...
public class UserPermissionMvoStateDto
{
    ...
    public static class DtoConverter extends AbstractStateDtoConverter
    {
        ...
        public UserPermissionMvoStateDto[] toUserPermissionMvoStateDtoArray(Iterable<UserPermissionMvoState> states) 
        {
            ArrayList<UserPermissionMvoStateDto> stateDtos = new ArrayList();
            for (UserPermissionMvoState s : states) {
                UserPermissionMvoStateDto dto = toUserPermissionMvoStateDto(s);
                stateDtos.add(dto);
            }
            return stateDtos.toArray(new UserPermissionMvoStateDto[0]);
        }

        public UserPermissionMvoStateDto toUserPermissionMvoStateDto(UserPermissionMvoState state)
        {
