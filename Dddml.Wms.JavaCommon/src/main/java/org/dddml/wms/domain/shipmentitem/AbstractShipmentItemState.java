...
public abstract class AbstractShipmentItemState implements ShipmentItemState
{
    ...
    public AbstractShipmentItemState(List<Event> events) {
        this(true);
        if (events != null && events.size() > 0) {
            this.setShipmentItemId(((ShipmentItemStateEvent) events.get(0)).getStateEventId().getShipmentItemId());
            for (Event e : events) {
                mutate(e);
    ...
    public static class SimpleShipmentItemState extends AbstractShipmentItemState
    {
        ...
        public SimpleShipmentItemState(List<Event> events) {
            super(events);
        }
