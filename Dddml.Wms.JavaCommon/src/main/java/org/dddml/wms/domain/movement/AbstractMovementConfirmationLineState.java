...
public abstract class AbstractMovementConfirmationLineState implements MovementConfirmationLineState
{
    ...
    public String getMovementDocumentNumber() {
        return this.getMovementConfirmationLineId().getMovementDocumentNumber();
    }
        
    public void setMovementDocumentNumber(String movementDocumentNumber) {
        this.getMovementConfirmationLineId().setMovementDocumentNumber(movementDocumentNumber);
    }
    ...
    {
        String stateEntityIdMovementDocumentNumber = this.getMovementConfirmationLineId().getMovementDocumentNumber();
        ...
        if (!(stateVersion == null && eventVersion.equals(MovementConfirmationLineState.VERSION_NULL)) && !eventVersion.equals(stateVersion))
        {
