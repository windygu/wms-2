...
public class MovementConfirmationLineId implements Serializable
{
    ...
    public MovementConfirmationLineId(String movementDocumentNumber, String lineNumber)
    {
        this.movementDocumentNumber = movementDocumentNumber;
        this.lineNumber = lineNumber;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        MovementConfirmationLineId other = (MovementConfirmationLineId)obj;
        return true 
