...
public class AttributeSetInstanceStateDto
{
    ...
    public static class DtoConverter extends AbstractStateDtoConverter
    {
        ...
        public AttributeSetInstanceStateDto toAttributeSetInstanceStateDto(AttributeSetInstanceState state)
        {
            ...
            if (returnedFieldsContains("WidthInch")) {
                dto.setWidthInch(state.getWidthInch());
            }
            if (returnedFieldsContains("DiameterInch")) {
                dto.setDiameterInch(state.getDiameterInch());
            }
            if (returnedFieldsContains("WeightLbs")) {
                dto.setWeightLbs(state.getWeightLbs());
            }
            if (returnedFieldsContains("WeightKg")) {
                dto.setWeightKg(state.getWeightKg());
            }
            if (returnedFieldsContains("AirDryWeightLbs")) {
                dto.setAirDryWeightLbs(state.getAirDryWeightLbs());
            }
            if (returnedFieldsContains("AirDryWeightKg")) {
                dto.setAirDryWeightKg(state.getAirDryWeightKg());
            }
