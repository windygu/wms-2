...
public interface OrderHeaderStateEvent extends Event
{
    OrderHeaderStateEventId getStateEventId();
    ...
    interface OrderHeaderStateCreated extends OrderHeaderStateEvent
    {
    
    }


    interface OrderHeaderStateMergePatched extends OrderHeaderStateEvent
    {
