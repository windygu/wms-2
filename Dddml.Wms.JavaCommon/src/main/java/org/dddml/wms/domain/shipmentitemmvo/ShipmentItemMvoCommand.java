...
public interface ShipmentItemMvoCommand extends Command
{
    ...
    static void throwOnInvalidStateTransition(ShipmentItemMvoState state, Command c) {
        if (state.getShipmentVersion() == null)
        {
            if (isCommandCreate((ShipmentItemMvoCommand)c))
            {
                return;
            }
    ...
    static boolean isCommandCreate(ShipmentItemMvoCommand c) {
        return ((c instanceof ShipmentItemMvoCommand.CreateShipmentItemMvo) 
            && c.getShipmentVersion().equals(ShipmentItemMvoState.VERSION_NULL));
    }

    interface CreateOrMergePatchShipmentItemMvo extends ShipmentItemMvoCommand
    {
        String getProductId();
    ...
    interface CreateShipmentItemMvo extends CreateOrMergePatchShipmentItemMvo
    {
    }

    interface MergePatchShipmentItemMvo extends CreateOrMergePatchShipmentItemMvo
    {
	...
	interface DeleteShipmentItemMvo extends ShipmentItemMvoCommand
	{
	}
