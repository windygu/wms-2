...
public abstract class AbstractOrderHeaderStateEvent extends AbstractStateEvent implements OrderHeaderStateEvent 
{
    private OrderHeaderStateEventId stateEventId;

    public OrderHeaderStateEventId getStateEventId() {
        return this.stateEventId;
    }

    public void setStateEventId(OrderHeaderStateEventId stateEventId) {
    ...
    protected AbstractOrderHeaderStateEvent() {
    }

    protected AbstractOrderHeaderStateEvent(OrderHeaderStateEventId stateEventId) {
        this.stateEventId = stateEventId;
    }
    ...
    public static abstract class AbstractOrderHeaderStateCreated extends AbstractOrderHeaderStateEvent implements OrderHeaderStateEvent.OrderHeaderStateCreated
    {
        public AbstractOrderHeaderStateCreated() {
            this(new OrderHeaderStateEventId());
        }

        public AbstractOrderHeaderStateCreated(OrderHeaderStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    public static abstract class AbstractOrderHeaderStateMergePatched extends AbstractOrderHeaderStateEvent implements OrderHeaderStateEvent.OrderHeaderStateMergePatched
    {
        public AbstractOrderHeaderStateMergePatched() {
            this(new OrderHeaderStateEventId());
        }

        public AbstractOrderHeaderStateMergePatched(OrderHeaderStateEventId stateEventId) {
            super(stateEventId);
        }
    ...
    public static class SimpleOrderHeaderStateCreated extends AbstractOrderHeaderStateCreated
    {
        public SimpleOrderHeaderStateCreated() {
        }

        public SimpleOrderHeaderStateCreated(OrderHeaderStateEventId stateEventId) {
            super(stateEventId);
        }
    }

    public static class SimpleOrderHeaderStateMergePatched extends AbstractOrderHeaderStateMergePatched
    {
        public SimpleOrderHeaderStateMergePatched() {
        }

        public SimpleOrderHeaderStateMergePatched(OrderHeaderStateEventId stateEventId) {
            super(stateEventId);
        }
    }
