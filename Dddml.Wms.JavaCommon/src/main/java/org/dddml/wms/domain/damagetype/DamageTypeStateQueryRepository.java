...
public interface DamageTypeStateQueryRepository
{
    ...
    DamageTypeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders);

    DamageTypeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders);
