...
public interface SellableInventoryItemEntryMvoStateQueryRepository
{
    ...
    SellableInventoryItemEntryMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders);

    SellableInventoryItemEntryMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders);
