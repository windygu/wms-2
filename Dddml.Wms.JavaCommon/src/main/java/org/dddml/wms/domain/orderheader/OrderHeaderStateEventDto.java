...
public class OrderHeaderStateEventDto extends AbstractStateEvent
{

    private OrderHeaderStateEventIdDto stateEventId;

    OrderHeaderStateEventIdDto getStateEventId() {
        if (stateEventId == null) { stateEventId = new OrderHeaderStateEventIdDto(); }
        return this.stateEventId;
    }

    void setStateEventId(OrderHeaderStateEventIdDto stateEventId) {
	...
	public static class OrderHeaderStateCreatedDto extends OrderHeaderStateEventDto
	{
        @Override
	...
	public static class OrderHeaderStateMergePatchedDto extends OrderHeaderStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public static class OrderHeaderStateDeletedDto extends OrderHeaderStateEventDto
	{
        @Override
        public String getStateEventType()
        {
