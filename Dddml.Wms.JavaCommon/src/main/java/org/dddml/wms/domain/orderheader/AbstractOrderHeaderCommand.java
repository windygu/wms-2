...
public abstract class AbstractOrderHeaderCommand extends AbstractCommand implements OrderHeaderCommand
{
    ...
    public static abstract class AbstractCreateOrMergePatchOrderHeader extends AbstractOrderHeaderCommand implements CreateOrMergePatchOrderHeader
    {
    ...
    public static abstract class AbstractCreateOrderHeader extends AbstractCreateOrMergePatchOrderHeader implements CreateOrderHeader
    {
        @Override
    ...
    public static abstract class AbstractMergePatchOrderHeader extends AbstractCreateOrMergePatchOrderHeader implements MergePatchOrderHeader
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateOrderHeader extends AbstractCreateOrderHeader
    {
    }

    
    public static class SimpleMergePatchOrderHeader extends AbstractMergePatchOrderHeader
    {
    }

    
	public static class SimpleDeleteOrderHeader extends AbstractOrderHeaderCommand implements DeleteOrderHeader
	{
        @Override
        public String getCommandType() {
