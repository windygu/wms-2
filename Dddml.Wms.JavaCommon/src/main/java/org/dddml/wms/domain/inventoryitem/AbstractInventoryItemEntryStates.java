...
public abstract class AbstractInventoryItemEntryStates implements InventoryItemEntryStates
{
    ...
    public AbstractInventoryItemEntryStates(InventoryItemState outerState) {
