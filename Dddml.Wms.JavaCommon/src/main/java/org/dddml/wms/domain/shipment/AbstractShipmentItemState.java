...
public abstract class AbstractShipmentItemState implements ShipmentItemState
{
    ...
    protected void throwOnWrongEvent(ShipmentItemStateEvent stateEvent)
    {
        ...
        String eventEntityIdShipmentItemSeqId = stateEvent.getStateEventId().getShipmentItemSeqId();
        ...
        if (!(stateVersion == null && eventVersion.equals(ShipmentItemState.VERSION_NULL)) && !(eventVersion.compareTo(stateVersion) >= 0))
        {
