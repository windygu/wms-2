...
public abstract class AbstractShipmentItemMvoCommand extends AbstractCommand implements ShipmentItemMvoCommand
{
    ...
    public static abstract class AbstractCreateOrMergePatchShipmentItemMvo extends AbstractShipmentItemMvoCommand implements CreateOrMergePatchShipmentItemMvo
    {
    ...
    public static abstract class AbstractCreateShipmentItemMvo extends AbstractCreateOrMergePatchShipmentItemMvo implements CreateShipmentItemMvo
    {
        @Override
    ...
    public static abstract class AbstractMergePatchShipmentItemMvo extends AbstractCreateOrMergePatchShipmentItemMvo implements MergePatchShipmentItemMvo
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateShipmentItemMvo extends AbstractCreateShipmentItemMvo
    {
    }

    
    public static class SimpleMergePatchShipmentItemMvo extends AbstractMergePatchShipmentItemMvo
    {
    }

    
	public static class SimpleDeleteShipmentItemMvo extends AbstractShipmentItemMvoCommand implements DeleteShipmentItemMvo
	{
        @Override
        public String getCommandType() {
