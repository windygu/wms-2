...
public abstract class AbstractMovementConfirmationLineMvoCommand extends AbstractCommand implements MovementConfirmationLineMvoCommand
{
    ...
    public static abstract class AbstractCreateOrMergePatchMovementConfirmationLineMvo extends AbstractMovementConfirmationLineMvoCommand implements CreateOrMergePatchMovementConfirmationLineMvo
    {
    ...
    public static abstract class AbstractCreateMovementConfirmationLineMvo extends AbstractCreateOrMergePatchMovementConfirmationLineMvo implements CreateMovementConfirmationLineMvo
    {
        @Override
    ...
    public static abstract class AbstractMergePatchMovementConfirmationLineMvo extends AbstractCreateOrMergePatchMovementConfirmationLineMvo implements MergePatchMovementConfirmationLineMvo
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateMovementConfirmationLineMvo extends AbstractCreateMovementConfirmationLineMvo
    {
    }

    
    public static class SimpleMergePatchMovementConfirmationLineMvo extends AbstractMergePatchMovementConfirmationLineMvo
    {
    }

    
	public static class SimpleDeleteMovementConfirmationLineMvo extends AbstractMovementConfirmationLineMvoCommand implements DeleteMovementConfirmationLineMvo
	{
        @Override
        public String getCommandType() {
