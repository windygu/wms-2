    ...
    public partial class ContactMechesController : ApiController
    {
        ...
        public IEnumerable<IContactMechStateDto> GetAll(string sort = null, string fields = null, int firstResult = 0, int maxResults = int.MaxValue, string filter = null)
        {
          try {
            ...
            {
                states = _contactMechApplicationService.Get(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(), new ApiControllerTypeConverter(), new PropertyTypeResolver()
        ...
        public long GetCount(string filter = null)
        {
          try
          {
            ...
            if (!String.IsNullOrWhiteSpace(filter))
            {
                count = _contactMechApplicationService.GetCount(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(), new ApiControllerTypeConverter(), new PropertyTypeResolver()
                    , n => (ContactMechMetadata.Instance.FilteringPropertyAliasDictionary.ContainsKey(n) ? ContactMechMetadata.Instance.FilteringPropertyAliasDictionary[n] : n)));
            }
            else 
            {
