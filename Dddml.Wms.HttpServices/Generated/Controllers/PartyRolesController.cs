    ...
    public partial class PartyRolesController : ApiController
    {
        ...
        public IEnumerable<IPartyRoleStateDto> GetAll(string sort = null, string fields = null, int firstResult = 0, int maxResults = int.MaxValue, string filter = null)
        {
          try {
            ...
            {
                states = _partyRoleApplicationService.Get(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(), new WebApiControllerTypeConverter(), new PropertyTypeResolver()
        ...
        public long GetCount(string filter = null)
        {
          try {
            ...
            if (!String.IsNullOrWhiteSpace(filter))
            {
                count = _partyRoleApplicationService.GetCount(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(), new WebApiControllerTypeConverter(), new PropertyTypeResolver()
                    , n => (PartyRoleMetadata.Instance.FilteringPropertyAliasDictionary.ContainsKey(n) ? PartyRoleMetadata.Instance.FilteringPropertyAliasDictionary[n] : n)));
            }
            else 
            {
