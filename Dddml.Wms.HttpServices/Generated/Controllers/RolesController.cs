    ...
    public partial class RolesController : ApiController
    {
        ...
        public RoleStateCreatedOrMergePatchedOrDeletedDto GetStateEvent(string id, long version)
        {
          try {
            ...
            var se = _roleApplicationService.GetStateEvent(idObj, version);
            return se == null ? null : conv.ToRoleStateEventDto(se);
          } catch (Exception ex) { var response = RolesControllerUtils.GetErrorHttpResponseMessage(ex); throw new HttpResponseException(response); }
        }

        [Route("{id}/_historyStates/{version}")]
        [HttpGet]
        public RoleStateDto Get(string id, long version, string fields = null)
        {
          try {
            var idObj = id;
