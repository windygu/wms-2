    ...
    public partial class PickwavesController : ApiController
    {
        ...
        public IEnumerable<IPickwaveStateDto> GetAll(string sort = null, string fields = null, int firstResult = 0, int maxResults = int.MaxValue, string filter = null)
        {
          try {
            ...
            {
                states = _pickwaveApplicationService.Get(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(), new ApiControllerTypeConverter(), new PropertyTypeResolver()
        ...
        public long GetCount(string filter = null)
        {
          try
          {
            ...
            if (!String.IsNullOrWhiteSpace(filter))
            {
                count = _pickwaveApplicationService.GetCount(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(), new ApiControllerTypeConverter(), new PropertyTypeResolver()
                    , n => (PickwaveMetadata.Instance.FilteringPropertyAliasDictionary.ContainsKey(n) ? PickwaveMetadata.Instance.FilteringPropertyAliasDictionary[n] : n)));
            }
            else 
            {
