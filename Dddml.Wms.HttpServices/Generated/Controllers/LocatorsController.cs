...
namespace Dddml.Wms.HttpServices.ApiControllers
{
    ...
    public partial class LocatorsController : ApiController
    {
        ...
        public IEnumerable<ILocatorStateDto> GetAll(string sort = null, string fields = null, int firstResult = 0, int maxResults = int.MaxValue, string filter = null)
        {
          try {
            ...
            {
                states = _locatorApplicationService.Get(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(), new WebApiControllerTypeConverter(), new PropertyTypeResolver()
            ...
            {
                var dto = s is LocatorStateDtoWrapper ? (LocatorStateDtoWrapper)s : new LocatorStateDtoWrapper(s);
        ...
        public ILocatorStateDto Get(string id, string fields = null)
        {
          try {
            var idObj = id;
            var state = _locatorApplicationService.Get(idObj);
        ...
        public long GetCount(string filter = null)
        {
          try {
            ...
            if (!String.IsNullOrWhiteSpace(filter))
            {
                count = _locatorApplicationService.GetCount(CriterionDto.ToSubclass(JObject.Parse(filter).ToObject<CriterionDto>(), new WebApiControllerTypeConverter(), new PropertyTypeResolver()
                    , n => (LocatorMetadata.Instance.FilteringPropertyAliasDictionary.ContainsKey(n) ? LocatorMetadata.Instance.FilteringPropertyAliasDictionary[n] : n)));
            }
            else 
            {
        ...
        public void Put(string id, [FromBody]CreateOrMergePatchOrDeleteLocatorDto value)
        {
          try {
              // ///////////////////////////////
    ...
    public static class LocatorsControllerUtils
    {
        ...
        public static string GetFilterPropertyName(string fieldName)
        {
            ...
            if (LocatorMetadata.Instance.FilteringPropertyAliasDictionary.ContainsKey(fieldName))
            {
                return LocatorMetadata.Instance.FilteringPropertyAliasDictionary[fieldName];
            }
            return null;
        }
