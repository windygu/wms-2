...
namespace Dddml.Wms.Domain.InOut
{
    ...
    public partial class InOutAggregate : IInOutAggregate
    {
        ...
        public void AddLine(string lineNumber, string locatorId, string productId, IDictionary<string, object> attributeSetInstance, IEnumerable<string> damageStatusIds, string description, string quantityUomId, decimal movementQuantity, long version, string commandId, string requesterId)
        {
