...
namespace Dddml.Wms.Domain.OrderItem
{
    ...
    public partial interface IOrderItemApplicationServiceFactory
    {

        IOrderItemApplicationService OrderItemApplicationService { get; }

        ICreateOrderItem NewCreateOrderItem();

        IMergePatchOrderItem NewMergePatchOrderItem();

        IDeleteOrderItem NewDeleteOrderItem();
    }
