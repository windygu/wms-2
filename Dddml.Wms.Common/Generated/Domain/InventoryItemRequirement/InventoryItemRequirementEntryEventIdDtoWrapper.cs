...
namespace Dddml.Wms.Domain.InventoryItemRequirement
{
	...
	public class InventoryItemRequirementEntryEventIdDtoWrapper : InventoryItemRequirementEntryEventIdDto
	{

        private InventoryItemRequirementEntryEventId _value = new InventoryItemRequirementEntryEventId();

		public InventoryItemRequirementEntryEventIdDtoWrapper()
		{
		}

		public InventoryItemRequirementEntryEventIdDtoWrapper(InventoryItemRequirementEntryEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override InventoryItemRequirementEntryEventId ToInventoryItemRequirementEntryEventId()
        {
            return this._value;
        }
