...
namespace Dddml.Wms.Domain.InventoryItemRequirement
{
	...
	public class InventoryItemRequirementStateEventIdDtoWrapper : InventoryItemRequirementStateEventIdDto
	{

        private InventoryItemRequirementStateEventId _value = new InventoryItemRequirementStateEventId();

		public InventoryItemRequirementStateEventIdDtoWrapper()
		{
		}

		public InventoryItemRequirementStateEventIdDtoWrapper(InventoryItemRequirementStateEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override InventoryItemRequirementStateEventId ToInventoryItemRequirementStateEventId()
        {
            return this._value;
        }
