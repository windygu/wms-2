...
namespace Dddml.Wms.Domain.InventoryItemRequirement
{
	...
	public abstract class InventoryItemRequirementEventBase : IInventoryItemRequirementEvent
	{
        ...
        protected InventoryItemRequirementEventBase()
        {
        }

        protected InventoryItemRequirementEventBase(InventoryItemRequirementEventId stateEventId)
        {
	...
	public class InventoryItemRequirementStateMergePatched : InventoryItemRequirementEventBase, IInventoryItemRequirementStateMergePatched
	{
		...
		private Dictionary<InventoryItemRequirementEntryEventId, IInventoryItemRequirementEntryEvent> _inventoryItemRequirementEntryEvents = new Dictionary<InventoryItemRequirementEntryEventId, IInventoryItemRequirementEntryEvent>();

        private IEnumerable<IInventoryItemRequirementEntryEvent> _readOnlyInventoryItemRequirementEntryEvents;
        
        public virtual IEnumerable<IInventoryItemRequirementEntryEvent> InventoryItemRequirementEntryEvents
        {
            get
            {
                return this._inventoryItemRequirementEntryEvents.Values;
