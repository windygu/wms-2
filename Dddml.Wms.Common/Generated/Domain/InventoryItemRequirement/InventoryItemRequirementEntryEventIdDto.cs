...
namespace Dddml.Wms.Domain.InventoryItemRequirement
{
	...
	public class InventoryItemRequirementEntryEventIdDto
	{

		public InventoryItemRequirementEntryEventIdDto()
		{
		}

        public virtual InventoryItemRequirementEntryEventId ToInventoryItemRequirementEntryEventId()
        {
            InventoryItemRequirementEntryEventId v = new InventoryItemRequirementEntryEventId();
		...
		public override bool Equals (object obj)
		{
			...
			InventoryItemRequirementEntryEventIdDto other = obj as InventoryItemRequirementEntryEventIdDto;
			if (other == null) {
				return false;
			}
