...
namespace Dddml.Wms.Domain.InventoryItemRequirement
{
	...
	public class InventoryItemRequirementStateEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private InventoryItemRequirementStateEventIdDto _value = new InventoryItemRequirementStateEventIdDto();

		public InventoryItemRequirementStateEventIdFlattenedDto()
		{
		}

		public InventoryItemRequirementStateEventIdFlattenedDto(InventoryItemRequirementStateEventIdDto val)
		{
			this._value = val;
		}
		...
		public InventoryItemRequirementStateEventIdFlattenedDto(InventoryItemRequirementStateEventId val)
		{
			this._value = new InventoryItemRequirementStateEventIdDtoWrapper(val);
		}

        public InventoryItemRequirementStateEventId ToInventoryItemRequirementStateEventId()
        {
            return this._value.ToInventoryItemRequirementStateEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			InventoryItemRequirementStateEventIdFlattenedDto other = obj as InventoryItemRequirementStateEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class InventoryItemRequirementStateEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<InventoryItemRequirementStateEventIdFlattenedDto>
    {
