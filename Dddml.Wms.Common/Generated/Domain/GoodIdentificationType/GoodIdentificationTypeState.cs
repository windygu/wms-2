...
namespace Dddml.Wms.Domain.GoodIdentificationType
{
	...
	public partial class GoodIdentificationTypeState : GoodIdentificationTypeStateProperties, IGoodIdentificationTypeState
	{
        ...
        public GoodIdentificationTypeState(IEnumerable<IEvent> events) : this(true)
        {
            if (events != null && events.Count() > 0)
            {
                this.GoodIdentificationTypeId = ((IGoodIdentificationTypeEvent)events.First()).GoodIdentificationTypeEventId.GoodIdentificationTypeId;
        ...
        public GoodIdentificationTypeState() : this(false)
        {
        }

        public GoodIdentificationTypeState(bool forReapplying)
        {
		...
		public virtual void When(IGoodIdentificationTypeStateMergePatched e)
		{
			ThrowOnWrongEvent(e);
