...
namespace Dddml.Wms.Domain.SellableInventoryItem
{
	...
	public abstract class SellableInventoryItemEntryEventBase : ISellableInventoryItemEntryEvent
	{
        ...
        protected SellableInventoryItemEntryEventBase() : this(new SellableInventoryItemEntryState())
        {
        }

        protected SellableInventoryItemEntryEventBase(SellableInventoryItemEntryEventId stateEventId) : this(new SellableInventoryItemEntryState())
        {
