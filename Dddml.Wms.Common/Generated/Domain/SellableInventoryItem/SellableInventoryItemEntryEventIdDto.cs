...
namespace Dddml.Wms.Domain.SellableInventoryItem
{
	...
	public class SellableInventoryItemEntryEventIdDto
	{

		public SellableInventoryItemEntryEventIdDto()
		{
		}

        public virtual SellableInventoryItemEntryEventId ToSellableInventoryItemEntryEventId()
        {
            SellableInventoryItemEntryEventId v = new SellableInventoryItemEntryEventId();
		...
		public override bool Equals (object obj)
		{
			...
			SellableInventoryItemEntryEventIdDto other = obj as SellableInventoryItemEntryEventIdDto;
			if (other == null) {
				return false;
			}
