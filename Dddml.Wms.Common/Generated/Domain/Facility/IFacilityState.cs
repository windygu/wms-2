...
{
	public interface IFacilityState : IFacilityStateProperties, 
		...
		IState
	{
		...
		void When(IFacilityStateCreated e);

		void When(IFacilityStateMergePatched e);

		void When(IFacilityStateDeleted e);
