...
namespace Dddml.Wms.Domain.Facility
{
	...
	public partial interface IFacilityAggregate : IGlobalIdentity<string>
	{
		IFacilityState State { get; }

		IList<IEvent> Changes { get; }

		void ThrowOnInvalidStateTransition (ICommand c);

		void Create (ICreateFacility c);

		void MergePatch (IMergePatchFacility c);

		void Delete (IDeleteFacility c);
