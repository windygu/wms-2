...
namespace Dddml.Wms.Domain.ShipmentType
{
	...
	public partial class ShipmentTypeState : ShipmentTypeStateProperties, IShipmentTypeState
	{
        ...
        public ShipmentTypeState(IEnumerable<IEvent> events) : this(true)
        {
            ...
            {
                this.ShipmentTypeId = ((IShipmentTypeStateEvent)events.First()).StateEventId.ShipmentTypeId;
        ...
        protected void ThrowOnWrongEvent(IShipmentTypeStateEvent stateEvent)
        {
            ...
            var eventEntityId = stateEvent.StateEventId.ShipmentTypeId; // EntityBase.Aggregate.GetStateEventIdPropertyIdName();
