...
namespace Dddml.Wms.Domain.ShipmentType
{
	...
	public class ShipmentTypeStateEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private ShipmentTypeStateEventIdDto _value = new ShipmentTypeStateEventIdDto();

		public ShipmentTypeStateEventIdFlattenedDto()
		{
		}

		public ShipmentTypeStateEventIdFlattenedDto(ShipmentTypeStateEventIdDto val)
		{
			this._value = val;
		}
		...
		public ShipmentTypeStateEventIdFlattenedDto(ShipmentTypeStateEventId val)
		{
			this._value = new ShipmentTypeStateEventIdDtoWrapper(val);
		}

        public ShipmentTypeStateEventId ToShipmentTypeStateEventId()
        {
            return this._value.ToShipmentTypeStateEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			ShipmentTypeStateEventIdFlattenedDto other = obj as ShipmentTypeStateEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class ShipmentTypeStateEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<ShipmentTypeStateEventIdFlattenedDto>
    {
