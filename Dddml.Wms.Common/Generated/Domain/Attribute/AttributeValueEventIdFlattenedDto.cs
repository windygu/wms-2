...
namespace Dddml.Wms.Domain.Attribute
{
	...
	public class AttributeValueEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private AttributeValueEventIdDto _value = new AttributeValueEventIdDto();

		public AttributeValueEventIdFlattenedDto()
		{
		}

		public AttributeValueEventIdFlattenedDto(AttributeValueEventIdDto val)
		{
			this._value = val;
		}

        public AttributeValueEventIdDto ToAttributeValueEventIdDto()
        {
            return this._value;
        }

		public AttributeValueEventIdFlattenedDto(AttributeValueEventId val)
		{
			this._value = new AttributeValueEventIdDtoWrapper(val);
		}

        public AttributeValueEventId ToAttributeValueEventId()
        {
            return this._value.ToAttributeValueEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			AttributeValueEventIdFlattenedDto other = obj as AttributeValueEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class AttributeValueEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<AttributeValueEventIdFlattenedDto>
    {
