...
namespace Dddml.Wms.Domain.InOutLineMvo
{
	...
	public class InOutLineMvoEventIdDto
	{

		public InOutLineMvoEventIdDto()
		{
		}

        public virtual InOutLineMvoEventId ToInOutLineMvoEventId()
        {
            InOutLineMvoEventId v = new InOutLineMvoEventId();
		...
		public override bool Equals (object obj)
		{
			...
			InOutLineMvoEventIdDto other = obj as InOutLineMvoEventIdDto;
			if (other == null) {
				return false;
			}
