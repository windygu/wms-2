...
namespace Dddml.Wms.Domain.OrderShipment
{
	...
	public class OrderShipmentEventIdDto
	{

		public OrderShipmentEventIdDto()
		{
		}

        public virtual OrderShipmentEventId ToOrderShipmentEventId()
        {
            OrderShipmentEventId v = new OrderShipmentEventId();
		...
		public override bool Equals (object obj)
		{
			...
			OrderShipmentEventIdDto other = obj as OrderShipmentEventIdDto;
			if (other == null) {
				return false;
			}
