...
namespace Dddml.Wms.Domain.Pickwave
{
	...
	public class PickwaveEventId
	{

		private long? _pickwaveId;

		public virtual long? PickwaveId { 
			get { return this._pickwaveId; } 
			set { _pickwaveId = value; } 
		}
		...
		public override bool Equals (object obj)
		{
			...
			PickwaveEventId other = obj as PickwaveEventId;
			if (other == null) {
				return false;
			}

			return true 
				&& Object.Equals (this.PickwaveId, other.PickwaveId)
		...
		public override int GetHashCode ()
		{
			...
			if (this.PickwaveId != null) {
				hash += 13 * this.PickwaveId.GetHashCode ();
			}
        ...
        public static bool operator ==(PickwaveEventId obj1, PickwaveEventId obj2)
        {
        ...
        {
            return String.Empty
                + "PickwaveId: " + this.PickwaveId + ", "
                + "Version: " + this.Version + ", "
                ;
        }

        protected internal static readonly string[] FlattenedPropertyNames = new string[] { "PickwaveId", "Version" };

        protected internal static readonly Type[] FlattenedPropertyTypes = new Type[] { typeof(long?), typeof(long) };

        protected internal static readonly IDictionary<string, Type> FlattenedPropertyTypeDictionary;

        static PickwaveEventId()
        {
