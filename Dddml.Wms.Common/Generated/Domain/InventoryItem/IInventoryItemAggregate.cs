...
namespace Dddml.Wms.Domain.InventoryItem
{
	...
	public partial interface IInventoryItemAggregate : IGlobalIdentity<InventoryItemId>
	{
		...
		void Create (ICreateInventoryItem c);

		void MergePatch (IMergePatchInventoryItem c);
