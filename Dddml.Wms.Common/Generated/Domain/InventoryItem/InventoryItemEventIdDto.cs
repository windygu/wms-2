...
namespace Dddml.Wms.Domain.InventoryItem
{
	...
	public class InventoryItemEventIdDto
	{

		public InventoryItemEventIdDto()
		{
		}

        public virtual InventoryItemEventId ToInventoryItemEventId()
        {
            InventoryItemEventId v = new InventoryItemEventId();
		...
		public override bool Equals (object obj)
		{
			...
			InventoryItemEventIdDto other = obj as InventoryItemEventIdDto;
			if (other == null) {
				return false;
			}
