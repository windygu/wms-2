...
{
	public partial interface IStatusItemStateQueryRepository
	{
        IStatusItemState Get(string id);
        ...
        IStatusItemState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null);

        IStatusItemState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null);
