...
{
	public interface IShipmentItemStateEvent : IEvent, IStateEventDto, IGlobalIdentity<ShipmentItemStateEventId>, ICreated<string>
	{
		ShipmentItemStateEventId StateEventId { get; }
