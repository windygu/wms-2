...
namespace Dddml.Wms.Domain.Shipment
{
	...
	public abstract class ShipmentItemStateEventDtoBase : IEventDto, IShipmentItemStateCreated, IShipmentItemStateMergePatched
	{

        private ShipmentItemEventId _shipmentItemEventId;

		protected internal virtual ShipmentItemEventId ShipmentItemEventId 
        {
            get 
            {
                if (_shipmentItemEventId == null) { _shipmentItemEventId = new ShipmentItemEventId(); }
                return _shipmentItemEventId;
            }
            set
            {
                _shipmentItemEventId = value;
            }
        }
        ...
        ShipmentItemEventId IShipmentItemEvent.ShipmentItemEventId
        {
            get { return this.ShipmentItemEventId; }
        }
        ...
        protected ShipmentItemStateEventDtoBase(ShipmentItemEventId stateEventId)
        {
    ...
    public partial class ShipmentItemStateCreatedOrMergePatchedOrRemovedDtos : IEnumerable<IShipmentItemStateCreated>, IEnumerable<IShipmentItemStateMergePatched>
    {
        ...
        public void AddShipmentItemEvent(IShipmentItemEvent e)
        {
