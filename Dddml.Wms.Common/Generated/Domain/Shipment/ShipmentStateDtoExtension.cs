...
namespace Dddml.Wms.Domain.Shipment
{
	...
	public static partial class ShipmentStateDtoExtension
	{
        ...
        {
            return state.ToCreateOrMergePatchShipment<CreateShipmentDto, MergePatchShipmentDto>();
        }
        ...
        {
            return state.ToMergePatchShipment<MergePatchShipmentDto>();
        }

        public static CreateShipmentDto ToCreateShipment(this ShipmentStateDtoWrapper state)
        {
            return state.ToCreateShipment<CreateShipmentDto>();
        }
