...
namespace Dddml.Wms.Domain.Shipment
{
	...
	public class ShipmentItemEventIdDtoWrapper : ShipmentItemEventIdDto
	{

        private ShipmentItemEventId _value = new ShipmentItemEventId();

		public ShipmentItemEventIdDtoWrapper()
		{
		}

		public ShipmentItemEventIdDtoWrapper(ShipmentItemEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override ShipmentItemEventId ToShipmentItemEventId()
        {
            return this._value;
        }
