...
namespace Dddml.Wms.Domain.Party
{
	...
	public class PartyEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private PartyEventIdDto _value = new PartyEventIdDto();

		public PartyEventIdFlattenedDto()
		{
		}

		public PartyEventIdFlattenedDto(PartyEventIdDto val)
		{
			this._value = val;
		}

        public PartyEventIdDto ToPartyEventIdDto()
        {
            return this._value;
        }

		public PartyEventIdFlattenedDto(PartyEventId val)
		{
			this._value = new PartyEventIdDtoWrapper(val);
		}

        public PartyEventId ToPartyEventId()
        {
            return this._value.ToPartyEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			PartyEventIdFlattenedDto other = obj as PartyEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class PartyEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<PartyEventIdFlattenedDto>
    {
