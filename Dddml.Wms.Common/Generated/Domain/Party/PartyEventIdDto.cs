...
namespace Dddml.Wms.Domain.Party
{
	...
	public class PartyEventIdDto
	{

		public PartyEventIdDto()
		{
		}

        public virtual PartyEventId ToPartyEventId()
        {
            PartyEventId v = new PartyEventId();
		...
		public override bool Equals (object obj)
		{
			...
			PartyEventIdDto other = obj as PartyEventIdDto;
			if (other == null) {
				return false;
			}
