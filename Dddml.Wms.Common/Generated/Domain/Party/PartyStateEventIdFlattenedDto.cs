...
namespace Dddml.Wms.Domain.Party
{
	...
	public class PartyStateEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private PartyStateEventIdDto _value = new PartyStateEventIdDto();

		public PartyStateEventIdFlattenedDto()
		{
		}

		public PartyStateEventIdFlattenedDto(PartyStateEventIdDto val)
		{
			this._value = val;
		}
		...
		public PartyStateEventIdFlattenedDto(PartyStateEventId val)
		{
			this._value = new PartyStateEventIdDtoWrapper(val);
		}

        public PartyStateEventId ToPartyStateEventId()
        {
            return this._value.ToPartyStateEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			PartyStateEventIdFlattenedDto other = obj as PartyStateEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class PartyStateEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<PartyStateEventIdFlattenedDto>
    {
