...
namespace Dddml.Wms.Domain.MovementType
{
    ...
    public partial class MovementTypeStateDto : IMovementTypeStateDto
    {
        ...
        public virtual IMovementTypeState ToMovementTypeState()
        {
            var state = new MovementTypeState(true);
