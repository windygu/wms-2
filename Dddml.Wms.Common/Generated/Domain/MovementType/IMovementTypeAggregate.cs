...
namespace Dddml.Wms.Domain.MovementType
{
	...
	public partial interface IMovementTypeAggregate : IGlobalIdentity<string>
	{
		IMovementTypeState State { get; }

		IList<IEvent> Changes { get; }

		void ThrowOnInvalidStateTransition (ICommand c);

		void Create (ICreateMovementType c);

		void MergePatch (IMergePatchMovementType c);

		void Delete (IDeleteMovementType c);
