...
{
	public partial interface IShipmentMethodTypeStateRepository
	{

        IShipmentMethodTypeState Get(string id, bool nullAllowed);
        
        void Save(IShipmentMethodTypeState state);
