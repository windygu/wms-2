...
{
	public partial interface IShipmentMethodTypeStateQueryRepository
	{
        IShipmentMethodTypeState Get(string id);
        ...
        IShipmentMethodTypeState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null);

        IShipmentMethodTypeState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null);
