...
namespace Dddml.Wms.Domain.ShipmentMethodType
{
	...
	public abstract class ShipmentMethodTypeStateEventBase : IShipmentMethodTypeStateEvent
	{
        ...
        protected ShipmentMethodTypeStateEventBase()
        {
        }

        protected ShipmentMethodTypeStateEventBase(ShipmentMethodTypeEventId stateEventId)
        {
