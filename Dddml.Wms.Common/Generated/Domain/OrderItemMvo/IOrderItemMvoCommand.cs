...
{
	public interface IOrderItemMvoCommand : IAggregateCommand<OrderItemId, long>, ICommandDto
	{
		long OrderVersion { get; set; }

		OrderItemId OrderItemId { get; set; }

	}


	public interface ICreateOrMergePatchOrDeleteOrderItemMvo : IOrderItemMvoCommand
	{
	...
	public interface ICreateOrderItemMvo : ICreateOrMergePatchOrDeleteOrderItemMvo
	{
	}

	public interface IMergePatchOrderItemMvo : ICreateOrMergePatchOrDeleteOrderItemMvo
	{
	...
	public interface IDeleteOrderItemMvo : ICreateOrMergePatchOrDeleteOrderItemMvo
	{
	}
