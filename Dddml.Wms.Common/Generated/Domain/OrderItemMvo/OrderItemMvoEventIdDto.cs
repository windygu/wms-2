...
namespace Dddml.Wms.Domain.OrderItemMvo
{
	...
	public class OrderItemMvoEventIdDto
	{

		public OrderItemMvoEventIdDto()
		{
		}

        public virtual OrderItemMvoEventId ToOrderItemMvoEventId()
        {
            OrderItemMvoEventId v = new OrderItemMvoEventId();
		...
		public override bool Equals (object obj)
		{
			...
			OrderItemMvoEventIdDto other = obj as OrderItemMvoEventIdDto;
			if (other == null) {
				return false;
			}
