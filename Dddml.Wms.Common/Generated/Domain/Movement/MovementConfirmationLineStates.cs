    ...
    public class MovementConfirmationLineStates : IMovementConfirmationLineStates
    {
        ...
        private IEnumerable<IMovementConfirmationLineState> InnerEnumeralbe
        {
            get
            {
                if (!ForReapplying)
                {
                    return MovementConfirmationLineStateDao.FindByMovementDocumentNumber(_movementState.DocumentNumber);
                }
                else
                {
        ...
        public MovementConfirmationLineStates(IMovementState outerState)
        {
        ...
        {
            MovementConfirmationLineId globalId = new MovementConfirmationLineId(_movementState.DocumentNumber, lineNumber);
