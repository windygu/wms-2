...
{
	public interface IMovementEvent : IEvent, IEventDto, IGlobalIdentity<MovementEventId>, ICreated<string>
	{
		MovementEventId MovementEventId { get; }
	...
	public interface IMovementStateMergePatched : IMovementEvent//, IMovementStateProperties
	{
		...
		IEnumerable<IMovementLineEvent> MovementLineEvents { get; }
		
		void AddMovementLineEvent(IMovementLineEvent e);
