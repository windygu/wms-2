...
namespace Dddml.Wms.Domain.Movement
{
	...
	public partial class MovementConfirmationLineState : MovementConfirmationLineStateProperties, IMovementConfirmationLineState
	{
        ...
        public override string MovementDocumentNumber {
			get {
				return this.MovementConfirmationLineId.MovementDocumentNumber;
			}
			set {
				this.MovementConfirmationLineId.MovementDocumentNumber = value;
			}
		}
        ...
        protected void ThrowOnWrongEvent(IMovementConfirmationLineStateEvent stateEvent)
        {
            ...
            var stateEntityIdMovementDocumentNumber = (this as IGlobalIdentity<MovementConfirmationLineId>).GlobalId.MovementDocumentNumber;
