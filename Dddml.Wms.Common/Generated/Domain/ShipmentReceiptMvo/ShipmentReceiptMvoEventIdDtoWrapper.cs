...
namespace Dddml.Wms.Domain.ShipmentReceiptMvo
{
	...
	public class ShipmentReceiptMvoEventIdDtoWrapper : ShipmentReceiptMvoEventIdDto
	{

        private ShipmentReceiptMvoEventId _value = new ShipmentReceiptMvoEventId();

		public ShipmentReceiptMvoEventIdDtoWrapper()
		{
		}

		public ShipmentReceiptMvoEventIdDtoWrapper(ShipmentReceiptMvoEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override ShipmentReceiptMvoEventId ToShipmentReceiptMvoEventId()
        {
            return this._value;
        }
