...
namespace Dddml.Wms.Domain.ShipmentReceiptMvo
{
	...
	public class ShipmentReceiptMvoEventIdDto
	{

		public ShipmentReceiptMvoEventIdDto()
		{
		}

        public virtual ShipmentReceiptMvoEventId ToShipmentReceiptMvoEventId()
        {
            ShipmentReceiptMvoEventId v = new ShipmentReceiptMvoEventId();
		...
		public override bool Equals (object obj)
		{
			...
			ShipmentReceiptMvoEventIdDto other = obj as ShipmentReceiptMvoEventIdDto;
			if (other == null) {
				return false;
			}
