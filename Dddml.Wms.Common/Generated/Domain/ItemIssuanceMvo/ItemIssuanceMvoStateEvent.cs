...
namespace Dddml.Wms.Domain.ItemIssuanceMvo
{
	...
	public abstract class ItemIssuanceMvoStateEventBase : IItemIssuanceMvoStateEvent
	{
        ...
        protected ItemIssuanceMvoStateEventBase()
        {
        }

        protected ItemIssuanceMvoStateEventBase(ItemIssuanceMvoEventId stateEventId)
        {
