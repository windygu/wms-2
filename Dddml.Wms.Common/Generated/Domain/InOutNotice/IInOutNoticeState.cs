...
{
	public interface IInOutNoticeState : IInOutNoticeStateProperties, 
		...
		IState
	{
		...
		void When(IInOutNoticeStateCreated e);

		void When(IInOutNoticeStateMergePatched e);

		void When(IInOutNoticeStateDeleted e);
