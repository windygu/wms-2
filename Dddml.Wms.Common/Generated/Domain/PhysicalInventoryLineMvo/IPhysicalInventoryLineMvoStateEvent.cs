...
{
	public interface IPhysicalInventoryLineMvoStateEvent : IEvent, IStateEventDto, IGlobalIdentity<PhysicalInventoryLineMvoStateEventId>, ICreated<string>
	{
		PhysicalInventoryLineMvoStateEventId StateEventId { get; }
