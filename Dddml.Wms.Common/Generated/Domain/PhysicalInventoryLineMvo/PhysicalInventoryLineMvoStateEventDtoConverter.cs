...
namespace Dddml.Wms.Domain.PhysicalInventoryLineMvo
{
    ...
    {
        public virtual PhysicalInventoryLineMvoStateCreatedOrMergePatchedOrDeletedDto ToPhysicalInventoryLineMvoStateEventDto(IPhysicalInventoryLineMvoEvent stateEvent)
        {
