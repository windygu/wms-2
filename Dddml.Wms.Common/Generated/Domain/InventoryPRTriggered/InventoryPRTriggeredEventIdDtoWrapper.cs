...
namespace Dddml.Wms.Domain.InventoryPRTriggered
{
	...
	public class InventoryPRTriggeredEventIdDtoWrapper : InventoryPRTriggeredEventIdDto
	{

        private InventoryPRTriggeredEventId _value = new InventoryPRTriggeredEventId();

		public InventoryPRTriggeredEventIdDtoWrapper()
		{
		}

		public InventoryPRTriggeredEventIdDtoWrapper(InventoryPRTriggeredEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override InventoryPRTriggeredEventId ToInventoryPRTriggeredEventId()
        {
            return this._value;
        }
