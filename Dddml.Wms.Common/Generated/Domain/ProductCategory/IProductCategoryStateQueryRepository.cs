...
{
	public partial interface IProductCategoryStateQueryRepository
	{
        IProductCategoryState Get(string id);
        ...
        IProductCategoryState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null);

        IProductCategoryState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null);
