...
namespace Dddml.Wms.Domain.ProductCategory
{
	...
	public class ProductCategoryEventIdDto
	{

		public ProductCategoryEventIdDto()
		{
		}

        public virtual ProductCategoryEventId ToProductCategoryEventId()
        {
            ProductCategoryEventId v = new ProductCategoryEventId();
		...
		public override bool Equals (object obj)
		{
			...
			ProductCategoryEventIdDto other = obj as ProductCategoryEventIdDto;
			if (other == null) {
				return false;
			}
