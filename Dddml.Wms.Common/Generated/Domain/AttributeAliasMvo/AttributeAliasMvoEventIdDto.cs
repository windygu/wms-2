...
namespace Dddml.Wms.Domain.AttributeAliasMvo
{
	...
	public class AttributeAliasMvoEventIdDto
	{

		public AttributeAliasMvoEventIdDto()
		{
		}

        public virtual AttributeAliasMvoEventId ToAttributeAliasMvoEventId()
        {
            AttributeAliasMvoEventId v = new AttributeAliasMvoEventId();
		...
		public override bool Equals (object obj)
		{
			...
			AttributeAliasMvoEventIdDto other = obj as AttributeAliasMvoEventIdDto;
			if (other == null) {
				return false;
			}
