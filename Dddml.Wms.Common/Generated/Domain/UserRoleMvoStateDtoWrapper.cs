...
namespace Dddml.Wms.Domain
{
	...
	public partial class UserRoleMvoStateDtoWrapper : StateDtoWrapperBase, IUserRoleMvoStateDto, IUserRoleMvoState
	{
		...
		public IUserRoleMvoState ToUserRoleMvoState()
		{
			return this._state;
		}
		...
		bool IUserRoleMvoState.ForReapplying
		{
    ...
    partial class UserRoleMvoStateDtoWrapperCollection : StateDtoWrapperCollectionBase<UserRoleMvoStateDtoWrapper>
    {

        protected override bool IsCollectionField(string fieldName)
        {
            return CollectionUtils.CollectionContainsIgnoringCase(UserRoleMvoStateDtoWrapper._collectionFieldNames, fieldName);
        }
