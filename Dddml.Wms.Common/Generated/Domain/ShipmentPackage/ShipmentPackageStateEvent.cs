...
namespace Dddml.Wms.Domain.ShipmentPackage
{
	...
	public abstract class ShipmentPackageStateEventBase : IShipmentPackageStateEvent
	{
        ...
        protected ShipmentPackageStateEventBase()
        {
        }

        protected ShipmentPackageStateEventBase(ShipmentPackageEventId stateEventId)
        {
            this.ShipmentPackageEventId = stateEventId;
        }

		protected IShipmentPackageContentStateEventDao ShipmentPackageContentStateEventDao
		{
			get { return ApplicationContext.Current["ShipmentPackageContentStateEventDao"] as IShipmentPackageContentStateEventDao; }
		}
        ...
        protected void ThrowOnInconsistentEventIds(IShipmentPackageContentStateEvent e)
        {
            ThrowOnInconsistentEventIds(this, e);
        }

		public static void ThrowOnInconsistentEventIds(IShipmentPackageStateEvent oe, IShipmentPackageContentStateEvent e)
		{
	...
	public class ShipmentPackageStateCreated : ShipmentPackageStateEventBase, IShipmentPackageStateCreated, ISaveable
	{
        ...
        public virtual IEnumerable<IShipmentPackageContentStateCreated> ShipmentPackageContentEvents
        {
            get
            {
                ...
                else
                {
                    ...
                    var eventDao = ShipmentPackageContentStateEventDao;
		...
		public virtual void Save ()
		{
			foreach (IShipmentPackageContentStateCreated e in this.ShipmentPackageContentEvents) {
				ShipmentPackageContentStateEventDao.Save(e);
			}
		}
	...
	public class ShipmentPackageStateMergePatched : ShipmentPackageStateEventBase, IShipmentPackageStateMergePatched, ISaveable
	{
		...
		private Dictionary<ShipmentPackageContentEventId, IShipmentPackageContentStateEvent> _shipmentPackageContentEvents = new Dictionary<ShipmentPackageContentEventId, IShipmentPackageContentStateEvent>();

        private IEnumerable<IShipmentPackageContentStateEvent> _readOnlyShipmentPackageContentEvents;
        
        public virtual IEnumerable<IShipmentPackageContentStateEvent> ShipmentPackageContentEvents
        {
            get
            {
                if (!StateEventReadOnly)
                ...
                else
                {
                    if (_readOnlyShipmentPackageContentEvents != null) { return _readOnlyShipmentPackageContentEvents; }
                    var eventDao = ShipmentPackageContentStateEventDao;
                    var eL = new List<IShipmentPackageContentStateEvent>();
                    foreach (var e in eventDao.FindByShipmentPackageEventId(this.ShipmentPackageEventId))
                    {
                        e.ReadOnly = true;
                        eL.Add((IShipmentPackageContentStateEvent)e);
                    }
                    return (_readOnlyShipmentPackageContentEvents = eL);
                }
            }
		...
		public virtual void AddShipmentPackageContentEvent(IShipmentPackageContentStateEvent e)
		{
			ThrowOnInconsistentEventIds(e);
			this._shipmentPackageContentEvents[e.ShipmentPackageContentEventId] = e;
		}
		...
		public virtual void Save ()
		{
			foreach (IShipmentPackageContentStateEvent e in this.ShipmentPackageContentEvents) {
				ShipmentPackageContentStateEventDao.Save(e);
			}
		}
