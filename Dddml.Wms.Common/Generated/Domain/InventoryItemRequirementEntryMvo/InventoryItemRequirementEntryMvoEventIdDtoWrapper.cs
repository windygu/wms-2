...
namespace Dddml.Wms.Domain.InventoryItemRequirementEntryMvo
{
	...
	public class InventoryItemRequirementEntryMvoEventIdDtoWrapper : InventoryItemRequirementEntryMvoEventIdDto
	{

        private InventoryItemRequirementEntryMvoEventId _value = new InventoryItemRequirementEntryMvoEventId();

		public InventoryItemRequirementEntryMvoEventIdDtoWrapper()
		{
		}

		public InventoryItemRequirementEntryMvoEventIdDtoWrapper(InventoryItemRequirementEntryMvoEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override InventoryItemRequirementEntryMvoEventId ToInventoryItemRequirementEntryMvoEventId()
        {
            return this._value;
        }
