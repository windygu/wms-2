...
{
	public partial interface IShipmentItemMvoStateRepository
	{

        IShipmentItemMvoState Get(ShipmentItemId id, bool nullAllowed);
        
        void Save(IShipmentItemMvoState state);
