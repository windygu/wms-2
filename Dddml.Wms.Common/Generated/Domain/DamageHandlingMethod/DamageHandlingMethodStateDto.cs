...
namespace Dddml.Wms.Domain.DamageHandlingMethod
{
    ...
    public partial class DamageHandlingMethodStateDto : IDamageHandlingMethodStateDto
    {
        ...
        public virtual IDamageHandlingMethodState ToDamageHandlingMethodState()
        {
            var state = new DamageHandlingMethodState(true);
            state.DamageHandlingMethodId = this.DamageHandlingMethodId;
