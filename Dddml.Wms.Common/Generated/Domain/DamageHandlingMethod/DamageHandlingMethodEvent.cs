...
namespace Dddml.Wms.Domain.DamageHandlingMethod
{
	...
	public abstract class DamageHandlingMethodEventBase : IDamageHandlingMethodEvent
	{
        ...
        protected DamageHandlingMethodEventBase()
        {
        }

        protected DamageHandlingMethodEventBase(DamageHandlingMethodEventId stateEventId)
        {
