...
{
	public partial interface IDamageHandlingMethodStateRepository
	{

        IDamageHandlingMethodState Get(string id, bool nullAllowed);
        
        void Save(IDamageHandlingMethodState state);
