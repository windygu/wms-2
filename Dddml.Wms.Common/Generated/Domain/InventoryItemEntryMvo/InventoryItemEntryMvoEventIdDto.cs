...
namespace Dddml.Wms.Domain.InventoryItemEntryMvo
{
	...
	public class InventoryItemEntryMvoEventIdDto
	{

		public InventoryItemEntryMvoEventIdDto()
		{
		}

        public virtual InventoryItemEntryMvoEventId ToInventoryItemEntryMvoEventId()
        {
            InventoryItemEntryMvoEventId v = new InventoryItemEntryMvoEventId();
		...
		public override bool Equals (object obj)
		{
			...
			InventoryItemEntryMvoEventIdDto other = obj as InventoryItemEntryMvoEventIdDto;
			if (other == null) {
				return false;
			}
