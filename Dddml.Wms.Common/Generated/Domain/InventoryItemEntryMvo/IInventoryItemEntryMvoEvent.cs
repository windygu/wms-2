...
{
	public interface IInventoryItemEntryMvoEvent : IEvent, IEventDto, IGlobalIdentity<InventoryItemEntryMvoEventId>, ICreated<string>
	{
		InventoryItemEntryMvoEventId InventoryItemEntryMvoEventId { get; }
