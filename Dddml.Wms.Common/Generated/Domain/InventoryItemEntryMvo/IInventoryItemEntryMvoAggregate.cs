...
namespace Dddml.Wms.Domain.InventoryItemEntryMvo
{
	...
	public partial interface IInventoryItemEntryMvoAggregate : IGlobalIdentity<InventoryItemEntryId>
	{
		IInventoryItemEntryMvoState State { get; }

		IList<IEvent> Changes { get; }

		void ThrowOnInvalidStateTransition (ICommand c);

		void Create (ICreateInventoryItemEntryMvo c);

		void MergePatch (IMergePatchInventoryItemEntryMvo c);
