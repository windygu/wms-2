...
namespace Dddml.Wms.Domain.InventoryItemEntryMvo
{
    ...
    public interface IInventoryItemEntryMvoStateDto
    {
        ...
        string InventoryItemCreatedBy
        {
            get;
            set;
        }

        DateTime? InventoryItemCreatedAt
        {
            get;
            set;
        }

        string InventoryItemUpdatedBy
        {
            get;
            set;
        }

        DateTime? InventoryItemUpdatedAt
        {
            get;
            set;
        }

        long? InventoryItemVersion
        {
            get;
            set;
        }
        ...
        IInventoryItemEntryMvoState ToInventoryItemEntryMvoState();
