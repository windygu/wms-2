...
namespace Dddml.Wms.Domain.PicklistBin
{
	...
	public abstract class PicklistItemStateEventBase : IPicklistItemStateEvent
	{
        ...
        protected PicklistItemStateEventBase()
        {
        }

        protected PicklistItemStateEventBase(PicklistItemEventId stateEventId)
        {
