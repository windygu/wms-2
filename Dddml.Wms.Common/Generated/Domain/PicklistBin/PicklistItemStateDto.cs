...
namespace Dddml.Wms.Domain.PicklistBin
{
    ...
    public partial class PicklistItemStateDto : IPicklistItemStateDto
    {
        ...
        public virtual IPicklistItemState ToPicklistItemState()
        {
            var state = new PicklistItemState(true);
            state.PicklistItemOrderShipGrpInvId = this.PicklistItemOrderShipGrpInvId;
