...
namespace Dddml.Wms.Domain.ShipmentPackageContentMvo
{
	...
	public abstract class ShipmentPackageContentMvoCommandDtoBase : ICommandDto, ICreateShipmentPackageContentMvo, IMergePatchShipmentPackageContentMvo, IDeleteShipmentPackageContentMvo
	{
		...
		long IAggregateCommand<ShipmentPackageContentId, long>.AggregateVersion
		{
			get
			{
				return this.ShipmentPackageVersion != null ? this.ShipmentPackageVersion.Value : default(long);
			}
		}

        long IShipmentPackageContentMvoCommand.ShipmentPackageVersion
        {
            get { return this.ShipmentPackageVersion != null ? this.ShipmentPackageVersion.Value : default(long); }
            set { this.ShipmentPackageVersion = value; }
        }
