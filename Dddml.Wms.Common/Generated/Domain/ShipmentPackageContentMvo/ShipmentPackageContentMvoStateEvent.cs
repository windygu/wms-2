...
namespace Dddml.Wms.Domain.ShipmentPackageContentMvo
{
	...
	public abstract class ShipmentPackageContentMvoStateEventBase : IShipmentPackageContentMvoStateEvent
	{
        ...
        protected ShipmentPackageContentMvoStateEventBase()
        {
        }

        protected ShipmentPackageContentMvoStateEventBase(ShipmentPackageContentMvoEventId stateEventId)
        {
