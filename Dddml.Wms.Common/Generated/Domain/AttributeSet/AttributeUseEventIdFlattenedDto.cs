...
namespace Dddml.Wms.Domain.AttributeSet
{
	...
	public class AttributeUseEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private AttributeUseEventIdDto _value = new AttributeUseEventIdDto();

		public AttributeUseEventIdFlattenedDto()
		{
		}

		public AttributeUseEventIdFlattenedDto(AttributeUseEventIdDto val)
		{
			this._value = val;
		}

        public AttributeUseEventIdDto ToAttributeUseEventIdDto()
        {
            return this._value;
        }

		public AttributeUseEventIdFlattenedDto(AttributeUseEventId val)
		{
			this._value = new AttributeUseEventIdDtoWrapper(val);
		}

        public AttributeUseEventId ToAttributeUseEventId()
        {
            return this._value.ToAttributeUseEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			AttributeUseEventIdFlattenedDto other = obj as AttributeUseEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class AttributeUseEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<AttributeUseEventIdFlattenedDto>
    {
