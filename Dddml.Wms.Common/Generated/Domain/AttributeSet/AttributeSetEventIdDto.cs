...
namespace Dddml.Wms.Domain.AttributeSet
{
	...
	public class AttributeSetEventIdDto
	{

		public AttributeSetEventIdDto()
		{
		}

        public virtual AttributeSetEventId ToAttributeSetEventId()
        {
            AttributeSetEventId v = new AttributeSetEventId();
		...
		public override bool Equals (object obj)
		{
			...
			AttributeSetEventIdDto other = obj as AttributeSetEventIdDto;
			if (other == null) {
				return false;
			}
