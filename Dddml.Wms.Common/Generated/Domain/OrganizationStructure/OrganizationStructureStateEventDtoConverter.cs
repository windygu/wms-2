...
namespace Dddml.Wms.Domain.OrganizationStructure
{
    ...
    {
        public virtual OrganizationStructureStateCreatedOrMergePatchedOrDeletedDto ToOrganizationStructureStateEventDto(IOrganizationStructureEvent stateEvent)
        {
