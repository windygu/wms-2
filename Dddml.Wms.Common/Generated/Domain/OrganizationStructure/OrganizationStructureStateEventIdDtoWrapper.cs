...
namespace Dddml.Wms.Domain.OrganizationStructure
{
	...
	public class OrganizationStructureStateEventIdDtoWrapper : OrganizationStructureStateEventIdDto
	{
		...
		public OrganizationStructureStateEventIdDtoWrapper(OrganizationStructureStateEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override OrganizationStructureStateEventId ToOrganizationStructureStateEventId()
        {
            return this._value;
        }
