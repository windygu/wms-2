...
namespace Dddml.Wms.Domain.Product
{
	...
	public partial class ProductState : ProductStateProperties, IProductState
	{
        ...
        public ProductState(IEnumerable<IEvent> events) : this(true)
        {
            ...
            {
                this.ProductId = ((IProductStateEvent)events.First()).StateEventId.ProductId;
        ...
        protected void ThrowOnWrongEvent(IProductStateEvent stateEvent)
        {
            ...
            var eventEntityId = stateEvent.StateEventId.ProductId; // EntityBase.Aggregate.GetStateEventIdPropertyIdName();
