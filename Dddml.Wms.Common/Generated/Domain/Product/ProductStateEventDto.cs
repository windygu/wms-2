...
namespace Dddml.Wms.Domain.Product
{
	...
	public abstract class ProductStateEventDtoBase : IEventDto, IProductStateCreated, IProductStateMergePatched
	{
        ...
        bool IProductStateMergePatched.IsPropertyRollCntRemoved
        {
            get 
            {
    ...
    public partial class ProductStateCreatedOrMergePatchedOrDeletedDtos : IEnumerable<IProductStateCreated>, IEnumerable<IProductStateMergePatched>
    {
        ...
        public void AddProductEvent(IProductEvent e)
        {
