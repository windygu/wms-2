...
namespace Dddml.Wms.Domain.Product
{
	...
	public class ProductEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private ProductEventIdDto _value = new ProductEventIdDto();

		public ProductEventIdFlattenedDto()
		{
		}

		public ProductEventIdFlattenedDto(ProductEventIdDto val)
		{
			this._value = val;
		}

        public ProductEventIdDto ToProductEventIdDto()
        {
            return this._value;
        }

		public ProductEventIdFlattenedDto(ProductEventId val)
		{
			this._value = new ProductEventIdDtoWrapper(val);
		}

        public ProductEventId ToProductEventId()
        {
            return this._value.ToProductEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			ProductEventIdFlattenedDto other = obj as ProductEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class ProductEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<ProductEventIdFlattenedDto>
    {
