...
namespace Dddml.Wms.Domain.OrderShipGroupMvo
{
	...
	public abstract class OrderShipGroupMvoStateEventBase : IOrderShipGroupMvoStateEvent
	{
        ...
        protected OrderShipGroupMvoStateEventBase()
        {
        }

        protected OrderShipGroupMvoStateEventBase(OrderShipGroupMvoEventId stateEventId)
        {
