...
namespace Dddml.Wms.Domain.SupplierProduct
{
	...
	public partial class SupplierProductState : SupplierProductStateProperties, ISupplierProductState
	{
        ...
        public SupplierProductState(IEnumerable<IEvent> events) : this(true)
        {
            ...
            {
                this.SupplierProductId = ((ISupplierProductStateEvent)events.First()).StateEventId.SupplierProductId;
        ...
        protected void ThrowOnWrongEvent(ISupplierProductStateEvent stateEvent)
        {
            ...
            var eventEntityId = stateEvent.StateEventId.SupplierProductId; // EntityBase.Aggregate.GetStateEventIdPropertyIdName();
