...
namespace Dddml.Wms.Domain.Lot
{
	...
	public class LotEventId
	{
		...
		public override bool Equals (object obj)
		{
			...
			LotEventId other = obj as LotEventId;
			if (other == null) {
				return false;
			}
        ...
        public static bool operator ==(LotEventId obj1, LotEventId obj2)
        {
        ...
        protected internal static readonly string[] FlattenedPropertyNames = new string[] { "LotId", "Version" };
