...
namespace Dddml.Wms.Domain.DamageType
{
	...
	public class DamageTypeStateEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private DamageTypeStateEventIdDto _value = new DamageTypeStateEventIdDto();

		public DamageTypeStateEventIdFlattenedDto()
		{
		}

		public DamageTypeStateEventIdFlattenedDto(DamageTypeStateEventIdDto val)
		{
			this._value = val;
		}
		...
		public DamageTypeStateEventIdFlattenedDto(DamageTypeStateEventId val)
		{
			this._value = new DamageTypeStateEventIdDtoWrapper(val);
		}

        public DamageTypeStateEventId ToDamageTypeStateEventId()
        {
            return this._value.ToDamageTypeStateEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			DamageTypeStateEventIdFlattenedDto other = obj as DamageTypeStateEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class DamageTypeStateEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<DamageTypeStateEventIdFlattenedDto>
    {
