...
namespace Dddml.Wms.Domain.DamageType
{
	...
	public interface IDamageTypeStateCreated : IDamageTypeStateEvent//, IDamageTypeStateProperties
	{
	
	}


	public interface IDamageTypeStateMergePatched : IDamageTypeStateEvent//, IDamageTypeStateProperties
	{
