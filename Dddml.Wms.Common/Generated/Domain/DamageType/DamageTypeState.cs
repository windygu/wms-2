...
namespace Dddml.Wms.Domain.DamageType
{
	...
	public partial class DamageTypeState : DamageTypeStateProperties, IDamageTypeState
	{
        ...
        public DamageTypeState(IEnumerable<IEvent> events) : this(true)
        {
            ...
            {
                this.DamageTypeId = ((IDamageTypeStateEvent)events.First()).StateEventId.DamageTypeId;
        ...
        protected void ThrowOnWrongEvent(IDamageTypeStateEvent stateEvent)
        {
            ...
            var eventEntityId = stateEvent.StateEventId.DamageTypeId; // EntityBase.Aggregate.GetStateEventIdPropertyIdName();
