...
namespace Dddml.Wms.Domain.DocumentType
{
	...
	public class DocumentTypeStateEventIdDtoWrapper : DocumentTypeStateEventIdDto
	{

        private DocumentTypeStateEventId _value = new DocumentTypeStateEventId();

		public DocumentTypeStateEventIdDtoWrapper()
		{
		}

		public DocumentTypeStateEventIdDtoWrapper(DocumentTypeStateEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override DocumentTypeStateEventId ToDocumentTypeStateEventId()
        {
            return this._value;
        }
