...
namespace Dddml.Wms.Domain.DocumentType
{
	...
	public partial class DocumentTypeState : DocumentTypeStateProperties, IDocumentTypeState
	{
        ...
        public DocumentTypeState(IEnumerable<IEvent> events) : this(true)
        {
        ...
        public DocumentTypeState() : this(false)
        {
        }

        public DocumentTypeState(bool forReapplying)
        {
        ...
        protected void ThrowOnWrongEvent(IDocumentTypeStateEvent stateEvent)
        {
            ...
            var eventEntityId = stateEvent.StateEventId.DocumentTypeId; // EntityBase.Aggregate.GetStateEventIdPropertyIdName();
