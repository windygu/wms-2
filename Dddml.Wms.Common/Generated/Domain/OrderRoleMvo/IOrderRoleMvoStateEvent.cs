...
{
	public interface IOrderRoleMvoStateEvent : IEvent, IStateEventDto, IGlobalIdentity<OrderRoleMvoEventId>, ICreated<string>
	{
	...
	public interface IOrderRoleMvoStateCreated : IOrderRoleMvoStateEvent//, IOrderRoleMvoStateProperties
	{
	
	}


	public interface IOrderRoleMvoStateMergePatched : IOrderRoleMvoStateEvent//, IOrderRoleMvoStateProperties
	{
