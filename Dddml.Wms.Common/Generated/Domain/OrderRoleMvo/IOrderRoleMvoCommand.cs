...
{
	public interface IOrderRoleMvoCommand : IAggregateCommand<OrderRoleId, long>, ICommandDto
	{
		long OrderVersion { get; set; }

		OrderRoleId OrderRoleId { get; set; }

	}


	public interface ICreateOrMergePatchOrDeleteOrderRoleMvo : IOrderRoleMvoCommand
	{
	...
	public interface ICreateOrderRoleMvo : ICreateOrMergePatchOrDeleteOrderRoleMvo
	{
	}

	public interface IMergePatchOrderRoleMvo : ICreateOrMergePatchOrDeleteOrderRoleMvo
	{
	...
	public interface IDeleteOrderRoleMvo : ICreateOrMergePatchOrDeleteOrderRoleMvo
	{
	}
