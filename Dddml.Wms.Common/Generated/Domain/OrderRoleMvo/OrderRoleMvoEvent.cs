...
namespace Dddml.Wms.Domain.OrderRoleMvo
{
	...
	public abstract class OrderRoleMvoEventBase : IOrderRoleMvoEvent
	{
        ...
        protected OrderRoleMvoEventBase()
        {
        }

        protected OrderRoleMvoEventBase(OrderRoleMvoEventId stateEventId)
        {
