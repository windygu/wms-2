...
{
	public interface IContactMechStateEvent : IEvent, IStateEventDto, IGlobalIdentity<ContactMechEventId>, ICreated<string>
	{
	...
	public interface IContactMechStateCreated : IContactMechStateEvent//, IContactMechStateProperties
	{
	
	}


	public interface IContactMechStateMergePatched : IContactMechStateEvent//, IContactMechStateProperties
	{
