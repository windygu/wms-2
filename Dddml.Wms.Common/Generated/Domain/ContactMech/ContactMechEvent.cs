...
namespace Dddml.Wms.Domain.ContactMech
{
	...
	public abstract class ContactMechEventBase : IContactMechEvent
	{
        ...
        protected ContactMechEventBase()
        {
        }

        protected ContactMechEventBase(ContactMechEventId stateEventId)
        {
