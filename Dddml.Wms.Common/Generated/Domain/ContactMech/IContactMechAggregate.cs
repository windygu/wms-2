...
namespace Dddml.Wms.Domain.ContactMech
{
	...
	public partial interface IContactMechAggregate : IGlobalIdentity<string>
	{
		IContactMechState State { get; }

		IList<IEvent> Changes { get; }

		void ThrowOnInvalidStateTransition (ICommand c);

		void Create (ICreateContactMech c);

		void MergePatch (IMergePatchContactMech c);

		void Delete (IDeleteContactMech c);
