...
namespace Dddml.Wms.Domain
{
	...
	public partial class RoleStateDtoWrapper : StateDtoWrapperBase, IRoleStateDto, IRoleState
	{
        ...
        {
            get { return this.Version == RoleState.VersionZero; }
        }
    ...
    partial class RoleStateDtoWrapperCollection : StateDtoWrapperCollectionBase<RoleStateDtoWrapper>
    {

        protected override bool IsCollectionField(string fieldName)
        {
            return CollectionUtils.CollectionContainsIgnoringCase(RoleStateDtoWrapper._collectionFieldNames, fieldName);
        }
