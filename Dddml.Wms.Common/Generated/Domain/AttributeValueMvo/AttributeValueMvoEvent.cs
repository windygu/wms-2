...
namespace Dddml.Wms.Domain.AttributeValueMvo
{
    ...
    public abstract class AttributeValueMvoStateEventBase : AttributeValueMvoEventBase, IAttributeValueMvoStateEvent
    {
        ...
        protected AttributeValueMvoStateEventBase() : base()
        {
        }
