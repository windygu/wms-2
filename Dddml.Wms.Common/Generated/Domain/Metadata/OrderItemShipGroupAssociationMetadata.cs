...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class OrderItemShipGroupAssociationMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                ...
                new PropertyMetadata {
                    Name = "NumberOfPakagesPerContainer",
                    Type = typeof(int),
                    TypeName = "int",
                    IsSimpleValueObjectType = true,
                    IsNullableType = false,
                ...
                new PropertyMetadata {
                    Name = "OrderItemShipGroupAssociationKey",
                    Type = typeof(string),
                    TypeName = "string",
                    IsSimpleValueObjectType = true,
                    IsNullableType = false,
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("numberOfPackages", "NumberOfPackages");
            d.Add("NumberOfContainers", "NumberOfContainers");
            d.Add("numberOfContainers", "NumberOfContainers");
            d.Add("NumberOfPakagesPerContainer", "NumberOfPakagesPerContainer");
            d.Add("numberOfPakagesPerContainer", "NumberOfPakagesPerContainer");
            d.Add("OrderItemShipGroupAssociationKey", "OrderItemShipGroupAssociationKey");
            d.Add("orderItemShipGroupAssociationKey", "OrderItemShipGroupAssociationKey");
