    ...
    public class ProductCategoryMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                ...
                new PropertyMetadata {
                    ...
                    ReferenceName = "PrimaryParentCategoryId",
                    ItemTypeName = "",
                    InverseOf = "",
                    IsHoisted = false,
                    IsId = false,
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("ProductCategoryId", "ProductCategoryId");
            d.Add("productCategoryId", "ProductCategoryId");
            d.Add("ProductCategoryTypeId", "ProductCategoryTypeId");
            d.Add("productCategoryTypeId", "ProductCategoryTypeId");
            d.Add("PrimaryParentCategoryId", "PrimaryParentCategoryId");
            d.Add("primaryParentCategoryId", "PrimaryParentCategoryId");
            d.Add("CategoryName", "CategoryName");
            d.Add("categoryName", "CategoryName");
            d.Add("Description", "Description");
            d.Add("description", "Description");
            d.Add("CategoryImageUrl", "CategoryImageUrl");
            d.Add("categoryImageUrl", "CategoryImageUrl");
        ...
        static ProductCategoryMetadata()
        {
        ...
        private static ProductCategoryMetadata _instance = new ProductCategoryMetadata();

        public static ProductCategoryMetadata Instance
        {
            get
            {
                return _instance;
