...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class LocatorTypeMetadata
    {
        ...
        private static LocatorTypeMetadata _instance = new LocatorTypeMetadata();

        public static LocatorTypeMetadata Instance
        {
            get
            {
                return _instance;
