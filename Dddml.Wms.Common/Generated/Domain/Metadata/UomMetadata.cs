...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class UomMetadata
    {
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("uomTypeId", "UomTypeId");
            d.Add("Abbreviation", "Abbreviation");
            d.Add("abbreviation", "Abbreviation");
        ...
        private static UomMetadata _instance = new UomMetadata();

        public static UomMetadata Instance
        {
            get
            {
                return _instance;
