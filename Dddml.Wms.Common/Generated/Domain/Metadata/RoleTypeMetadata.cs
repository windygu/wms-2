...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class RoleTypeMetadata
    {
        ...
        private static RoleTypeMetadata _instance = new RoleTypeMetadata();

        public static RoleTypeMetadata Instance
        {
            get
            {
                return _instance;
