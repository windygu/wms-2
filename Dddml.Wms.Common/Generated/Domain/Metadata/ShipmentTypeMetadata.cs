...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class ShipmentTypeMetadata
    {
        ...
        private static ShipmentTypeMetadata _instance = new ShipmentTypeMetadata();

        public static ShipmentTypeMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected ShipmentTypeMetadata()
        { 
        }
