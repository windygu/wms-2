...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class AttributeAliasMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                new PropertyMetadata {
                    ...
                    IsDerived = true,
                    IsOuterId = true,
                    DerivedFrom = "AttributeAliasId.Code",
                ...
                new PropertyMetadata {
                    ...
                    IsDerived = true,
                    IsOuterId = true,
                    DerivedFrom = "AttributeAliasId.AttributeId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("Code", "AttributeAliasId.Code");
            d.Add("code", "AttributeAliasId.Code");
            d.Add("Name", "Name");
            d.Add("name", "Name");
            ...
            d.Add("deleted", "Deleted");
            d.Add("AttributeId", "AttributeAliasId.AttributeId");
            d.Add("attributeId", "AttributeAliasId.AttributeId");
        ...
        private static AttributeAliasMetadata _instance = new AttributeAliasMetadata();

        public static AttributeAliasMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected AttributeAliasMetadata()
        { 
        }
