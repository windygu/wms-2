...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class UomTypeMetadata
    {
        ...
        private static UomTypeMetadata _instance = new UomTypeMetadata();

        public static UomTypeMetadata Instance
        {
            get
            {
                return _instance;
