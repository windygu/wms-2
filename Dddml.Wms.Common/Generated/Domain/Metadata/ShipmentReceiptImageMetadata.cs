...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class ShipmentReceiptImageMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                new PropertyMetadata {
                    ...
                    IsDerived = true,
                    IsOuterId = true,
                    DerivedFrom = "ShipmentReceiptImageId.SequenceId",
                ...
                new PropertyMetadata {
                    Name = "ShipmentReceiptImageId",
                    Type = typeof(ShipmentReceiptImageId),
                    TypeName = "ShipmentReceiptImageId",
                ...
                new PropertyMetadata {
                    ...
                    IsDerived = true,
                    IsOuterId = true,
                    DerivedFrom = "ShipmentReceiptImageId.ShipmentId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
                ...
                new PropertyMetadata {
                    Name = "ShipmentReceiptReceiptSeqId",
                    Type = typeof(string),
                    TypeName = "string",
                    IsSimpleValueObjectType = true,
                    IsNullableType = false,
                    ...
                    IsDerived = true,
                    IsOuterId = true,
                    DerivedFrom = "ShipmentReceiptImageId.ShipmentReceiptReceiptSeqId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
                ...
                new PropertyMetadata {
                    Name = "ShipmentReceiptImageId.ShipmentId",
                    Type = typeof(string),
                    TypeName = "string",
                    IsSimpleValueObjectType = true,
                    IsNullableType = false,
                    ...
                    SourceChainingName = "ShipmentReceiptImageId.ShipmentId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
                ...
                new PropertyMetadata {
                    Name = "ShipmentReceiptImageId.ShipmentReceiptReceiptSeqId",
                    Type = typeof(string),
                    TypeName = "string",
                    IsSimpleValueObjectType = true,
                    IsNullableType = false,
                    ...
                    IsDerived = false,
                    IsReallyFlattened = false,
                    SourceChainingName = "ShipmentReceiptImageId.ShipmentReceiptReceiptSeqId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
                ...
                new PropertyMetadata {
                    Name = "ShipmentReceiptImageId.SequenceId",
                    Type = typeof(string),
                    TypeName = "string",
                    IsSimpleValueObjectType = true,
                    IsNullableType = false,
                    ...
                    IsDerived = false,
                    IsReallyFlattened = false,
                    SourceChainingName = "ShipmentReceiptImageId.SequenceId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("SequenceId", "ShipmentReceiptImageId.SequenceId");
            d.Add("sequenceId", "ShipmentReceiptImageId.SequenceId");
            d.Add("Url", "Url");
            d.Add("url", "Url");
            ...
            d.Add("deleted", "Deleted");
            d.Add("ShipmentId", "ShipmentReceiptImageId.ShipmentId");
            d.Add("shipmentId", "ShipmentReceiptImageId.ShipmentId");
            d.Add("ShipmentReceiptReceiptSeqId", "ShipmentReceiptImageId.ShipmentReceiptReceiptSeqId");
            d.Add("shipmentReceiptReceiptSeqId", "ShipmentReceiptImageId.ShipmentReceiptReceiptSeqId");
            d.Add("ShipmentReceiptImageId.ShipmentId", "ShipmentReceiptImageId.ShipmentId");
            d.Add("shipmentReceiptImageId.shipmentId", "ShipmentReceiptImageId.ShipmentId");
            d.Add("ShipmentReceiptImageId.ShipmentReceiptReceiptSeqId", "ShipmentReceiptImageId.ShipmentReceiptReceiptSeqId");
            d.Add("shipmentReceiptImageId.shipmentReceiptReceiptSeqId", "ShipmentReceiptImageId.ShipmentReceiptReceiptSeqId");
            d.Add("ShipmentReceiptImageId.SequenceId", "ShipmentReceiptImageId.SequenceId");
            d.Add("shipmentReceiptImageId.sequenceId", "ShipmentReceiptImageId.SequenceId");
            _filteringPropertyAliasDictionary = d;
        }

        static ShipmentReceiptImageMetadata()
        {
        ...
        private static ShipmentReceiptImageMetadata _instance = new ShipmentReceiptImageMetadata();

        public static ShipmentReceiptImageMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected ShipmentReceiptImageMetadata()
        { 
        }
