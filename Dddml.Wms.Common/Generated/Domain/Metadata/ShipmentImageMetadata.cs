...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class ShipmentImageMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                new PropertyMetadata {
                    ...
                    IsDerived = true,
                    IsOuterId = true,
                    DerivedFrom = "ShipmentImageId.SequenceId",
                ...
                new PropertyMetadata {
                    Name = "ShipmentImageId",
                    Type = typeof(ShipmentImageId),
                    TypeName = "ShipmentImageId",
                ...
                new PropertyMetadata {
                    ...
                    IsDerived = true,
                    IsOuterId = true,
                    DerivedFrom = "ShipmentImageId.ShipmentId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
                ...
                new PropertyMetadata {
                    Name = "ShipmentImageId.ShipmentId",
                    Type = typeof(string),
                    TypeName = "string",
                    IsSimpleValueObjectType = true,
                    IsNullableType = false,
                    ...
                    SourceChainingName = "ShipmentImageId.ShipmentId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
                ...
                new PropertyMetadata {
                    Name = "ShipmentImageId.SequenceId",
                    Type = typeof(string),
                    TypeName = "string",
                    IsSimpleValueObjectType = true,
                    IsNullableType = false,
                    ...
                    IsDerived = false,
                    IsReallyFlattened = false,
                    SourceChainingName = "ShipmentImageId.SequenceId",
                    IsDiscriminator = false,
                    IsReservedProperty = false,
                    IsReservedPropertyVersion = false,
                    IsReservedPropertyDeleted = false,
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("SequenceId", "ShipmentImageId.SequenceId");
            d.Add("sequenceId", "ShipmentImageId.SequenceId");
            d.Add("Url", "Url");
            d.Add("url", "Url");
            ...
            d.Add("deleted", "Deleted");
            d.Add("ShipmentId", "ShipmentImageId.ShipmentId");
            d.Add("shipmentId", "ShipmentImageId.ShipmentId");
            d.Add("ShipmentImageId.ShipmentId", "ShipmentImageId.ShipmentId");
            d.Add("shipmentImageId.shipmentId", "ShipmentImageId.ShipmentId");
            d.Add("ShipmentImageId.SequenceId", "ShipmentImageId.SequenceId");
            d.Add("shipmentImageId.sequenceId", "ShipmentImageId.SequenceId");
            _filteringPropertyAliasDictionary = d;
        }

        static ShipmentImageMetadata()
        {
        ...
        private static ShipmentImageMetadata _instance = new ShipmentImageMetadata();

        public static ShipmentImageMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected ShipmentImageMetadata()
        { 
        }
