...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class PickwaveMetadata
    {
        ...
        private static PickwaveMetadata _instance = new PickwaveMetadata();

        public static PickwaveMetadata Instance
        {
            get
            {
                return _instance;
