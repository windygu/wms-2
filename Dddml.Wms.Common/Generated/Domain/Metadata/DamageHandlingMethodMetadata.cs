...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class DamageHandlingMethodMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                new PropertyMetadata {
                    Name = "DamageHandlingMethodId",
                    Type = typeof(string),
                    TypeName = "string",
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("DamageHandlingMethodId", "DamageHandlingMethodId");
            d.Add("damageHandlingMethodId", "DamageHandlingMethodId");
        ...
        static DamageHandlingMethodMetadata()
        {
        ...
        private static DamageHandlingMethodMetadata _instance = new DamageHandlingMethodMetadata();

        public static DamageHandlingMethodMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected DamageHandlingMethodMetadata()
        { 
        }
