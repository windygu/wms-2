    ...
    public class DamageTypeMetadata
    {
        private static PropertyMetadata[] _properties = new PropertyMetadata[]{
                ...
                new PropertyMetadata {
                    ...
                    Length = 0,
                    GenericTypeName = "",
                    ReferenceTypeName = "DamageHandlingMethod",
                    ReferenceName = "",
                    ItemTypeName = "",
                    InverseOf = "",
                    IsHoisted = false,
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("DamageTypeId", "DamageTypeId");
            d.Add("damageTypeId", "DamageTypeId");
            d.Add("Description", "Description");
            d.Add("description", "Description");
            d.Add("SequenceId", "SequenceId");
            d.Add("sequenceId", "SequenceId");
            d.Add("DefaultHandlingMethodId", "DefaultHandlingMethodId");
            d.Add("defaultHandlingMethodId", "DefaultHandlingMethodId");
        ...
        private static DamageTypeMetadata _instance = new DamageTypeMetadata();

        public static DamageTypeMetadata Instance
        {
            get
            {
                return _instance;
