...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class OrderRoleMvoMetadata
    {
        ...
        private static OrderRoleMvoMetadata _instance = new OrderRoleMvoMetadata();

        public static OrderRoleMvoMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected OrderRoleMvoMetadata()
        { 
        }
