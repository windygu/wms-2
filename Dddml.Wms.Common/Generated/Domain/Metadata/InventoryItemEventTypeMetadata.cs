...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class InventoryItemEventTypeMetadata
    {
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("InventoryItemEventTypeId", "InventoryItemEventTypeId");
            d.Add("inventoryItemEventTypeId", "InventoryItemEventTypeId");
        ...
        static InventoryItemEventTypeMetadata()
        {
        ...
        private static InventoryItemEventTypeMetadata _instance = new InventoryItemEventTypeMetadata();

        public static InventoryItemEventTypeMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected InventoryItemEventTypeMetadata()
        { 
        }
