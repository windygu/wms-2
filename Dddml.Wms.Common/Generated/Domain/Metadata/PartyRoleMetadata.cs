...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class PartyRoleMetadata
    {
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("deleted", "Deleted");
            d.Add("PartyRoleId.PartyId", "PartyRoleId.PartyId");
            d.Add("partyRoleId.partyId", "PartyRoleId.PartyId");
            d.Add("PartyRoleId.RoleTypeId", "PartyRoleId.RoleTypeId");
            d.Add("partyRoleId.roleTypeId", "PartyRoleId.RoleTypeId");
            _filteringPropertyAliasDictionary = d;
        }

        static PartyRoleMetadata()
        {
        ...
        private static PartyRoleMetadata _instance = new PartyRoleMetadata();

        public static PartyRoleMetadata Instance
        {
            get
            {
                return _instance;
