...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class PicklistMetadata
    {
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("statusId", "StatusId");
            d.Add("PicklistDate", "PicklistDate");
            d.Add("picklistDate", "PicklistDate");
        ...
        private static PicklistMetadata _instance = new PicklistMetadata();

        public static PicklistMetadata Instance
        {
            get
            {
                return _instance;
