...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class DocumentTypeMetadata
    {
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("description", "Description");
            d.Add("ParentDocumentTypeId", "ParentDocumentTypeId");
            d.Add("parentDocumentTypeId", "ParentDocumentTypeId");
        ...
        private static DocumentTypeMetadata _instance = new DocumentTypeMetadata();

        public static DocumentTypeMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected DocumentTypeMetadata()
        { 
        }
