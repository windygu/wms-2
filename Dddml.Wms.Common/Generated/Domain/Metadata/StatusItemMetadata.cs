...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class StatusItemMetadata
    {
        ...
        private static void InitFilteringPropertyAliasDictionary()
        {
            ...
            d.Add("statusId", "StatusId");
            d.Add("StatusTypeId", "StatusTypeId");
            d.Add("statusTypeId", "StatusTypeId");
        ...
        private static StatusItemMetadata _instance = new StatusItemMetadata();

        public static StatusItemMetadata Instance
        {
            get
            {
                return _instance;
