...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class RejectionReasonMetadata
    {
        ...
        static RejectionReasonMetadata()
        {
        ...
        private static RejectionReasonMetadata _instance = new RejectionReasonMetadata();

        public static RejectionReasonMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected RejectionReasonMetadata()
        { 
        }
