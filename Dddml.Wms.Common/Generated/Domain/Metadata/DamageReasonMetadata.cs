...
namespace Dddml.Wms.Domain.Metadata
{
    ...
    public class DamageReasonMetadata
    {
        ...
        private static DamageReasonMetadata _instance = new DamageReasonMetadata();

        public static DamageReasonMetadata Instance
        {
            get
            {
                return _instance;
        ...
        protected DamageReasonMetadata()
        { 
        }
