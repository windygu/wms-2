...
namespace Dddml.Wms.Domain.UomConversion
{
	...
	public partial class UomConversionState : UomConversionStateProperties, IUomConversionState
	{
        ...
        public UomConversionState(IEnumerable<IEvent> events) : this(true)
        {
            if (events != null && events.Count() > 0)
            {
                this.UomConversionId = ((IUomConversionStateEvent)events.First()).StateEventId.UomConversionId;
        ...
        public UomConversionState() : this(false)
        {
        }

        public UomConversionState(bool forReapplying)
        {
		...
		public virtual void When(IUomConversionStateCreated e)
		{
			ThrowOnWrongEvent(e);
		...
		public virtual void When(IUomConversionStateDeleted e)
		{
			ThrowOnWrongEvent(e);
        ...
        protected void ThrowOnWrongEvent(IUomConversionStateEvent stateEvent)
        {
            ...
            var stateEntityId = this.UomConversionId; // Aggregate Id
            var eventEntityId = stateEvent.StateEventId.UomConversionId; // EntityBase.Aggregate.GetStateEventIdPropertyIdName();
