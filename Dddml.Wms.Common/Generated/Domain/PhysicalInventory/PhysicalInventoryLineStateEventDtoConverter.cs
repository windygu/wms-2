...
namespace Dddml.Wms.Domain.PhysicalInventory
{
    ...
    {
        public virtual PhysicalInventoryLineStateCreatedOrMergePatchedOrRemovedDto ToPhysicalInventoryLineStateEventDto(IPhysicalInventoryLineEvent stateEvent)
        {
