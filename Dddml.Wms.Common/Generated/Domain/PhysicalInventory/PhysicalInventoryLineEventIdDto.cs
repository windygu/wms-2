...
namespace Dddml.Wms.Domain.PhysicalInventory
{
	...
	public class PhysicalInventoryLineEventIdDto
	{

		public PhysicalInventoryLineEventIdDto()
		{
		}

        public virtual PhysicalInventoryLineEventId ToPhysicalInventoryLineEventId()
        {
            PhysicalInventoryLineEventId v = new PhysicalInventoryLineEventId();
		...
		public override bool Equals (object obj)
		{
			...
			PhysicalInventoryLineEventIdDto other = obj as PhysicalInventoryLineEventIdDto;
			if (other == null) {
				return false;
			}
