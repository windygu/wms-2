...
namespace Dddml.Wms.Domain.LocatorType
{
	...
	public partial interface ILocatorTypeAggregate : IGlobalIdentity<string>
	{
		ILocatorTypeState State { get; }

		IList<IEvent> Changes { get; }

		void ThrowOnInvalidStateTransition (ICommand c);

		void Create (ICreateLocatorType c);

		void MergePatch (IMergePatchLocatorType c);

		void Delete (IDeleteLocatorType c);
