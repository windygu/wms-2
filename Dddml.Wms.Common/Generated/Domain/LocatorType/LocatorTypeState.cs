...
namespace Dddml.Wms.Domain.LocatorType
{
	...
	public partial class LocatorTypeState : LocatorTypeStateProperties, ILocatorTypeState
	{
        ...
        public LocatorTypeState(IEnumerable<IEvent> events) : this(true)
        {
        ...
        public LocatorTypeState() : this(false)
        {
        }

        public LocatorTypeState(bool forReapplying)
        {
		...
		public virtual void When(ILocatorTypeStateMergePatched e)
		{
			ThrowOnWrongEvent(e);
		...
		public virtual void When(ILocatorTypeStateDeleted e)
		{
			ThrowOnWrongEvent(e);
