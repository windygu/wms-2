...
namespace Dddml.Wms.Domain.AttributeSetInstance
{
	...
	public class AttributeSetInstanceEventIdDto
	{

		public AttributeSetInstanceEventIdDto()
		{
		}

        public virtual AttributeSetInstanceEventId ToAttributeSetInstanceEventId()
        {
            AttributeSetInstanceEventId v = new AttributeSetInstanceEventId();
		...
		public override bool Equals (object obj)
		{
			...
			AttributeSetInstanceEventIdDto other = obj as AttributeSetInstanceEventIdDto;
			if (other == null) {
				return false;
			}
