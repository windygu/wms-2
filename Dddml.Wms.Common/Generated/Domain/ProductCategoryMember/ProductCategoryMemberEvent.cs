...
namespace Dddml.Wms.Domain.ProductCategoryMember
{
	...
	public abstract class ProductCategoryMemberEventBase : IProductCategoryMemberEvent
	{
        ...
        protected ProductCategoryMemberEventBase()
        {
        }

        protected ProductCategoryMemberEventBase(ProductCategoryMemberEventId stateEventId)
        {
