...
namespace Dddml.Wms.Domain.ProductCategoryMember
{
	...
	public class ProductCategoryMemberEventId
	{
		...
		protected internal virtual string ProductCategoryMemberIdProductCategoryId {
			get { return ProductCategoryMemberId.ProductCategoryId; }
			set { ProductCategoryMemberId.ProductCategoryId = value; }
		}

		protected internal virtual string ProductCategoryMemberIdProductId {
        ...
        protected internal static readonly string[] FlattenedPropertyNames = new string[] { "ProductCategoryMemberIdProductCategoryId", "ProductCategoryMemberIdProductId", "Version" };
        ...
        static ProductCategoryMemberEventId()
        {
