...
namespace Dddml.Wms.Domain.Order
{
	...
	public class OrderItemEventIdDto
	{

		public OrderItemEventIdDto()
		{
		}

        public virtual OrderItemEventId ToOrderItemEventId()
        {
            OrderItemEventId v = new OrderItemEventId();
		...
		public override bool Equals (object obj)
		{
			...
			OrderItemEventIdDto other = obj as OrderItemEventIdDto;
			if (other == null) {
				return false;
			}
