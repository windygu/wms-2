...
namespace Dddml.Wms.Domain.Order
{
	...
	public abstract class OrderItemStateEventDtoBase : IEventDto, IOrderItemStateCreated, IOrderItemStateMergePatched
	{

        private OrderItemEventId _orderItemEventId;

		protected internal virtual OrderItemEventId OrderItemEventId 
        {
            get 
            {
                if (_orderItemEventId == null) { _orderItemEventId = new OrderItemEventId(); }
        ...
        OrderItemEventId IOrderItemEvent.OrderItemEventId
        {
            get { return this.OrderItemEventId; }
        }
        ...
        protected OrderItemStateEventDtoBase(OrderItemEventId stateEventId)
        {
    ...
    public class OrderItemStateCreatedOrMergePatchedOrRemovedDto : OrderItemStateEventDtoBase
    {
	...
	public class OrderItemStateCreatedDto : OrderItemStateCreatedOrMergePatchedOrRemovedDto
	{
	...
	public class OrderItemStateMergePatchedDto : OrderItemStateCreatedOrMergePatchedOrRemovedDto
	{
	...
	public class OrderItemStateRemovedDto : OrderItemStateCreatedOrMergePatchedOrRemovedDto
	{
		public OrderItemStateRemovedDto()
		{
		}
    ...
    public partial class OrderItemStateCreatedOrMergePatchedOrRemovedDtos : IEnumerable<IOrderItemStateCreated>, IEnumerable<IOrderItemStateMergePatched>
    {
        private List<OrderItemStateCreatedOrMergePatchedOrRemovedDto> _innerStateEvents = new List<OrderItemStateCreatedOrMergePatchedOrRemovedDto>();

        public virtual OrderItemStateCreatedOrMergePatchedOrRemovedDto[] ToArray()
        {
        ...
        public virtual void AddRange(IEnumerable<OrderItemStateCreatedOrMergePatchedOrRemovedDto> es)
        {
        ...
        public void AddOrderItemEvent(IOrderItemEvent e)
        {
            _innerStateEvents.Add((OrderItemStateCreatedOrMergePatchedOrRemovedDto)e);
        }
