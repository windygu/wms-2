...
namespace Dddml.Wms.Domain.SellableInventoryItemEntryMvo
{
	...
	public abstract class SellableInventoryItemEntryMvoEventBase : ISellableInventoryItemEntryMvoEvent
	{
        ...
        protected SellableInventoryItemEntryMvoEventBase()
        {
        }

        protected SellableInventoryItemEntryMvoEventBase(SellableInventoryItemEntryMvoEventId stateEventId)
        {
