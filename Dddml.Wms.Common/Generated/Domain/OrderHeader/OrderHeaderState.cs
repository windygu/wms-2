...
namespace Dddml.Wms.Domain.OrderHeader
{
	...
	public partial class OrderHeaderState : OrderHeaderStateProperties, IOrderHeaderState
	{
        ...
        public OrderHeaderState(IEnumerable<IEvent> events) : this(true)
        {
            if (events != null && events.Count() > 0)
            {
                this.OrderId = ((IOrderHeaderStateEvent)events.First()).StateEventId.OrderId;
        ...
        public OrderHeaderState() : this(false)
        {
        }

        public OrderHeaderState(bool forReapplying)
        {
		...
		public virtual void When(IOrderHeaderStateCreated e)
		{
			ThrowOnWrongEvent(e);
		...
		public virtual void When(IOrderHeaderStateMergePatched e)
		{
			ThrowOnWrongEvent(e);
        ...
        protected void ThrowOnWrongEvent(IOrderHeaderStateEvent stateEvent)
        {
            var id = new System.Text.StringBuilder(); 
            id.Append("[").Append("OrderHeader|");

            var stateEntityId = this.OrderId; // Aggregate Id
            var eventEntityId = stateEvent.StateEventId.OrderId; // EntityBase.Aggregate.GetStateEventIdPropertyIdName();
