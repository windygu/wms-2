...
namespace Dddml.Wms.Domain.OrderHeader
{
	...
	public partial interface IOrderHeaderAggregate : IGlobalIdentity<string>
	{
		IOrderHeaderState State { get; }

		IList<IEvent> Changes { get; }

		void ThrowOnInvalidStateTransition (ICommand c);

		void Create (ICreateOrderHeader c);

		void MergePatch (IMergePatchOrderHeader c);
