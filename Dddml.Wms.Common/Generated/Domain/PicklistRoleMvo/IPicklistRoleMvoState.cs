...
{
	public interface IPicklistRoleMvoState : IPicklistRoleMvoStateProperties, 
		...
		IState
	{
		...
		void When(IPicklistRoleMvoStateCreated e);

		void When(IPicklistRoleMvoStateMergePatched e);

		void When(IPicklistRoleMvoStateDeleted e);
