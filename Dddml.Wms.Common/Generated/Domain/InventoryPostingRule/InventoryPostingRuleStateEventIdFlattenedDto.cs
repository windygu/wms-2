...
namespace Dddml.Wms.Domain.InventoryPostingRule
{
	...
	public class InventoryPostingRuleStateEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private InventoryPostingRuleStateEventIdDto _value = new InventoryPostingRuleStateEventIdDto();

		public InventoryPostingRuleStateEventIdFlattenedDto()
		{
		}

		public InventoryPostingRuleStateEventIdFlattenedDto(InventoryPostingRuleStateEventIdDto val)
		{
			this._value = val;
		}
		...
		public InventoryPostingRuleStateEventIdFlattenedDto(InventoryPostingRuleStateEventId val)
		{
			this._value = new InventoryPostingRuleStateEventIdDtoWrapper(val);
		}

        public InventoryPostingRuleStateEventId ToInventoryPostingRuleStateEventId()
        {
            return this._value.ToInventoryPostingRuleStateEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			InventoryPostingRuleStateEventIdFlattenedDto other = obj as InventoryPostingRuleStateEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class InventoryPostingRuleStateEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<InventoryPostingRuleStateEventIdFlattenedDto>
    {
