...
{
	public partial interface IInventoryPostingRuleStateQueryRepository
	{
        IInventoryPostingRuleState Get(string id);
        ...
        IInventoryPostingRuleState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null);

        IInventoryPostingRuleState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null);
