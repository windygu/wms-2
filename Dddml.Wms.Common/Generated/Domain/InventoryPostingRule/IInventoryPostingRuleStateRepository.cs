...
{
	public partial interface IInventoryPostingRuleStateRepository
	{

        IInventoryPostingRuleState Get(string id, bool nullAllowed);
        
        void Save(IInventoryPostingRuleState state);
