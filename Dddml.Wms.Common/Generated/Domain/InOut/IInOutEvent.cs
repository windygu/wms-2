...
{
	public interface IInOutEvent : IEvent, IEventDto, IGlobalIdentity<InOutEventId>, ICreated<string>
	{
		InOutEventId InOutEventId { get; }
	...
	public interface IInOutStateCreated : IInOutEvent//, IInOutStateProperties
	{
	...
	public interface IInOutStateMergePatched : IInOutEvent//, IInOutStateProperties
	{
		...
		void AddInOutLineEvent(IInOutLineEvent e);
