...
namespace Dddml.Wms.HttpServices.ClientProxies
{
    ...
    public partial class OrganizationStructureApplicationServiceProxy : IOrganizationStructureApplicationService
    {
        ...
        public async Task<IOrganizationStructureEvent> GetStateEventAsync(OrganizationStructureId id, long version)
        {
            var idObj = OrganizationStructureProxyUtils.ToIdString(id);
        ...
        public IOrganizationStructureEvent GetEvent(OrganizationStructureId id, long version)
        {
            return GetStateEventAsync(id, version).GetAwaiter().GetResult();
        }


        public async Task<IOrganizationStructureState> GetHistoryStateAsync(OrganizationStructureId id, long version)
        {
            var idObj = OrganizationStructureProxyUtils.ToIdString(id);
            var uriParameters = new OrganizationStructureHistoryStateUriParameters();
            uriParameters.Id = idObj;
            uriParameters.Version = version.ToString();
            ...
            OrganizationStructureProxyUtils.ThrowOnHttpResponseError(resp);
            return (resp.Content == null) ? null : resp.Content.ToOrganizationStructureState();
        }
