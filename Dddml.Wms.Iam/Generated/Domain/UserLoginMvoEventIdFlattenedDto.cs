...
namespace Dddml.Wms.Domain.UserLoginMvo
{
	...
	public class UserLoginMvoEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private UserLoginMvoEventIdDto _value = new UserLoginMvoEventIdDto();

		public UserLoginMvoEventIdFlattenedDto()
		{
		}

		public UserLoginMvoEventIdFlattenedDto(UserLoginMvoEventIdDto val)
		{
			this._value = val;
		}

        public UserLoginMvoEventIdDto ToUserLoginMvoEventIdDto()
        {
            return this._value;
        }

		public UserLoginMvoEventIdFlattenedDto(UserLoginMvoEventId val)
		{
			this._value = new UserLoginMvoEventIdDtoWrapper(val);
		}

        public UserLoginMvoEventId ToUserLoginMvoEventId()
        {
            return this._value.ToUserLoginMvoEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			UserLoginMvoEventIdFlattenedDto other = obj as UserLoginMvoEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class UserLoginMvoEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<UserLoginMvoEventIdFlattenedDto>
    {
