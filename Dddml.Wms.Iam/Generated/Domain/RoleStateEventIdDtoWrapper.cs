...
namespace Dddml.Wms.Domain.Role
{
	...
	public class RoleStateEventIdDtoWrapper : RoleStateEventIdDto
	{
		...
		public RoleStateEventIdDtoWrapper(RoleStateEventId val)
		{
			if (val == null) { throw new ArgumentNullException("val"); }
			this._value = val;
		}

        public override RoleStateEventId ToRoleStateEventId()
        {
            return this._value;
        }
