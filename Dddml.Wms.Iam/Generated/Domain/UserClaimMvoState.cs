...
namespace Dddml.Wms.Domain.UserClaimMvo
{
	...
	public partial class UserClaimMvoState : UserClaimMvoStateProperties, IUserClaimMvoState
	{
        ...
        public UserClaimMvoState(IEnumerable<IEvent> events) : this(true)
        {
            if (events != null && events.Count() > 0)
            {
                this.UserClaimId = ((IUserClaimMvoStateEvent)events.First()).StateEventId.UserClaimId;
        ...
        public UserClaimMvoState() : this(false)
        {
        }

        public UserClaimMvoState(bool forReapplying)
        {
        ...
        protected void ThrowOnWrongEvent(IUserClaimMvoStateEvent stateEvent)
        {
            ...
            var eventEntityId = stateEvent.StateEventId.UserClaimId;
