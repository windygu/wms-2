...
namespace Dddml.Wms.Domain.User
{
	...
	public class UserLoginEventIdDto
	{

		public UserLoginEventIdDto()
		{
		}

        public virtual UserLoginEventId ToUserLoginEventId()
        {
            UserLoginEventId v = new UserLoginEventId();
		...
		public override bool Equals (object obj)
		{
			...
			UserLoginEventIdDto other = obj as UserLoginEventIdDto;
			if (other == null) {
				return false;
			}
