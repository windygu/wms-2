...
namespace Dddml.Wms.Domain.User
{
	...
	public class UserPermissionEventIdFlattenedDto : IIdFlattenedDto
	{
        ...
        private UserPermissionEventIdDto _value = new UserPermissionEventIdDto();

		public UserPermissionEventIdFlattenedDto()
		{
		}

		public UserPermissionEventIdFlattenedDto(UserPermissionEventIdDto val)
		{
			this._value = val;
		}

        public UserPermissionEventIdDto ToUserPermissionEventIdDto()
        {
            return this._value;
        }

		public UserPermissionEventIdFlattenedDto(UserPermissionEventId val)
		{
			this._value = new UserPermissionEventIdDtoWrapper(val);
		}

        public UserPermissionEventId ToUserPermissionEventId()
        {
            return this._value.ToUserPermissionEventId();
        }
		...
		public override bool Equals (object obj)
		{
			...
			UserPermissionEventIdFlattenedDto other = obj as UserPermissionEventIdFlattenedDto;
			if (other == null) {
				return false;
			}
    ...
    public class UserPermissionEventIdFlattenedDtoFormatter : IdFlattenedDtoFormatterBase<UserPermissionEventIdFlattenedDto>
    {
