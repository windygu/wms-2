...
namespace Dddml.Wms.Domain.User
{
	...
	public class UserPermissionEventIdDto
	{

		public UserPermissionEventIdDto()
		{
		}

        public virtual UserPermissionEventId ToUserPermissionEventId()
        {
            UserPermissionEventId v = new UserPermissionEventId();
		...
		public override bool Equals (object obj)
		{
			...
			UserPermissionEventIdDto other = obj as UserPermissionEventIdDto;
			if (other == null) {
				return false;
			}
