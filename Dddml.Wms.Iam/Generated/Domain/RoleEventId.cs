...
namespace Dddml.Wms.Domain.Role
{
	...
	public class RoleEventId
	{
		...
		public RoleEventId (string roleId, long version)
		{
			this._roleId = roleId;
		...
		public override bool Equals (object obj)
		{
			...
			RoleEventId other = obj as RoleEventId;
			if (other == null) {
				return false;
			}
        ...
        public static bool operator ==(RoleEventId obj1, RoleEventId obj2)
        {
        ...
        protected internal static readonly string[] FlattenedPropertyNames = new string[] { "RoleId", "Version" };
