...
namespace Dddml.Wms.Domain.UserRoleMvo
{
	...
	public class UserRoleMvoEventIdDto
	{

		public UserRoleMvoEventIdDto()
		{
		}

        public virtual UserRoleMvoEventId ToUserRoleMvoEventId()
        {
            UserRoleMvoEventId v = new UserRoleMvoEventId();
		...
		public override bool Equals (object obj)
		{
			...
			UserRoleMvoEventIdDto other = obj as UserRoleMvoEventIdDto;
			if (other == null) {
				return false;
			}
