...
namespace Dddml.Wms.Domain.User
{
	...
	public class UserLoginEventId
	{
		...
		public UserLoginEventId ()
		{
		}

		public UserLoginEventId (string userId, LoginKey loginKey, long userVersion)
		{
			this._userId = userId;
		...
		public override bool Equals (object obj)
		{
			...
			UserLoginEventId other = obj as UserLoginEventId;
			if (other == null) {
				return false;
			}
        ...
        public static bool operator ==(UserLoginEventId obj1, UserLoginEventId obj2)
        {
        ...
        protected internal static readonly string[] FlattenedPropertyNames = new string[] { "UserId", "LoginKeyLoginProvider", "LoginKeyProviderKey", "UserVersion" };
