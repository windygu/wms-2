...
namespace Dddml.Wms.Domain.UserPermissionMvo
{
	...
	public abstract class UserPermissionMvoEventBase : IUserPermissionMvoEvent
	{
        ...
        bool IUserPermissionMvoEvent.ReadOnly
        {
            get
            {
        ...
        protected UserPermissionMvoEventBase()
        {
        }

        protected UserPermissionMvoEventBase(UserPermissionMvoEventId stateEventId)
        {
	...
	public class UserPermissionMvoStateCreated : UserPermissionMvoEventBase, IUserPermissionMvoStateCreated
	{
	...
	public class UserPermissionMvoStateMergePatched : UserPermissionMvoEventBase, IUserPermissionMvoStateMergePatched
	{
	...
	public class UserPermissionMvoStateDeleted : UserPermissionMvoEventBase, IUserPermissionMvoStateDeleted
	{
