...
namespace Dddml.Wms.Domain.UserPermissionMvo
{
    ...
    public abstract class UserPermissionMvoStateEventBase : UserPermissionMvoEventBase, IUserPermissionMvoStateEvent
    {
        ...
        protected UserPermissionMvoStateEventBase() : base()
        {
        }

        protected UserPermissionMvoStateEventBase(UserPermissionMvoEventId stateEventId) : base(stateEventId)
        {
        }
