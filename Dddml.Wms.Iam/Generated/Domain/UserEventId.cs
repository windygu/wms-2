...
namespace Dddml.Wms.Domain.User
{
	...
	public class UserEventId
	{
		...
		public UserEventId (string userId, long version)
		{
			this._userId = userId;
		...
		public override bool Equals (object obj)
		{
			...
			UserEventId other = obj as UserEventId;
			if (other == null) {
				return false;
			}
        ...
        public static bool operator ==(UserEventId obj1, UserEventId obj2)
        {
        ...
        protected internal static readonly string[] FlattenedPropertyNames = new string[] { "UserId", "Version" };
