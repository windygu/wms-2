...
namespace Dddml.Wms.Domain.UserClaimMvo
{
	...
	public abstract class UserClaimMvoEventBase : IUserClaimMvoEvent
	{
        ...
        protected UserClaimMvoEventBase()
        {
        }

        protected UserClaimMvoEventBase(UserClaimMvoEventId stateEventId)
        {
