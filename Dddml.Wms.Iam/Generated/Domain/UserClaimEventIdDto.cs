...
namespace Dddml.Wms.Domain.User
{
	...
	public class UserClaimEventIdDto
	{

		public UserClaimEventIdDto()
		{
		}

        public virtual UserClaimEventId ToUserClaimEventId()
        {
            UserClaimEventId v = new UserClaimEventId();
		...
		public override bool Equals (object obj)
		{
			...
			UserClaimEventIdDto other = obj as UserClaimEventIdDto;
			if (other == null) {
				return false;
			}
