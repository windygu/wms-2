...
namespace Dddml.Wms.Domain.User.NHibernate
{
	...
	public class NHibernateUserLoginEventDao : IUserLoginEventDao
	{
		...
		public NHibernateUserLoginEventDao ()
		{
		}

		public void Save(IUserLoginEvent stateEvent)
		{
        ...
        public IEnumerable<IUserLoginEvent> FindByUserEventId(UserEventId userEventId)
        {
            var criteria = CurrentSession.CreateCriteria<UserLoginEventBase>();
            ...
            return criteria.Add(partIdCondition).List<UserLoginEventBase>();
        }
