...
namespace Dddml.Wms.Domain.Role
{
	...
	public class RoleEventIdDto
	{

		public RoleEventIdDto()
		{
		}

        public virtual RoleEventId ToRoleEventId()
        {
            RoleEventId v = new RoleEventId();
		...
		public override bool Equals (object obj)
		{
			...
			RoleEventIdDto other = obj as RoleEventIdDto;
			if (other == null) {
				return false;
			}
