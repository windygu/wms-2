...
namespace Dddml.Wms.Domain.UserRoleMvo
{
	...
	public abstract class UserRoleMvoStateEventDtoBase : IEventDto, IUserRoleMvoStateCreated, IUserRoleMvoStateMergePatched, IUserRoleMvoStateDeleted
	{

        private UserRoleMvoEventId _userRoleMvoEventId;

		protected internal virtual UserRoleMvoEventId UserRoleMvoEventId 
        {
            get 
            {
                if (_userRoleMvoEventId == null) { _userRoleMvoEventId = new UserRoleMvoEventId(); }
        ...
        UserRoleMvoEventId IUserRoleMvoEvent.UserRoleMvoEventId
        {
            get { return this.UserRoleMvoEventId; }
        }
        ...
        protected UserRoleMvoStateEventDtoBase(UserRoleMvoEventId stateEventId)
        {
    ...
    public partial class UserRoleMvoStateCreatedOrMergePatchedOrDeletedDtos : IEnumerable<IUserRoleMvoStateCreated>, IEnumerable<IUserRoleMvoStateMergePatched>, IEnumerable<IUserRoleMvoStateDeleted>
    {
        ...
        public void AddUserRoleMvoEvent(IUserRoleMvoEvent e)
        {
