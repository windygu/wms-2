...
public class HibernateInventoryItemRequirementStateRepository implements InventoryItemRequirementStateRepository
{
    ...
    @Transactional
    public void save(InventoryItemRequirementState state)
    {
        InventoryItemRequirementState s = state;
