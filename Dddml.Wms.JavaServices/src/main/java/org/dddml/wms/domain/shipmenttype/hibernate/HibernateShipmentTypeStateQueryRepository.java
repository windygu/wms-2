package org.dddml.wms.domain.shipmenttype.hibernate;
...
public class HibernateShipmentTypeStateQueryRepository implements ShipmentTypeStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("ShipmentTypeId", "Description", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(ShipmentTypeState.class);
