...
public class HibernateInventoryPRTriggeredStateQueryRepository implements InventoryPRTriggeredStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(InventoryPRTriggeredState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<InventoryPRTriggeredState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(InventoryPRTriggeredState.class);
    ...
    @Transactional(readOnly = true)
    public InventoryPRTriggeredState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<InventoryPRTriggeredState> list = (List<InventoryPRTriggeredState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public InventoryPRTriggeredState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
