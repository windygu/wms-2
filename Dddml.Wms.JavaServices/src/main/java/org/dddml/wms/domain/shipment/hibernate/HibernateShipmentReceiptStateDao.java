...
public class HibernateShipmentReceiptStateDao implements ShipmentReceiptStateDao
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("ReceiptSeqId", "ProductId", "ShipmentItemSeqId", "RejectionId", "ItemDescription", "AcceptedQuantity", "RejectedQuantity", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "ShipmentId"));
