...
public class HibernateRejectionReasonStateQueryRepository implements RejectionReasonStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("RejectionReasonId", "Description", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(RejectionReasonState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<RejectionReasonState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(RejectionReasonState.class);
    ...
    @Transactional(readOnly = true)
    public RejectionReasonState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<RejectionReasonState> list = (List<RejectionReasonState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public RejectionReasonState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
