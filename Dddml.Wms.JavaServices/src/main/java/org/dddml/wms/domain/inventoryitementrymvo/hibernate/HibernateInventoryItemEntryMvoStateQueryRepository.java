...
public class HibernateInventoryItemEntryMvoStateQueryRepository implements InventoryItemEntryMvoStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("InventoryItemEntryId", "QuantityOnHandVar", "QuantityReservedVar", "QuantityOccupiedVar", "QuantityVirtualVar", "EventVO", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "InventoryItemQuantityOnHand", "InventoryItemQuantityReserved", "InventoryItemQuantityOccupied", "InventoryItemQuantityVirtual", "InventoryItemEntries", "InventoryItemVersion", "InventoryItemCreatedBy", "InventoryItemCreatedAt", "InventoryItemUpdatedBy", "InventoryItemUpdatedAt"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(InventoryItemEntryMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<InventoryItemEntryMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(InventoryItemEntryMvoState.class);
    ...
    @Transactional(readOnly = true)
    public InventoryItemEntryMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<InventoryItemEntryMvoState> list = (List<InventoryItemEntryMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public InventoryItemEntryMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
