...
public class HibernateDamageHandlingMethodStateQueryRepository implements DamageHandlingMethodStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(DamageHandlingMethodState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<DamageHandlingMethodState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(DamageHandlingMethodState.class);
    ...
    @Transactional(readOnly = true)
    public DamageHandlingMethodState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<DamageHandlingMethodState> list = (List<DamageHandlingMethodState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public DamageHandlingMethodState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
