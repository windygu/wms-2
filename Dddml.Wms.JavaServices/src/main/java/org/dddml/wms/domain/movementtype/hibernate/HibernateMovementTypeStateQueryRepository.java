...
public class HibernateMovementTypeStateQueryRepository implements MovementTypeStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(MovementTypeState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<MovementTypeState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(MovementTypeState.class);
    ...
    @Transactional(readOnly = true)
    public MovementTypeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<MovementTypeState> list = (List<MovementTypeState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public MovementTypeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
