...
public class HibernateInventoryPostingRuleStateQueryRepository implements InventoryPostingRuleStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("InventoryPostingRuleId", "Trigger", "Output", "AccountName", "IsOutputNegated", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(InventoryPostingRuleState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<InventoryPostingRuleState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(InventoryPostingRuleState.class);
    ...
    @Transactional(readOnly = true)
    public InventoryPostingRuleState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<InventoryPostingRuleState> list = (List<InventoryPostingRuleState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public InventoryPostingRuleState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
