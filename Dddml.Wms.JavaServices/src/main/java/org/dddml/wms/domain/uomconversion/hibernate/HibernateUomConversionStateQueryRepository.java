...
public class HibernateUomConversionStateQueryRepository implements UomConversionStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(UomConversionState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<UomConversionState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(UomConversionState.class);
    ...
    @Transactional(readOnly = true)
    public UomConversionState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<UomConversionState> list = (List<UomConversionState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public UomConversionState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
