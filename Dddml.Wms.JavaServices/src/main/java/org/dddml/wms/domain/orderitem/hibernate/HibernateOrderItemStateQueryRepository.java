...
public class HibernateOrderItemStateQueryRepository implements OrderItemStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderItemState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<OrderItemState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderItemState.class);
    ...
    @Transactional(readOnly = true)
    public OrderItemState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<OrderItemState> list = (List<OrderItemState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public OrderItemState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
