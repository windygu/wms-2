...
public class HibernateMovementConfirmationLineMvoStateQueryRepository implements MovementConfirmationLineMvoStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(MovementConfirmationLineMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<MovementConfirmationLineMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(MovementConfirmationLineMvoState.class);
    ...
    @Transactional(readOnly = true)
    public MovementConfirmationLineMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<MovementConfirmationLineMvoState> list = (List<MovementConfirmationLineMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public MovementConfirmationLineMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
