...
public class HibernateShipmentItemStateQueryRepository implements ShipmentItemStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(ShipmentItemState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<ShipmentItemState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(ShipmentItemState.class);
    ...
    @Transactional(readOnly = true)
    public ShipmentItemState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<ShipmentItemState> list = (List<ShipmentItemState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public ShipmentItemState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
