...
public class HibernateRejectionReasonStateRepository implements RejectionReasonStateRepository
{
    ...
    public void save(RejectionReasonState state)
    {
        RejectionReasonState s = state;
        if (getReadOnlyProxyGenerator() != null) {
            s = (RejectionReasonState) getReadOnlyProxyGenerator().getTarget(state);
        }
