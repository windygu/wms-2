...
public class HibernateDamageReasonStateQueryRepository implements DamageReasonStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(DamageReasonState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<DamageReasonState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(DamageReasonState.class);
    ...
    @Transactional(readOnly = true)
    public DamageReasonState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<DamageReasonState> list = (List<DamageReasonState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public DamageReasonState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
