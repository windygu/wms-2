...
public class HibernateMovementConfirmationLineStateDao implements MovementConfirmationLineStateDao
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("LineNumber", "TargetQuantity", "ConfirmedQuantity", "DifferenceQuantity", "ScrappedQuantity", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "MovementDocumentNumber"));
    ...
    @Transactional(readOnly = true)
    @Override
    public Iterable<MovementConfirmationLineState> findByMovementDocumentNumber(String movementDocumentNumber)
    {
