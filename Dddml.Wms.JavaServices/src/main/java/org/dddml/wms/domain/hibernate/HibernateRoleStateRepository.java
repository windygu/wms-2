...
public class HibernateRoleStateRepository implements RoleStateRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("RoleId", "Name", "Description", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    public RoleState get(String id, boolean nullAllowed)
    {
        ...
        if (getReadOnlyProxyGenerator() != null && state != null) {
            return (RoleState) getReadOnlyProxyGenerator().createProxy(state, new Class[]{RoleState.class}, "getStateReadOnly", readOnlyPropertyPascalCaseNames);
        }
        return state;
    }
    ...
    public void save(RoleState state)
    {
        ...
        if (getReadOnlyProxyGenerator() != null) {
            s = (RoleState) getReadOnlyProxyGenerator().getTarget(state);
        }
