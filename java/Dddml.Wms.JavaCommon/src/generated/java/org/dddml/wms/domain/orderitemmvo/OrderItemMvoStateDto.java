...
public class OrderItemMvoStateDto
{
    ...
    public static class DtoConverter extends AbstractStateDtoConverter
    {
        ...
        public OrderItemMvoStateDto[] toOrderItemMvoStateDtoArray(Iterable<OrderItemMvoState> states) 
        {
            ArrayList<OrderItemMvoStateDto> stateDtos = new ArrayList();
            for (OrderItemMvoState s : states) {
                OrderItemMvoStateDto dto = toOrderItemMvoStateDto(s);
                stateDtos.add(dto);
            }
            return stateDtos.toArray(new OrderItemMvoStateDto[0]);
        }

        public OrderItemMvoStateDto toOrderItemMvoStateDto(OrderItemMvoState state)
        {
            if(state == null) {
                return null;
            }
