...
public abstract class AbstractItemIssuanceEvent extends AbstractEvent implements ItemIssuanceEvent.SqlItemIssuanceEvent 
{
    ...
    protected AbstractItemIssuanceEvent() {
    }

    protected AbstractItemIssuanceEvent(ItemIssuanceEventId eventId) {
        this.itemIssuanceEventId = eventId;
    }
