...
public abstract class AbstractShipmentAggregate extends AbstractAggregate implements ShipmentAggregate
{
    ...
    protected ShipmentEvent map(ShipmentCommand.CreateShipment c) {
        ...
        e.setF_B_1_(c.getF_B_1_());
        e.setF_B_2_(c.getF_B_2_());
        e.setF_B_3_(c.getF_B_3_());
        e.setF_C10_1_(c.getF_C10_1_());
        e.setF_C10_2_(c.getF_C10_2_());
        e.setF_C10_3_(c.getF_C10_3_());
    ...
    protected ShipmentEvent map(ShipmentCommand.MergePatchShipment c) {
        ...
        e.setIsPropertyF_B_1_Removed(c.getIsPropertyF_B_1_Removed());
        e.setIsPropertyF_B_2_Removed(c.getIsPropertyF_B_2_Removed());
        e.setIsPropertyF_B_3_Removed(c.getIsPropertyF_B_3_Removed());
        e.setIsPropertyF_C10_1_Removed(c.getIsPropertyF_C10_1_Removed());
        e.setIsPropertyF_C10_2_Removed(c.getIsPropertyF_C10_2_Removed());
        e.setIsPropertyF_C10_3_Removed(c.getIsPropertyF_C10_3_Removed());
    ...
    public static class SimpleShipmentAggregate extends AbstractShipmentAggregate
    {
        ...
        @Override
        public void purchaseShipmentAction(String value, Long version, String commandId, String requesterId, ShipmentCommands.PurchaseShipmentAction c) {
        ...
        @Override
        public void salesShipmentAction(String value, Long version, String commandId, String requesterId, ShipmentCommands.SalesShipmentAction c) {
            ShipmentEvent.ShipmentStateMergePatched e = newShipmentStateMergePatched(version, commandId, requesterId);
