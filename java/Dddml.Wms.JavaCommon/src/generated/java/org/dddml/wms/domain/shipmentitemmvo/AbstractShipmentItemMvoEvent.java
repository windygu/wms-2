...
public abstract class AbstractShipmentItemMvoEvent extends AbstractEvent implements ShipmentItemMvoEvent 
{
    private ShipmentItemMvoEventId shipmentItemMvoEventId;

    public ShipmentItemMvoEventId getShipmentItemMvoEventId() {
        return this.shipmentItemMvoEventId;
    }

    public void setShipmentItemMvoEventId(ShipmentItemMvoEventId eventId) {
    ...
    protected AbstractShipmentItemMvoEvent() {
    }

    protected AbstractShipmentItemMvoEvent(ShipmentItemMvoEventId eventId) {
        this.shipmentItemMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractShipmentItemMvoStateEvent extends AbstractShipmentItemMvoEvent implements ShipmentItemMvoEvent.ShipmentItemMvoStateEvent {
    ...
    public static abstract class AbstractShipmentItemMvoStateCreated extends AbstractShipmentItemMvoStateEvent implements ShipmentItemMvoEvent.ShipmentItemMvoStateCreated
    {
    ...
    public static abstract class AbstractShipmentItemMvoStateMergePatched extends AbstractShipmentItemMvoStateEvent implements ShipmentItemMvoEvent.ShipmentItemMvoStateMergePatched
    {
    ...
    public static class SimpleShipmentItemMvoStateMergePatched extends AbstractShipmentItemMvoStateMergePatched
    {
