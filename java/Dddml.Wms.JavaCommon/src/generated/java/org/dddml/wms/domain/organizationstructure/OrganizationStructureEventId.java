...
public class OrganizationStructureEventId implements Serializable
{
    ...
    protected String getIdOrganizationStructureTypeId()
    {
        return getId().getOrganizationStructureTypeId();
    }

    protected void setIdOrganizationStructureTypeId(String idOrganizationStructureTypeId)
    {
        getId().setOrganizationStructureTypeId(idOrganizationStructureTypeId);
    }

    protected String getIdParentId()
    {
        return getId().getParentId();
    }

    protected void setIdParentId(String idParentId)
    {
        getId().setParentId(idParentId);
    }

    protected String getIdSubsidiaryId()
    {
        return getId().getSubsidiaryId();
    }

    protected void setIdSubsidiaryId(String idSubsidiaryId)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        OrganizationStructureEventId other = (OrganizationStructureEventId)obj;
        return true 
