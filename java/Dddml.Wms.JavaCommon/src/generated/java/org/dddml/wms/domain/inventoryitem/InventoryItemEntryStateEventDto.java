...
public class InventoryItemEntryStateEventDto extends AbstractEvent
{
    ...
    void setInventoryItemEntryEventId(InventoryItemEntryEventId eventId) {
        this.inventoryItemEntryEventId = eventId;
    }
