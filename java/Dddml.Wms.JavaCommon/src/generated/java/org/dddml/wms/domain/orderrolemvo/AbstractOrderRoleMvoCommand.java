...
public abstract class AbstractOrderRoleMvoCommand extends AbstractCommand implements OrderRoleMvoCommand
{
    ...
    public static abstract class AbstractCreateOrMergePatchOrderRoleMvo extends AbstractOrderRoleMvoCommand implements CreateOrMergePatchOrderRoleMvo
    {
    ...
    public static abstract class AbstractCreateOrderRoleMvo extends AbstractCreateOrMergePatchOrderRoleMvo implements CreateOrderRoleMvo
    {
        @Override
    ...
    public static abstract class AbstractMergePatchOrderRoleMvo extends AbstractCreateOrMergePatchOrderRoleMvo implements MergePatchOrderRoleMvo
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateOrderRoleMvo extends AbstractCreateOrderRoleMvo
    {
    }

    
    public static class SimpleMergePatchOrderRoleMvo extends AbstractMergePatchOrderRoleMvo
    {
    }

    
	public static class SimpleDeleteOrderRoleMvo extends AbstractOrderRoleMvoCommand implements DeleteOrderRoleMvo
	{
        @Override
        public String getCommandType() {
