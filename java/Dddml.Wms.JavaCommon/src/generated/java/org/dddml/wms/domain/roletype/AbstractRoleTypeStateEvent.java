...
public abstract class AbstractRoleTypeStateEvent extends AbstractStateEvent implements RoleTypeStateEvent 
{
    ...
    protected AbstractRoleTypeStateEvent() {
    }
    ...
    public static abstract class AbstractRoleTypeStateCreated extends AbstractRoleTypeStateEvent implements RoleTypeStateEvent.RoleTypeStateCreated
    {
    ...
    public static abstract class AbstractRoleTypeStateMergePatched extends AbstractRoleTypeStateEvent implements RoleTypeStateEvent.RoleTypeStateMergePatched
    {
    ...
    public static abstract class AbstractRoleTypeStateDeleted extends AbstractRoleTypeStateEvent implements RoleTypeStateEvent.RoleTypeStateDeleted
    {
