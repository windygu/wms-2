...
public abstract class AbstractShipmentReceiptMvoEvent extends AbstractEvent implements ShipmentReceiptMvoEvent 
{
    private ShipmentReceiptMvoEventId shipmentReceiptMvoEventId;

    public ShipmentReceiptMvoEventId getShipmentReceiptMvoEventId() {
        return this.shipmentReceiptMvoEventId;
    }

    public void setShipmentReceiptMvoEventId(ShipmentReceiptMvoEventId eventId) {
    ...
    protected AbstractShipmentReceiptMvoEvent() {
    }

    protected AbstractShipmentReceiptMvoEvent(ShipmentReceiptMvoEventId eventId) {
        this.shipmentReceiptMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractShipmentReceiptMvoStateEvent extends AbstractShipmentReceiptMvoEvent implements ShipmentReceiptMvoEvent.ShipmentReceiptMvoStateEvent {
    ...
    public static abstract class AbstractShipmentReceiptMvoStateCreated extends AbstractShipmentReceiptMvoStateEvent implements ShipmentReceiptMvoEvent.ShipmentReceiptMvoStateCreated
    {
    ...
    public static abstract class AbstractShipmentReceiptMvoStateMergePatched extends AbstractShipmentReceiptMvoStateEvent implements ShipmentReceiptMvoEvent.ShipmentReceiptMvoStateMergePatched
    {
