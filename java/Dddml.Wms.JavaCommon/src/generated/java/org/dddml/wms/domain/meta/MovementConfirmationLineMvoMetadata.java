...
public final class MovementConfirmationLineMvoMetadata {

    private MovementConfirmationLineMvoMetadata() {
    }

    public static final String PROPERTY_NAME_VERSION      = "movementConfirmationVersion";
