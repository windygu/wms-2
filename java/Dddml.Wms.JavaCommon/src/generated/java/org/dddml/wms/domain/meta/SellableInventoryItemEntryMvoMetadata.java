...
public final class SellableInventoryItemEntryMvoMetadata {

    private SellableInventoryItemEntryMvoMetadata() {
    }

    public static final String PROPERTY_NAME_VERSION      = "sellableInventoryItemVersion";
