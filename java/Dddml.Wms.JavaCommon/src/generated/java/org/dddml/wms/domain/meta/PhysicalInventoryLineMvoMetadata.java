...
public final class PhysicalInventoryLineMvoMetadata {

    private PhysicalInventoryLineMvoMetadata() {
    }

    public static final String PROPERTY_NAME_VERSION      = "physicalInventoryVersion";
