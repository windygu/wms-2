...
public abstract class AbstractItemIssuanceMvoEvent extends AbstractEvent implements ItemIssuanceMvoEvent 
{
    private ItemIssuanceMvoEventId itemIssuanceMvoEventId;

    public ItemIssuanceMvoEventId getItemIssuanceMvoEventId() {
        return this.itemIssuanceMvoEventId;
    }

    public void setItemIssuanceMvoEventId(ItemIssuanceMvoEventId eventId) {
    ...
    protected AbstractItemIssuanceMvoEvent() {
    }

    protected AbstractItemIssuanceMvoEvent(ItemIssuanceMvoEventId eventId) {
        this.itemIssuanceMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractItemIssuanceMvoStateEvent extends AbstractItemIssuanceMvoEvent implements ItemIssuanceMvoEvent.ItemIssuanceMvoStateEvent {
        ...
        protected AbstractItemIssuanceMvoStateEvent(ItemIssuanceMvoEventId eventId) {
            super(eventId);
        }
    }

    public static abstract class AbstractItemIssuanceMvoStateCreated extends AbstractItemIssuanceMvoStateEvent implements ItemIssuanceMvoEvent.ItemIssuanceMvoStateCreated
    {
        public AbstractItemIssuanceMvoStateCreated() {
            this(new ItemIssuanceMvoEventId());
        }

        public AbstractItemIssuanceMvoStateCreated(ItemIssuanceMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractItemIssuanceMvoStateMergePatched extends AbstractItemIssuanceMvoStateEvent implements ItemIssuanceMvoEvent.ItemIssuanceMvoStateMergePatched
    {
        public AbstractItemIssuanceMvoStateMergePatched() {
            this(new ItemIssuanceMvoEventId());
        }

        public AbstractItemIssuanceMvoStateMergePatched(ItemIssuanceMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractItemIssuanceMvoStateDeleted extends AbstractItemIssuanceMvoStateEvent implements ItemIssuanceMvoEvent.ItemIssuanceMvoStateDeleted
    {
        public AbstractItemIssuanceMvoStateDeleted() {
            this(new ItemIssuanceMvoEventId());
        }

        public AbstractItemIssuanceMvoStateDeleted(ItemIssuanceMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static class SimpleItemIssuanceMvoStateCreated extends AbstractItemIssuanceMvoStateCreated
    {
        public SimpleItemIssuanceMvoStateCreated() {
        }

        public SimpleItemIssuanceMvoStateCreated(ItemIssuanceMvoEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleItemIssuanceMvoStateMergePatched extends AbstractItemIssuanceMvoStateMergePatched
    {
        public SimpleItemIssuanceMvoStateMergePatched() {
        }

        public SimpleItemIssuanceMvoStateMergePatched(ItemIssuanceMvoEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleItemIssuanceMvoStateDeleted extends AbstractItemIssuanceMvoStateDeleted
    {
        public SimpleItemIssuanceMvoStateDeleted() {
        }

        public SimpleItemIssuanceMvoStateDeleted(ItemIssuanceMvoEventId eventId) {
            super(eventId);
        }
    }
