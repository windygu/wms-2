...
public class ShipmentItemIssuanceId implements Serializable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        ShipmentItemIssuanceId other = (ShipmentItemIssuanceId)obj;
        return true 
            && (shipmentId == other.shipmentId || (shipmentId != null && shipmentId.equals(other.shipmentId)))
            && (itemIssuanceSeqId == other.itemIssuanceSeqId || (itemIssuanceSeqId != null && itemIssuanceSeqId.equals(other.itemIssuanceSeqId)))
            ;
    }
    ...
    public int hashCode()
    {
        ...
        if (this.itemIssuanceSeqId != null) {
            hash += 13 * this.itemIssuanceSeqId.hashCode();
        }
        return hash;
    }
