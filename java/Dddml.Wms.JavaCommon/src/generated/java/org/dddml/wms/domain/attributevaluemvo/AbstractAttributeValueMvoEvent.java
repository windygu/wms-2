...
public abstract class AbstractAttributeValueMvoEvent extends AbstractEvent implements AttributeValueMvoEvent 
{
    ...
    protected AbstractAttributeValueMvoEvent() {
    }

    protected AbstractAttributeValueMvoEvent(AttributeValueMvoEventId eventId) {
        this.attributeValueMvoEventId = eventId;
    }
