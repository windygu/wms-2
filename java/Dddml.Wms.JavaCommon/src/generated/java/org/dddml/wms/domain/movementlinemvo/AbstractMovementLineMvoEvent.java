...
public abstract class AbstractMovementLineMvoEvent extends AbstractEvent implements MovementLineMvoEvent 
{
    private MovementLineMvoEventId movementLineMvoEventId;

    public MovementLineMvoEventId getMovementLineMvoEventId() {
        return this.movementLineMvoEventId;
    }

    public void setMovementLineMvoEventId(MovementLineMvoEventId eventId) {
        this.movementLineMvoEventId = eventId;
    }
    ...
    protected AbstractMovementLineMvoEvent() {
    }

    protected AbstractMovementLineMvoEvent(MovementLineMvoEventId eventId) {
        this.movementLineMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractMovementLineMvoStateCreated extends AbstractMovementLineMvoStateEvent implements MovementLineMvoEvent.MovementLineMvoStateCreated
    {
        ...
        public AbstractMovementLineMvoStateCreated(MovementLineMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractMovementLineMvoStateMergePatched extends AbstractMovementLineMvoStateEvent implements MovementLineMvoEvent.MovementLineMvoStateMergePatched
    {
        ...
        public AbstractMovementLineMvoStateMergePatched(MovementLineMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractMovementLineMvoStateDeleted extends AbstractMovementLineMvoStateEvent implements MovementLineMvoEvent.MovementLineMvoStateDeleted
    {
        ...
        public AbstractMovementLineMvoStateDeleted(MovementLineMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static class SimpleMovementLineMvoStateCreated extends AbstractMovementLineMvoStateCreated
    {
        ...
        public SimpleMovementLineMvoStateCreated(MovementLineMvoEventId eventId) {
            super(eventId);
        }
    }
    ...
    public static class SimpleMovementLineMvoStateMergePatched extends AbstractMovementLineMvoStateMergePatched
    {
        ...
        public SimpleMovementLineMvoStateMergePatched(MovementLineMvoEventId eventId) {
            super(eventId);
        }
    }
    ...
    public static class SimpleMovementLineMvoStateDeleted extends AbstractMovementLineMvoStateDeleted
    {
        ...
        public SimpleMovementLineMvoStateDeleted(MovementLineMvoEventId eventId) {
            super(eventId);
        }
    }
