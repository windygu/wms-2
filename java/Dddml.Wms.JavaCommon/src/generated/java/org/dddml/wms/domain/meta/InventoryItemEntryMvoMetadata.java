...
public final class InventoryItemEntryMvoMetadata {

    private InventoryItemEntryMvoMetadata() {
    }

    public static final String PROPERTY_NAME_VERSION      = "inventoryItemVersion";
