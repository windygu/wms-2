...
public final class InventoryItemRequirementEntryMvoMetadata {

    private InventoryItemRequirementEntryMvoMetadata() {
    }

    public static final String PROPERTY_NAME_VERSION      = "inventoryItemRequirementVersion";
