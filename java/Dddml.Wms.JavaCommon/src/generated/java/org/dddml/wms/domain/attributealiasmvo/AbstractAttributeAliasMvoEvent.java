...
public abstract class AbstractAttributeAliasMvoEvent extends AbstractEvent implements AttributeAliasMvoEvent 
{
    private AttributeAliasMvoEventId attributeAliasMvoEventId;

    public AttributeAliasMvoEventId getAttributeAliasMvoEventId() {
        return this.attributeAliasMvoEventId;
    }

    public void setAttributeAliasMvoEventId(AttributeAliasMvoEventId eventId) {
        this.attributeAliasMvoEventId = eventId;
    }
    ...
    protected AbstractAttributeAliasMvoEvent() {
    }

    protected AbstractAttributeAliasMvoEvent(AttributeAliasMvoEventId eventId) {
        this.attributeAliasMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractAttributeAliasMvoStateEvent extends AbstractAttributeAliasMvoEvent implements AttributeAliasMvoEvent.AttributeAliasMvoStateEvent {
        private String name;
    ...
    public static abstract class AbstractAttributeAliasMvoStateCreated extends AbstractAttributeAliasMvoStateEvent implements AttributeAliasMvoEvent.AttributeAliasMvoStateCreated
    {
    ...
    public static abstract class AbstractAttributeAliasMvoStateMergePatched extends AbstractAttributeAliasMvoStateEvent implements AttributeAliasMvoEvent.AttributeAliasMvoStateMergePatched
    {
    ...
    public static abstract class AbstractAttributeAliasMvoStateDeleted extends AbstractAttributeAliasMvoStateEvent implements AttributeAliasMvoEvent.AttributeAliasMvoStateDeleted
    {
