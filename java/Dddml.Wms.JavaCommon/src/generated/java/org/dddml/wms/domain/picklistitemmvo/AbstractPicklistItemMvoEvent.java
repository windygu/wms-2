...
public abstract class AbstractPicklistItemMvoEvent extends AbstractEvent implements PicklistItemMvoEvent 
{
    private PicklistItemMvoEventId picklistItemMvoEventId;

    public PicklistItemMvoEventId getPicklistItemMvoEventId() {
        return this.picklistItemMvoEventId;
    }

    public void setPicklistItemMvoEventId(PicklistItemMvoEventId eventId) {
        this.picklistItemMvoEventId = eventId;
    }
    
    public PicklistBinPicklistItemId getPicklistBinPicklistItemId() {
        return getPicklistItemMvoEventId().getPicklistBinPicklistItemId();
    }

    public void setPicklistBinPicklistItemId(PicklistBinPicklistItemId picklistBinPicklistItemId) {
        getPicklistItemMvoEventId().setPicklistBinPicklistItemId(picklistBinPicklistItemId);
    }
    ...
    protected AbstractPicklistItemMvoEvent() {
    }

    protected AbstractPicklistItemMvoEvent(PicklistItemMvoEventId eventId) {
        this.picklistItemMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractPicklistItemMvoStateEvent extends AbstractPicklistItemMvoEvent implements PicklistItemMvoEvent.PicklistItemMvoStateEvent {
        ...
        protected AbstractPicklistItemMvoStateEvent(PicklistItemMvoEventId eventId) {
            super(eventId);
        }
    }

    public static abstract class AbstractPicklistItemMvoStateCreated extends AbstractPicklistItemMvoStateEvent implements PicklistItemMvoEvent.PicklistItemMvoStateCreated
    {
        public AbstractPicklistItemMvoStateCreated() {
            this(new PicklistItemMvoEventId());
        }

        public AbstractPicklistItemMvoStateCreated(PicklistItemMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractPicklistItemMvoStateMergePatched extends AbstractPicklistItemMvoStateEvent implements PicklistItemMvoEvent.PicklistItemMvoStateMergePatched
    {
        public AbstractPicklistItemMvoStateMergePatched() {
            this(new PicklistItemMvoEventId());
        }

        public AbstractPicklistItemMvoStateMergePatched(PicklistItemMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractPicklistItemMvoStateDeleted extends AbstractPicklistItemMvoStateEvent implements PicklistItemMvoEvent.PicklistItemMvoStateDeleted
    {
        public AbstractPicklistItemMvoStateDeleted() {
            this(new PicklistItemMvoEventId());
        }

        public AbstractPicklistItemMvoStateDeleted(PicklistItemMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static class SimplePicklistItemMvoStateCreated extends AbstractPicklistItemMvoStateCreated
    {
        public SimplePicklistItemMvoStateCreated() {
        }

        public SimplePicklistItemMvoStateCreated(PicklistItemMvoEventId eventId) {
            super(eventId);
        }
    }

    public static class SimplePicklistItemMvoStateMergePatched extends AbstractPicklistItemMvoStateMergePatched
    {
        public SimplePicklistItemMvoStateMergePatched() {
        }

        public SimplePicklistItemMvoStateMergePatched(PicklistItemMvoEventId eventId) {
            super(eventId);
        }
    }

    public static class SimplePicklistItemMvoStateDeleted extends AbstractPicklistItemMvoStateDeleted
    {
        public SimplePicklistItemMvoStateDeleted() {
        }

        public SimplePicklistItemMvoStateDeleted(PicklistItemMvoEventId eventId) {
            super(eventId);
        }
    }
