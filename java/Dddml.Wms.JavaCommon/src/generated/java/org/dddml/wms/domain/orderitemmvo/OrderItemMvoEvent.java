...
public interface OrderItemMvoEvent extends Event
{
    ...
    interface OrderItemMvoStateEvent extends OrderItemMvoEvent {
        String getProductId();
    ...
    interface OrderItemMvoStateCreated extends OrderItemMvoStateEvent
    {
    
    }


    interface OrderItemMvoStateMergePatched extends OrderItemMvoStateEvent
    {
