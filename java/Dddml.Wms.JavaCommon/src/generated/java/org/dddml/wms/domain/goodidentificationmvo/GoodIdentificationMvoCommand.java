...
public interface GoodIdentificationMvoCommand extends Command
{
    ...
    static void throwOnInvalidStateTransition(GoodIdentificationMvoState state, Command c) {
        if (state.getProductVersion() == null)
        {
            if (isCommandCreate((GoodIdentificationMvoCommand)c))
            {
                return;
            }
    ...
    static boolean isCommandCreate(GoodIdentificationMvoCommand c) {
        return ((c instanceof GoodIdentificationMvoCommand.CreateGoodIdentificationMvo) 
            && c.getProductVersion().equals(GoodIdentificationMvoState.VERSION_NULL));
    }

    interface CreateOrMergePatchGoodIdentificationMvo extends GoodIdentificationMvoCommand
    {
        String getIdValue();
    ...
    interface CreateGoodIdentificationMvo extends CreateOrMergePatchGoodIdentificationMvo
    {
    }

    interface MergePatchGoodIdentificationMvo extends CreateOrMergePatchGoodIdentificationMvo
    {
	...
	interface DeleteGoodIdentificationMvo extends GoodIdentificationMvoCommand
	{
	}
