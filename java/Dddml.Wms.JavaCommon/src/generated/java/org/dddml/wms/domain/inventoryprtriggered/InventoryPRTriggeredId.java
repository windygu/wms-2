...
public class InventoryPRTriggeredId implements Serializable
{
    ...
    protected String getSourceEntryIdInventoryItemIdProductId()
    {
        return getSourceEntryId().getInventoryItemId().getProductId();
    }

    protected void setSourceEntryIdInventoryItemIdProductId(String sourceEntryIdInventoryItemIdProductId)
    {
        getSourceEntryId().getInventoryItemId().setProductId(sourceEntryIdInventoryItemIdProductId);
    }

    protected String getSourceEntryIdInventoryItemIdLocatorId()
    {
        return getSourceEntryId().getInventoryItemId().getLocatorId();
    }

    protected void setSourceEntryIdInventoryItemIdLocatorId(String sourceEntryIdInventoryItemIdLocatorId)
    {
        getSourceEntryId().getInventoryItemId().setLocatorId(sourceEntryIdInventoryItemIdLocatorId);
    }

    protected String getSourceEntryIdInventoryItemIdAttributeSetInstanceId()
    {
        return getSourceEntryId().getInventoryItemId().getAttributeSetInstanceId();
    }

    protected void setSourceEntryIdInventoryItemIdAttributeSetInstanceId(String sourceEntryIdInventoryItemIdAttributeSetInstanceId)
    {
        getSourceEntryId().getInventoryItemId().setAttributeSetInstanceId(sourceEntryIdInventoryItemIdAttributeSetInstanceId);
    }

    protected Long getSourceEntryIdEntrySeqId()
    {
        return getSourceEntryId().getEntrySeqId();
    }

    protected void setSourceEntryIdEntrySeqId(Long sourceEntryIdEntrySeqId)
    {
