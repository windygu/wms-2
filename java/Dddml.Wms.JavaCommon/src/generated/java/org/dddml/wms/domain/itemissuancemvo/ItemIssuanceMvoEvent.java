...
public interface ItemIssuanceMvoEvent extends Event
{
    ...
    interface ItemIssuanceMvoStateCreated extends ItemIssuanceMvoEvent
    {
    
    }


    interface ItemIssuanceMvoStateMergePatched extends ItemIssuanceMvoEvent
    {
    ...
    interface ItemIssuanceMvoStateDeleted extends ItemIssuanceMvoEvent
    {
    }
