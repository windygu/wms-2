...
public interface ItemIssuanceMvoEvent extends Event
{
    ...
    interface ItemIssuanceMvoStateEvent extends ItemIssuanceMvoEvent {
        String getOrderId();
    ...
    interface ItemIssuanceMvoStateCreated extends ItemIssuanceMvoStateEvent
    {
    
    }


    interface ItemIssuanceMvoStateMergePatched extends ItemIssuanceMvoStateEvent
    {
    ...
    interface ItemIssuanceMvoStateDeleted extends ItemIssuanceMvoStateEvent
    {
    }
