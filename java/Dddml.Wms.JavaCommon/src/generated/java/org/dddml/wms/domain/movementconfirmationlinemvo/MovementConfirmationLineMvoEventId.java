...
public class MovementConfirmationLineMvoEventId implements Serializable
{
    ...
    protected String getMovementConfirmationLineIdMovementConfirmationDocumentNumber()
    {
        return getMovementConfirmationLineId().getMovementConfirmationDocumentNumber();
    }

    protected void setMovementConfirmationLineIdMovementConfirmationDocumentNumber(String movementConfirmationLineIdMovementConfirmationDocumentNumber)
    {
    ...
    protected String getMovementConfirmationLineIdLineNumber()
    {
        return getMovementConfirmationLineId().getLineNumber();
    }

    protected void setMovementConfirmationLineIdLineNumber(String movementConfirmationLineIdLineNumber)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        MovementConfirmationLineMvoEventId other = (MovementConfirmationLineMvoEventId)obj;
        return true 
