...
public abstract class AbstractInventoryItemRequirementEntryState implements InventoryItemRequirementEntryState
{
    ...
    protected void throwOnWrongEvent(InventoryItemRequirementEntryStateEvent stateEvent)
    {
        ...
        InventoryItemId eventEntityIdInventoryItemRequirementId = stateEvent.getStateEventId().getInventoryItemRequirementId();
        ...
        if (eventVersion == null) {
            eventVersion = stateVersion == null ? InventoryItemRequirementEntryState.VERSION_NULL : stateVersion;
            stateEvent.setVersion(eventVersion);
        }
        if (!(stateVersion == null && eventVersion.equals(InventoryItemRequirementEntryState.VERSION_NULL)) && !eventVersion.equals(stateVersion))//(eventVersion.compareTo(stateVersion) >= 0)
        {
