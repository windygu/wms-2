...
public interface OrderItemShipGroupAssociationMvoCommand extends Command
{
    ...
    static void throwOnInvalidStateTransition(OrderItemShipGroupAssociationMvoState state, Command c) {
        if (state.getOrderVersion() == null)
        {
            if (isCommandCreate((OrderItemShipGroupAssociationMvoCommand)c))
            {
                return;
            }
    ...
    static boolean isCommandCreate(OrderItemShipGroupAssociationMvoCommand c) {
        return ((c instanceof OrderItemShipGroupAssociationMvoCommand.CreateOrderItemShipGroupAssociationMvo) 
            && c.getOrderVersion().equals(OrderItemShipGroupAssociationMvoState.VERSION_NULL));
    }

    interface CreateOrMergePatchOrderItemShipGroupAssociationMvo extends OrderItemShipGroupAssociationMvoCommand
    {
    ...
    interface CreateOrderItemShipGroupAssociationMvo extends CreateOrMergePatchOrderItemShipGroupAssociationMvo
    {
    }

    interface MergePatchOrderItemShipGroupAssociationMvo extends CreateOrMergePatchOrderItemShipGroupAssociationMvo
    {
	...
	interface DeleteOrderItemShipGroupAssociationMvo extends OrderItemShipGroupAssociationMvoCommand
	{
	}
