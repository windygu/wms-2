...
public class ShipmentReceiptImageId implements Serializable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        ShipmentReceiptImageId other = (ShipmentReceiptImageId)obj;
        return true 
            && (shipmentId == other.shipmentId || (shipmentId != null && shipmentId.equals(other.shipmentId)))
            && (shipmentReceiptReceiptSeqId == other.shipmentReceiptReceiptSeqId || (shipmentReceiptReceiptSeqId != null && shipmentReceiptReceiptSeqId.equals(other.shipmentReceiptReceiptSeqId)))
    ...
    public int hashCode()
    {
        ...
        if (this.shipmentReceiptReceiptSeqId != null) {
            hash += 13 * this.shipmentReceiptReceiptSeqId.hashCode();
        }
