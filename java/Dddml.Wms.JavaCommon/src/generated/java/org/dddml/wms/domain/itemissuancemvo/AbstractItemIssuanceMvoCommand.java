...
public abstract class AbstractItemIssuanceMvoCommand extends AbstractCommand implements ItemIssuanceMvoCommand
{
    ...
    public static abstract class AbstractCreateOrMergePatchItemIssuanceMvo extends AbstractItemIssuanceMvoCommand implements CreateOrMergePatchItemIssuanceMvo
    {
    ...
    public static abstract class AbstractCreateItemIssuanceMvo extends AbstractCreateOrMergePatchItemIssuanceMvo implements CreateItemIssuanceMvo
    {
        @Override
    ...
    public static abstract class AbstractMergePatchItemIssuanceMvo extends AbstractCreateOrMergePatchItemIssuanceMvo implements MergePatchItemIssuanceMvo
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreateItemIssuanceMvo extends AbstractCreateItemIssuanceMvo
    {
    }

    
    public static class SimpleMergePatchItemIssuanceMvo extends AbstractMergePatchItemIssuanceMvo
    {
    }

    
	public static class SimpleDeleteItemIssuanceMvo extends AbstractItemIssuanceMvoCommand implements DeleteItemIssuanceMvo
	{
        @Override
        public String getCommandType() {
