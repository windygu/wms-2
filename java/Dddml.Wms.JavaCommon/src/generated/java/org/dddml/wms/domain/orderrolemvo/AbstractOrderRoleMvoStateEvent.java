...
public abstract class AbstractOrderRoleMvoStateEvent extends AbstractStateEvent implements OrderRoleMvoStateEvent 
{
    ...
    protected AbstractOrderRoleMvoStateEvent() {
    }
    ...
    public static abstract class AbstractOrderRoleMvoStateCreated extends AbstractOrderRoleMvoStateEvent implements OrderRoleMvoStateEvent.OrderRoleMvoStateCreated
    {
    ...
    public static abstract class AbstractOrderRoleMvoStateMergePatched extends AbstractOrderRoleMvoStateEvent implements OrderRoleMvoStateEvent.OrderRoleMvoStateMergePatched
    {
    ...
    public static abstract class AbstractOrderRoleMvoStateDeleted extends AbstractOrderRoleMvoStateEvent implements OrderRoleMvoStateEvent.OrderRoleMvoStateDeleted
    {
