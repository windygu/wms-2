...
public abstract class AbstractGoodIdentificationMvoEvent extends AbstractEvent implements GoodIdentificationMvoEvent 
{
    private GoodIdentificationMvoEventId goodIdentificationMvoEventId;

    public GoodIdentificationMvoEventId getGoodIdentificationMvoEventId() {
        return this.goodIdentificationMvoEventId;
    }

    public void setGoodIdentificationMvoEventId(GoodIdentificationMvoEventId eventId) {
    ...
    protected AbstractGoodIdentificationMvoEvent() {
    }

    protected AbstractGoodIdentificationMvoEvent(GoodIdentificationMvoEventId eventId) {
        this.goodIdentificationMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractGoodIdentificationMvoStateEvent extends AbstractGoodIdentificationMvoEvent implements GoodIdentificationMvoEvent.GoodIdentificationMvoStateEvent {
        ...
        protected AbstractGoodIdentificationMvoStateEvent(GoodIdentificationMvoEventId eventId) {
            super(eventId);
        }
    }

    public static abstract class AbstractGoodIdentificationMvoStateCreated extends AbstractGoodIdentificationMvoStateEvent implements GoodIdentificationMvoEvent.GoodIdentificationMvoStateCreated
    {
        public AbstractGoodIdentificationMvoStateCreated() {
            this(new GoodIdentificationMvoEventId());
        }

        public AbstractGoodIdentificationMvoStateCreated(GoodIdentificationMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractGoodIdentificationMvoStateMergePatched extends AbstractGoodIdentificationMvoStateEvent implements GoodIdentificationMvoEvent.GoodIdentificationMvoStateMergePatched
    {
        public AbstractGoodIdentificationMvoStateMergePatched() {
            this(new GoodIdentificationMvoEventId());
        }

        public AbstractGoodIdentificationMvoStateMergePatched(GoodIdentificationMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractGoodIdentificationMvoStateDeleted extends AbstractGoodIdentificationMvoStateEvent implements GoodIdentificationMvoEvent.GoodIdentificationMvoStateDeleted
    {
        public AbstractGoodIdentificationMvoStateDeleted() {
            this(new GoodIdentificationMvoEventId());
        }

        public AbstractGoodIdentificationMvoStateDeleted(GoodIdentificationMvoEventId eventId) {
            super(eventId);
        }
    ...
    public static class SimpleGoodIdentificationMvoStateCreated extends AbstractGoodIdentificationMvoStateCreated
    {
        public SimpleGoodIdentificationMvoStateCreated() {
        }

        public SimpleGoodIdentificationMvoStateCreated(GoodIdentificationMvoEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleGoodIdentificationMvoStateMergePatched extends AbstractGoodIdentificationMvoStateMergePatched
    {
        public SimpleGoodIdentificationMvoStateMergePatched() {
        }

        public SimpleGoodIdentificationMvoStateMergePatched(GoodIdentificationMvoEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleGoodIdentificationMvoStateDeleted extends AbstractGoodIdentificationMvoStateDeleted
    {
        public SimpleGoodIdentificationMvoStateDeleted() {
        }

        public SimpleGoodIdentificationMvoStateDeleted(GoodIdentificationMvoEventId eventId) {
            super(eventId);
        }
    }
