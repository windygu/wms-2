...
public abstract class AbstractInOutLineMvoEvent extends AbstractEvent implements InOutLineMvoEvent 
{
    private InOutLineMvoEventId inOutLineMvoEventId;

    public InOutLineMvoEventId getInOutLineMvoEventId() {
        return this.inOutLineMvoEventId;
    }

    public void setInOutLineMvoEventId(InOutLineMvoEventId eventId) {
        this.inOutLineMvoEventId = eventId;
    }
    ...
    protected AbstractInOutLineMvoEvent() {
    }

    protected AbstractInOutLineMvoEvent(InOutLineMvoEventId eventId) {
        this.inOutLineMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractInOutLineMvoStateEvent extends AbstractInOutLineMvoEvent implements InOutLineMvoEvent.InOutLineMvoStateEvent {
    ...
    public static abstract class AbstractInOutLineMvoStateCreated extends AbstractInOutLineMvoStateEvent implements InOutLineMvoEvent.InOutLineMvoStateCreated
    {
    ...
    public static abstract class AbstractInOutLineMvoStateMergePatched extends AbstractInOutLineMvoStateEvent implements InOutLineMvoEvent.InOutLineMvoStateMergePatched
    {
    ...
    public static abstract class AbstractInOutLineMvoStateDeleted extends AbstractInOutLineMvoStateEvent implements InOutLineMvoEvent.InOutLineMvoStateDeleted
    {
