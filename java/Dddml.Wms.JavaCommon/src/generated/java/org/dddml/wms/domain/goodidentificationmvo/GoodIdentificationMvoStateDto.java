...
public class GoodIdentificationMvoStateDto
{
    ...
    public static class DtoConverter extends AbstractStateDtoConverter
    {
        ...
        public GoodIdentificationMvoStateDto[] toGoodIdentificationMvoStateDtoArray(Iterable<GoodIdentificationMvoState> states) 
        {
            ArrayList<GoodIdentificationMvoStateDto> stateDtos = new ArrayList();
            for (GoodIdentificationMvoState s : states) {
                GoodIdentificationMvoStateDto dto = toGoodIdentificationMvoStateDto(s);
                stateDtos.add(dto);
            }
            return stateDtos.toArray(new GoodIdentificationMvoStateDto[0]);
        }

        public GoodIdentificationMvoStateDto toGoodIdentificationMvoStateDto(GoodIdentificationMvoState state)
        {
            if(state == null) {
                return null;
            }
            GoodIdentificationMvoStateDto dto = new GoodIdentificationMvoStateDto();
            if (returnedFieldsContains("ProductGoodIdentificationId")) {
                dto.setProductGoodIdentificationId(state.getProductGoodIdentificationId());
            }
            ...
            if (returnedFieldsContains("ProductProductTypeId")) {
                dto.setProductProductTypeId(state.getProductProductTypeId());
            }
            if (returnedFieldsContains("ProductPrimaryProductCategoryId")) {
                dto.setProductPrimaryProductCategoryId(state.getProductPrimaryProductCategoryId());
            }
            if (returnedFieldsContains("ProductManufacturerPartyId")) {
                dto.setProductManufacturerPartyId(state.getProductManufacturerPartyId());
            }
            if (returnedFieldsContains("ProductFacilityId")) {
                dto.setProductFacilityId(state.getProductFacilityId());
            }
            if (returnedFieldsContains("ProductIntroductionDate")) {
                dto.setProductIntroductionDate(state.getProductIntroductionDate());
            }
            if (returnedFieldsContains("ProductReleaseDate")) {
                dto.setProductReleaseDate(state.getProductReleaseDate());
            }
            if (returnedFieldsContains("ProductSupportDiscontinuationDate")) {
                dto.setProductSupportDiscontinuationDate(state.getProductSupportDiscontinuationDate());
            }
            if (returnedFieldsContains("ProductSalesDiscontinuationDate")) {
                dto.setProductSalesDiscontinuationDate(state.getProductSalesDiscontinuationDate());
            }
            if (returnedFieldsContains("ProductSalesDiscWhenNotAvail")) {
                dto.setProductSalesDiscWhenNotAvail(state.getProductSalesDiscWhenNotAvail());
            }
            if (returnedFieldsContains("ProductInternalName")) {
                dto.setProductInternalName(state.getProductInternalName());
            }
            if (returnedFieldsContains("ProductBrandName")) {
                dto.setProductBrandName(state.getProductBrandName());
            }
            if (returnedFieldsContains("ProductComments")) {
                dto.setProductComments(state.getProductComments());
            }
            if (returnedFieldsContains("ProductProductName")) {
                dto.setProductProductName(state.getProductProductName());
            }
            if (returnedFieldsContains("ProductDescription")) {
                dto.setProductDescription(state.getProductDescription());
            }
            if (returnedFieldsContains("ProductPriceDetailText")) {
                dto.setProductPriceDetailText(state.getProductPriceDetailText());
            }
            if (returnedFieldsContains("ProductSmallImageUrl")) {
                dto.setProductSmallImageUrl(state.getProductSmallImageUrl());
            }
            if (returnedFieldsContains("ProductMediumImageUrl")) {
                dto.setProductMediumImageUrl(state.getProductMediumImageUrl());
            }
            if (returnedFieldsContains("ProductLargeImageUrl")) {
                dto.setProductLargeImageUrl(state.getProductLargeImageUrl());
            }
            if (returnedFieldsContains("ProductDetailImageUrl")) {
                dto.setProductDetailImageUrl(state.getProductDetailImageUrl());
            }
            if (returnedFieldsContains("ProductOriginalImageUrl")) {
                dto.setProductOriginalImageUrl(state.getProductOriginalImageUrl());
            }
            if (returnedFieldsContains("ProductDetailScreen")) {
                dto.setProductDetailScreen(state.getProductDetailScreen());
            }
            if (returnedFieldsContains("ProductInventoryMessage")) {
                dto.setProductInventoryMessage(state.getProductInventoryMessage());
            }
            if (returnedFieldsContains("ProductInventoryItemTypeId")) {
                dto.setProductInventoryItemTypeId(state.getProductInventoryItemTypeId());
            }
            if (returnedFieldsContains("ProductRequireInventory")) {
                dto.setProductRequireInventory(state.getProductRequireInventory());
            }
            if (returnedFieldsContains("ProductQuantityUomId")) {
                dto.setProductQuantityUomId(state.getProductQuantityUomId());
            }
            if (returnedFieldsContains("ProductQuantityIncluded")) {
                dto.setProductQuantityIncluded(state.getProductQuantityIncluded());
            }
            if (returnedFieldsContains("ProductPiecesIncluded")) {
                dto.setProductPiecesIncluded(state.getProductPiecesIncluded());
            }
            if (returnedFieldsContains("ProductRequireAmount")) {
                dto.setProductRequireAmount(state.getProductRequireAmount());
            }
            if (returnedFieldsContains("ProductFixedAmount")) {
                dto.setProductFixedAmount(state.getProductFixedAmount());
            }
            if (returnedFieldsContains("ProductAmountUomTypeId")) {
                dto.setProductAmountUomTypeId(state.getProductAmountUomTypeId());
            }
            if (returnedFieldsContains("ProductWeightUomId")) {
                dto.setProductWeightUomId(state.getProductWeightUomId());
            }
            if (returnedFieldsContains("ProductShippingWeight")) {
                dto.setProductShippingWeight(state.getProductShippingWeight());
            }
            if (returnedFieldsContains("ProductProductWeight")) {
                dto.setProductProductWeight(state.getProductProductWeight());
            }
            if (returnedFieldsContains("ProductHeightUomId")) {
                dto.setProductHeightUomId(state.getProductHeightUomId());
            }
            if (returnedFieldsContains("ProductProductHeight")) {
                dto.setProductProductHeight(state.getProductProductHeight());
            }
            if (returnedFieldsContains("ProductShippingHeight")) {
                dto.setProductShippingHeight(state.getProductShippingHeight());
            }
            if (returnedFieldsContains("ProductWidthUomId")) {
                dto.setProductWidthUomId(state.getProductWidthUomId());
            }
            if (returnedFieldsContains("ProductProductWidth")) {
                dto.setProductProductWidth(state.getProductProductWidth());
            }
            if (returnedFieldsContains("ProductShippingWidth")) {
                dto.setProductShippingWidth(state.getProductShippingWidth());
            }
            if (returnedFieldsContains("ProductDepthUomId")) {
                dto.setProductDepthUomId(state.getProductDepthUomId());
            }
            if (returnedFieldsContains("ProductProductDepth")) {
                dto.setProductProductDepth(state.getProductProductDepth());
            }
            if (returnedFieldsContains("ProductShippingDepth")) {
                dto.setProductShippingDepth(state.getProductShippingDepth());
            }
            if (returnedFieldsContains("ProductDiameterUomId")) {
                dto.setProductDiameterUomId(state.getProductDiameterUomId());
            }
            if (returnedFieldsContains("ProductProductDiameter")) {
                dto.setProductProductDiameter(state.getProductProductDiameter());
            }
            if (returnedFieldsContains("ProductProductRating")) {
                dto.setProductProductRating(state.getProductProductRating());
            }
            if (returnedFieldsContains("ProductRatingTypeEnum")) {
                dto.setProductRatingTypeEnum(state.getProductRatingTypeEnum());
            }
            if (returnedFieldsContains("ProductReturnable")) {
                dto.setProductReturnable(state.getProductReturnable());
            }
            if (returnedFieldsContains("ProductTaxable")) {
                dto.setProductTaxable(state.getProductTaxable());
            }
            if (returnedFieldsContains("ProductChargeShipping")) {
                dto.setProductChargeShipping(state.getProductChargeShipping());
            }
            if (returnedFieldsContains("ProductAutoCreateKeywords")) {
                dto.setProductAutoCreateKeywords(state.getProductAutoCreateKeywords());
            }
            if (returnedFieldsContains("ProductIncludeInPromotions")) {
                dto.setProductIncludeInPromotions(state.getProductIncludeInPromotions());
            }
            if (returnedFieldsContains("ProductIsVirtual")) {
                dto.setProductIsVirtual(state.getProductIsVirtual());
            }
            if (returnedFieldsContains("ProductIsVariant")) {
                dto.setProductIsVariant(state.getProductIsVariant());
            }
            if (returnedFieldsContains("ProductVirtualVariantMethodEnum")) {
                dto.setProductVirtualVariantMethodEnum(state.getProductVirtualVariantMethodEnum());
            }
            if (returnedFieldsContains("ProductInShippingBox")) {
                dto.setProductInShippingBox(state.getProductInShippingBox());
            }
            if (returnedFieldsContains("ProductDefaultShipmentBoxTypeId")) {
                dto.setProductDefaultShipmentBoxTypeId(state.getProductDefaultShipmentBoxTypeId());
            }
            if (returnedFieldsContains("ProductIsSerialNumbered")) {
                dto.setProductIsSerialNumbered(state.getProductIsSerialNumbered());
            }
            if (returnedFieldsContains("ProductIsManagedByLot")) {
                dto.setProductIsManagedByLot(state.getProductIsManagedByLot());
            }
            if (returnedFieldsContains("ProductAttributeSetId")) {
                dto.setProductAttributeSetId(state.getProductAttributeSetId());
            }
            if (returnedFieldsContains("ProductAttributeSetInstanceId")) {
                dto.setProductAttributeSetInstanceId(state.getProductAttributeSetInstanceId());
            }
            if (returnedFieldsContains("ProductCreatedBy")) {
                dto.setProductCreatedBy(state.getProductCreatedBy());
            }
            if (returnedFieldsContains("ProductCreatedAt")) {
                dto.setProductCreatedAt(state.getProductCreatedAt());
            }
            if (returnedFieldsContains("ProductUpdatedBy")) {
                dto.setProductUpdatedBy(state.getProductUpdatedBy());
            }
            if (returnedFieldsContains("ProductUpdatedAt")) {
                dto.setProductUpdatedAt(state.getProductUpdatedAt());
            }
            if (returnedFieldsContains("ProductActive")) {
                dto.setProductActive(state.getProductActive());
            }
            if (returnedFieldsContains("ProductVersion")) {
                dto.setProductVersion(state.getProductVersion());
            }
