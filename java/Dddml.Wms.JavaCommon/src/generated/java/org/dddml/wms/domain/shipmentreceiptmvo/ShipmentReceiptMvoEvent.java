...
public interface ShipmentReceiptMvoEvent extends Event
{
    ...
    interface ShipmentReceiptMvoStateCreated extends ShipmentReceiptMvoEvent
    {
    
    }


    interface ShipmentReceiptMvoStateMergePatched extends ShipmentReceiptMvoEvent
    {
