...
public abstract class AbstractOrderItemMvoEvent extends AbstractEvent implements OrderItemMvoEvent 
{
    ...
    protected AbstractOrderItemMvoEvent() {
    }

    protected AbstractOrderItemMvoEvent(OrderItemMvoEventId eventId) {
        this.orderItemMvoEventId = eventId;
    }
    ...
    public static abstract class AbstractOrderItemMvoStateEvent extends AbstractOrderItemMvoEvent implements OrderItemMvoEvent.OrderItemMvoStateEvent {
    ...
    public static abstract class AbstractOrderItemMvoStateCreated extends AbstractOrderItemMvoStateEvent implements OrderItemMvoEvent.OrderItemMvoStateCreated
    {
    ...
    public static abstract class AbstractOrderItemMvoStateMergePatched extends AbstractOrderItemMvoStateEvent implements OrderItemMvoEvent.OrderItemMvoStateMergePatched
    {
    ...
    public static class SimpleOrderItemMvoStateMergePatched extends AbstractOrderItemMvoStateMergePatched
    {
