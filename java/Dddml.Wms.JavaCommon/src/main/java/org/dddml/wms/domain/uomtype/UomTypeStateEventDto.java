...
public class UomTypeStateEventDto extends AbstractStateEvent
{

    private UomTypeStateEventIdDto stateEventId;

    UomTypeStateEventIdDto getStateEventId() {
        if (stateEventId == null) { stateEventId = new UomTypeStateEventIdDto(); }
        return this.stateEventId;
    }

    void setStateEventId(UomTypeStateEventIdDto stateEventId) {
	...
	public static class UomTypeStateCreatedDto extends UomTypeStateEventDto
	{
        @Override
	...
	public static class UomTypeStateMergePatchedDto extends UomTypeStateEventDto
	{
        @Override
        public String getStateEventType()
        {
	...
	public static class UomTypeStateDeletedDto extends UomTypeStateEventDto
	{
        @Override
        public String getStateEventType()
        {
