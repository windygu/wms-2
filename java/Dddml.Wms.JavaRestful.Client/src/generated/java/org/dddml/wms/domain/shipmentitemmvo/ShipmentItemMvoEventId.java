...
public class ShipmentItemMvoEventId implements Serializable
{
    ...
    protected String getShipmentItemIdShipmentId()
    {
        return getShipmentItemId().getShipmentId();
    }

    protected void setShipmentItemIdShipmentId(String shipmentItemIdShipmentId)
    {
        getShipmentItemId().setShipmentId(shipmentItemIdShipmentId);
    }

    protected String getShipmentItemIdShipmentItemSeqId()
    {
        return getShipmentItemId().getShipmentItemSeqId();
    }

    protected void setShipmentItemIdShipmentItemSeqId(String shipmentItemIdShipmentItemSeqId)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        ShipmentItemMvoEventId other = (ShipmentItemMvoEventId)obj;
        return true 
