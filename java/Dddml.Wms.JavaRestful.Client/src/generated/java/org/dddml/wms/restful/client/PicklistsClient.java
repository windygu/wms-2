...
public interface PicklistsClient {
    ...
    Call<List<PicklistRoleStateDto>> getPicklistRoles(@Path("picklistId") String picklistId, @Query("sort") String sort, @Query("fields") String fields, @Query("filter") String filter);
