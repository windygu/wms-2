...
public class ShipmentMethodTypeEventId implements Serializable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        ShipmentMethodTypeEventId other = (ShipmentMethodTypeEventId)obj;
        return true 
            && (shipmentMethodTypeId == other.shipmentMethodTypeId || (shipmentMethodTypeId != null && shipmentMethodTypeId.equals(other.shipmentMethodTypeId)))
    ...
    public int hashCode()
    {
        ...
        if (this.shipmentMethodTypeId != null) {
            hash += 13 * this.shipmentMethodTypeId.hashCode();
        }
