...
public class PickwaveEventId implements Serializable
{
    ...
    public PickwaveEventId()
    {
    }

    public PickwaveEventId(Long pickwaveId, Long version)
    {
        this.pickwaveId = pickwaveId;
        this.version = version;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        PickwaveEventId other = (PickwaveEventId)obj;
        return true 
            && (pickwaveId == other.pickwaveId || (pickwaveId != null && pickwaveId.equals(other.pickwaveId)))
    ...
    {
        int hash = 0;
        if (this.pickwaveId != null) {
            hash += 13 * this.pickwaveId.hashCode();
        }
