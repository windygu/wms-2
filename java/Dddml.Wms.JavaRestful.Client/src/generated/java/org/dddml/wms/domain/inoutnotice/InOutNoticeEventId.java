...
public class InOutNoticeEventId implements Serializable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        InOutNoticeEventId other = (InOutNoticeEventId)obj;
        return true 
            && (inOutNoticeId == other.inOutNoticeId || (inOutNoticeId != null && inOutNoticeId.equals(other.inOutNoticeId)))
    ...
    public int hashCode()
    {
        ...
        if (this.inOutNoticeId != null) {
            hash += 13 * this.inOutNoticeId.hashCode();
        }
