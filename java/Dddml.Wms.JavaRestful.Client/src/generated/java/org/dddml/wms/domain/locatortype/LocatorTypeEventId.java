...
public class LocatorTypeEventId implements Serializable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        LocatorTypeEventId other = (LocatorTypeEventId)obj;
        return true 
            && (locatorTypeId == other.locatorTypeId || (locatorTypeId != null && locatorTypeId.equals(other.locatorTypeId)))
    ...
    public int hashCode()
    {
        ...
        if (this.locatorTypeId != null) {
            hash += 13 * this.locatorTypeId.hashCode();
        }
