...
public interface RxAttributeSetInstanceExtensionFieldGroupsClient {
    ...
    @Headers("Accept: application/json")
    @POST("AttributeSetInstanceExtensionFieldGroups")
    Observable<String> post(@Body CreateOrMergePatchAttributeSetInstanceExtensionFieldGroupDto.CreateAttributeSetInstanceExtensionFieldGroupDto value);
