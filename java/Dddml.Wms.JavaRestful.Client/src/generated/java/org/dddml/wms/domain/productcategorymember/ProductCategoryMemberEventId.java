...
public class ProductCategoryMemberEventId implements Serializable
{
    ...
    protected String getProductCategoryMemberIdProductCategoryId()
    {
        return getProductCategoryMemberId().getProductCategoryId();
    }

    protected void setProductCategoryMemberIdProductCategoryId(String productCategoryMemberIdProductCategoryId)
    {
        getProductCategoryMemberId().setProductCategoryId(productCategoryMemberIdProductCategoryId);
    }

    protected String getProductCategoryMemberIdProductId()
    {
        return getProductCategoryMemberId().getProductId();
    }

    protected void setProductCategoryMemberIdProductId(String productCategoryMemberIdProductId)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        ProductCategoryMemberEventId other = (ProductCategoryMemberEventId)obj;
        return true 
