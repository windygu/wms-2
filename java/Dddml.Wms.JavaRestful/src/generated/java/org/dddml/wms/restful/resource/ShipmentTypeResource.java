...
public class ShipmentTypeResource {
    ...
    public Page<ShipmentTypeStateDto> getPage( HttpServletRequest request,
        ...
        try {
            List<String> sort = ShipmentTypeResourceUtils.getQuerySorts(request.getParameterMap());
            Integer firstResult = (page == null ? 0 : page) * size;
            Integer maxResults = (size ==null ? 0 : size);
            Iterable<ShipmentTypeState> states = null; 
            Iterable<Map.Entry<String, Object>> queryFilterMap = ShipmentTypeResourceUtils.getQueryFilterMap(request.getParameterMap());
            states = shipmentTypeApplicationService.get(
                        CriterionDto.toSubclass(
                        ...
                        firstResult, maxResults);
            long count = shipmentTypeApplicationService.getCount(queryFilterMap);
    ...
    public static class ShipmentTypeResourceUtils {
        ...
        public static List<String> getQuerySorts(Map<String, String[]> queryNameValuePairs) {
            return QueryParamUtils.getQuerySorts(queryNameValuePairs, ShipmentTypeMetadata.aliasMap);
        }
