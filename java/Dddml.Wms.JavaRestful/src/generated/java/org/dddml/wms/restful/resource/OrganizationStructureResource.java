...
public class OrganizationStructureResource {
     ...
     */
    @GetMapping
    public OrganizationStructureStateDto[] getAll(@Specification(value = OrganizationStructureStateDto.class) HttpServletRequest request,
     ...
     */
    @GetMapping("_page")
    public Page<OrganizationStructureStateDto> getPage(@Specification(value = OrganizationStructureStateDto.class) HttpServletRequest request,
                    @RequestParam(value = "fields", required = false) String fields,
        ...
        try {
            ...
            Page.PageImpl<OrganizationStructureStateDto> statePage =  new Page.PageImpl<>(dtoConverter.toOrganizationStructureStateDtoList(states), count);
    ...
    @GetMapping("_count")
    public long getCount(@Specification(value = OrganizationStructureStateDto.class) HttpServletRequest request,
                         @RequestParam(value = "filter", required = false) String filter) {
        try {
            long count = 0;
            CriterionDto criterion = null;
            ...
            Criterion c = CriterionDto.toSubclass(criterion,
                ...
                n -> (OrganizationStructureMetadata.aliasMap.containsKey(n) ? OrganizationStructureMetadata.aliasMap.get(n) : n));
            count = organizationStructureApplicationService.getCount(c);
            return count;
