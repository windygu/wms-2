...
public class OrderItemShipGrpInvReservationResource {
     ...
     */
    @GetMapping
    public OrderItemShipGrpInvReservationStateDto[] getAll(@Specification(value = OrderItemShipGrpInvReservationStateDto.class) HttpServletRequest request,
     ...
     */
    @GetMapping("_page")
    public Page<OrderItemShipGrpInvReservationStateDto> getPage(@Specification(value = OrderItemShipGrpInvReservationStateDto.class) HttpServletRequest request,
                    @RequestParam(value = "fields", required = false) String fields,
    ...
    @GetMapping("_count")
    public long getCount(@Specification(value = OrderItemShipGrpInvReservationStateDto.class) HttpServletRequest request,
                         @RequestParam(value = "filter", required = false) String filter) {
        try {
            long count = 0;
            CriterionDto criterion = null;
            ...
            Criterion c = CriterionDto.toSubclass(criterion,
                ...
                n -> (OrderItemShipGrpInvReservationMetadata.aliasMap.containsKey(n) ? OrderItemShipGrpInvReservationMetadata.aliasMap.get(n) : n));
            count = orderItemShipGrpInvReservationApplicationService.getCount(c);
            return count;
