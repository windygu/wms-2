...
public class StatusItemResource {
     ...
     */
    @GetMapping
    public StatusItemStateDto[] getAll(@Specification(value = StatusItemStateDto.class) HttpServletRequest request,
     ...
     */
    @GetMapping("_page")
    public Page<StatusItemStateDto> getPage(@Specification(value = StatusItemStateDto.class) HttpServletRequest request,
                    @RequestParam(value = "fields", required = false) String fields,
    ...
    @GetMapping("_count")
    public long getCount(@Specification(value = StatusItemStateDto.class) HttpServletRequest request,
                         @RequestParam(value = "filter", required = false) String filter) {
        try {
            long count = 0;
            CriterionDto criterion = null;
