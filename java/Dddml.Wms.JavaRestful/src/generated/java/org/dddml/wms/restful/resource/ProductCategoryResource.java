...
public class ProductCategoryResource {
     ...
     */
    @GetMapping
    public ProductCategoryStateDto[] getAll(@Specification(value = ProductCategoryStateDto.class) HttpServletRequest request,
     ...
     */
    @GetMapping("_page")
    public Page<ProductCategoryStateDto> getPage(@Specification(value = ProductCategoryStateDto.class) HttpServletRequest request,
                    @RequestParam(value = "fields", required = false) String fields,
    ...
    @GetMapping("_count")
    public long getCount(@Specification(value = ProductCategoryStateDto.class) HttpServletRequest request,
                         @RequestParam(value = "filter", required = false) String filter) {
        try {
            long count = 0;
            CriterionDto criterion = null;
