...
@Path("ItemIssuanceMvos") @Produces(MediaType.APPLICATION_JSON)
public class ItemIssuanceMvoResource {
    ...
    @GET
    public ItemIssuanceMvoStateDto[] getAll(@Context HttpServletRequest request,
            ...
            if (!StringHelper.isNullOrEmpty(filter)) {
                states = itemIssuanceMvoApplicationService.get(
                        CriterionDto.toSubclass(
                                ...
                                getCriterionTypeConverter(), getPropertyTypeResolver(), n -> (ItemIssuanceMvoFilteringProperties.aliasMap.containsKey(n) ? ItemIssuanceMvoFilteringProperties.aliasMap.get(n) : n)),
    ...
    @Path("{id}") @GET
    public ItemIssuanceMvoStateDto get(@PathParam("id") String id, @QueryParam("fields") String fields) {
        try {
    ...
    @Path("{id}") @PATCH
    public void patch(@PathParam("id") String id, CreateOrMergePatchItemIssuanceMvoDto.MergePatchItemIssuanceMvoDto value) {
        try {
    ...
    public List<PropertyMetadataDto> getMetadataFilteringFields() {
        try {
            ...
            ItemIssuanceMvoFilteringProperties.propertyTypeMap.forEach((key, value) -> {
    ...
    public ItemIssuanceMvoStateEventDto getStateEvent(@PathParam("id") String id, @PathParam("version") long version) {
        try {

            ShipmentItemIssuanceId idObj = ItemIssuanceMvoResourceUtils.parseIdString(id);
            ItemIssuanceMvoStateEventDtoConverter dtoConverter = getItemIssuanceMvoStateEventDtoConverter();
            return dtoConverter.toItemIssuanceMvoStateEventDto((AbstractItemIssuanceMvoStateEvent) itemIssuanceMvoApplicationService.getStateEvent(idObj, version));

        } catch (DomainError error) { throw error; } catch (Exception ex) { throw new DomainError("ExceptionCaught", ex); }
    }

    @Path("{id}/_historyStates/{version}") @GET
    public ItemIssuanceMvoStateDto getHistoryState(@PathParam("id") String id, @PathParam("version") long version, @QueryParam("fields") String fields) {
        try {
    ...
    public static class ItemIssuanceMvoResourceUtils {
        ...
        public static String getFilterPropertyName(String fieldName) {
            ...
            if (ItemIssuanceMvoFilteringProperties.aliasMap.containsKey(fieldName)) {
                return ItemIssuanceMvoFilteringProperties.aliasMap.get(fieldName);
            }
            return null;
        }

        public static Class getFilterPropertyType(String propertyName) {
            if (ItemIssuanceMvoFilteringProperties.propertyTypeMap.containsKey(propertyName)) {
                String propertyType = ItemIssuanceMvoFilteringProperties.propertyTypeMap.get(propertyName);
