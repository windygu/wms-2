...
@Path("ShipmentPackages") @Produces(MediaType.APPLICATION_JSON)
public class ShipmentPackageResource {
    ...
    @GET
    public ShipmentPackageStateDto[] getAll(@Context HttpServletRequest request,
            ...
            if (!StringHelper.isNullOrEmpty(filter)) {
                states = shipmentPackageApplicationService.get(
                        CriterionDto.toSubclass(
                                ...
                                getCriterionTypeConverter(), getPropertyTypeResolver(), n -> (ShipmentPackageFilteringProperties.aliasMap.containsKey(n) ? ShipmentPackageFilteringProperties.aliasMap.get(n) : n)),
    ...
    @Path("{id}") @GET
    public ShipmentPackageStateDto get(@PathParam("id") String id, @QueryParam("fields") String fields) {
        try {
    ...
    @Path("{id}") @PUT
    public void put(@PathParam("id") String id, CreateOrMergePatchShipmentPackageDto.CreateShipmentPackageDto value) {
        try {
    ...
    @Path("{id}") @PATCH
    public void patch(@PathParam("id") String id, CreateOrMergePatchShipmentPackageDto.MergePatchShipmentPackageDto value) {
        try {
    ...
    public List<PropertyMetadataDto> getMetadataFilteringFields() {
        try {
            ...
            ShipmentPackageFilteringProperties.propertyTypeMap.forEach((key, value) -> {
    ...
    public ShipmentPackageStateEventDto getStateEvent(@PathParam("id") String id, @PathParam("version") long version) {
        try {
    ...
    public ShipmentPackageStateDto getHistoryState(@PathParam("id") String id, @PathParam("version") long version, @QueryParam("fields") String fields) {
        try {
    ...
    @Path("{shipmentPackageId}/ShipmentPackageContents/{shipmentItemSeqId}") @GET
    public ShipmentPackageContentStateDto getShipmentPackageContent(@PathParam("shipmentPackageId") String shipmentPackageId, @PathParam("shipmentItemSeqId") String shipmentItemSeqId) {
        try {
    ...
    public static class ShipmentPackageResourceUtils {
        ...
        public static String getFilterPropertyName(String fieldName) {
            ...
            if (ShipmentPackageFilteringProperties.aliasMap.containsKey(fieldName)) {
                return ShipmentPackageFilteringProperties.aliasMap.get(fieldName);
            }
            return null;
        }

        public static Class getFilterPropertyType(String propertyName) {
            if (ShipmentPackageFilteringProperties.propertyTypeMap.containsKey(propertyName)) {
                String propertyType = ShipmentPackageFilteringProperties.propertyTypeMap.get(propertyName);
