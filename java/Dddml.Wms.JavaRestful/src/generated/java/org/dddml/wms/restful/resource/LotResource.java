...
@Path("Lots") @Produces(MediaType.APPLICATION_JSON)
public class LotResource {
    ...
    @GET
    public LotStateDto[] getAll(@Context HttpServletRequest request,
    ...
    @Path("{id}") @GET
    public LotStateDto get(@PathParam("id") String id, @QueryParam("fields") String fields) {
        try {
            String idObj = id;
    ...
    @Path("{id}") @PATCH
    public void patch(@PathParam("id") String id, CreateOrMergePatchLotDto.MergePatchLotDto value) {
        try {
    ...
    public LotStateEventDto getStateEvent(@PathParam("id") String id, @PathParam("version") long version) {
        try {
    ...
    public LotStateDto getHistoryState(@PathParam("id") String id, @PathParam("version") long version, @QueryParam("fields") String fields) {
        try {
