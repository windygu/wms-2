...
public class UomResource {
     ...
     */
    @GetMapping
    public UomStateDto[] getAll(@Specification(value = UomStateDto.class) HttpServletRequest request,
     ...
     */
    @GetMapping("_page")
    public Page<UomStateDto> getPage(@Specification(value = UomStateDto.class) HttpServletRequest request,
                    @RequestParam(value = "fields", required = false) String fields,
    ...
    @GetMapping("_count")
    public long getCount(@Specification(value = UomStateDto.class) HttpServletRequest request,
                         @RequestParam(value = "filter", required = false) String filter) {
        try {
            long count = 0;
            CriterionDto criterion = null;
