...
@Path("Locators") @Produces(MediaType.APPLICATION_JSON)
public class LocatorResource {
    ...
    @POST
    public String post(CreateOrMergePatchLocatorDto.CreateLocatorDto value, @Context HttpServletResponse response) {
        try {
    ...
    @Path("{id}") @PUT
    public void put(@PathParam("id") String id, CreateOrMergePatchLocatorDto value) {
        try {
    ...
    public LocatorStateEventDto getStateEvent(@PathParam("id") String id, @PathParam("version") long version) {
        try {
            ...
            return dtoConverter.toLocatorStateEventDto((AbstractLocatorEvent) locatorApplicationService.getEvent(idObj, version));
