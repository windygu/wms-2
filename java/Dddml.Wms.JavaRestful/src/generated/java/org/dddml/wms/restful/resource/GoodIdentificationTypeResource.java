...
@Path("GoodIdentificationTypes") @Produces(MediaType.APPLICATION_JSON)
public class GoodIdentificationTypeResource {
    ...
    @GET
    public GoodIdentificationTypeStateDto[] getAll(@Context HttpServletRequest request,
    ...
    @Path("{id}") @GET
    public GoodIdentificationTypeStateDto get(@PathParam("id") String id, @QueryParam("fields") String fields) {
        try {
            String idObj = id;
    ...
    @POST
    public String post(CreateOrMergePatchGoodIdentificationTypeDto.CreateGoodIdentificationTypeDto value, @Context HttpServletResponse response) {
        try {
    ...
    @Path("{id}") @PUT
    public void put(@PathParam("id") String id, CreateOrMergePatchGoodIdentificationTypeDto value) {
        try {
    ...
    @Path("{id}") @PATCH
    public void patch(@PathParam("id") String id, CreateOrMergePatchGoodIdentificationTypeDto.MergePatchGoodIdentificationTypeDto value) {
        try {
    ...
    public GoodIdentificationTypeStateEventDto getStateEvent(@PathParam("id") String id, @PathParam("version") long version) {
        try {
    ...
    public GoodIdentificationTypeStateDto getHistoryState(@PathParam("id") String id, @PathParam("version") long version, @QueryParam("fields") String fields) {
        try {
