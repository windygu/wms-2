...
public class OrderShipGroupMvoResource {
    ...
    @POST
    public OrderShipGroupId post(CreateOrMergePatchOrderShipGroupMvoDto.CreateOrderShipGroupMvoDto value, @Context HttpServletResponse response) {
        try {
    ...
    @Path("{id}") @PUT
    public void put(@PathParam("id") String id, CreateOrMergePatchOrderShipGroupMvoDto value) {
        try {
