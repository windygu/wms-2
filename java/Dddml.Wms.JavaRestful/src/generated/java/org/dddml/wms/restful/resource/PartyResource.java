...
public class PartyResource {
    ...
    public Page<PartyStateDto> getPage( HttpServletRequest request,
        ...
        try {
            List<String> sort = PartyResourceUtils.getQuerySorts(request.getParameterMap());
            Integer firstResult = (page == null ? 0 : page) * size;
            Integer maxResults = (size ==null ? 0 : size);
            Iterable<PartyState> states = null; 
            Iterable<Map.Entry<String, Object>> queryFilterMap = PartyResourceUtils.getQueryFilterMap(request.getParameterMap());
            states = partyApplicationService.get(
                        CriterionDto.toSubclass(
    ...
    public static class PartyResourceUtils {
        ...
        public static List<String> getQuerySorts(Map<String, String[]> queryNameValuePairs) {
            return QueryParamUtils.getQuerySorts(queryNameValuePairs, PartyMetadata.aliasMap);
        }
