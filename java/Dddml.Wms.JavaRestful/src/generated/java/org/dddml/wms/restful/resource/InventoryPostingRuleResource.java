...
@RequestMapping(path = "InventoryPostingRules", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
@RestController
public class InventoryPostingRuleResource {
    ...
    public long getCount( HttpServletRequest request,
        ...
        try {
            ...
            count = inventoryPostingRuleApplicationService.getCount(CriterionDto.toSubclass(criterion,
