...
public class ProductCategoryMemberResource {
     ...
     */
    @GetMapping
    public ProductCategoryMemberStateDto[] getAll(@Specification(value = ProductCategoryMemberStateDto.class) HttpServletRequest request,
     ...
     */
    @GetMapping("_page")
    public Page<ProductCategoryMemberStateDto> getPage(@Specification(value = ProductCategoryMemberStateDto.class) HttpServletRequest request,
                    @RequestParam(value = "fields", required = false) String fields,
        ...
        try {
            ...
            Page.PageImpl<ProductCategoryMemberStateDto> statePage =  new Page.PageImpl<>(dtoConverter.toProductCategoryMemberStateDtoList(states), count);
    ...
    @GetMapping("_count")
    public long getCount(@Specification(value = ProductCategoryMemberStateDto.class) HttpServletRequest request,
                         @RequestParam(value = "filter", required = false) String filter) {
        try {
            long count = 0;
            CriterionDto criterion = null;
            ...
            Criterion c = CriterionDto.toSubclass(criterion,
                ...
                n -> (ProductCategoryMemberMetadata.aliasMap.containsKey(n) ? ProductCategoryMemberMetadata.aliasMap.get(n) : n));
            count = productCategoryMemberApplicationService.getCount(c);
            return count;
