...
public class DocumentTypeResource {
     ...
     */
    @GetMapping
    public DocumentTypeStateDto[] getAll(@Specification(value = DocumentTypeStateDto.class) HttpServletRequest request,
     ...
     */
    @GetMapping("_page")
    public Page<DocumentTypeStateDto> getPage(@Specification(value = DocumentTypeStateDto.class) HttpServletRequest request,
                    @RequestParam(value = "fields", required = false) String fields,
        ...
        try {
            ...
            Page.PageImpl<DocumentTypeStateDto> statePage =  new Page.PageImpl<>(dtoConverter.toDocumentTypeStateDtoList(states), count);
    ...
    @GetMapping("_count")
    public long getCount(@Specification(value = DocumentTypeStateDto.class) HttpServletRequest request,
                         @RequestParam(value = "filter", required = false) String filter) {
        try {
            long count = 0;
            CriterionDto criterion = null;
            ...
            Criterion c = CriterionDto.toSubclass(criterion,
                ...
                n -> (DocumentTypeMetadata.aliasMap.containsKey(n) ? DocumentTypeMetadata.aliasMap.get(n) : n));
            count = documentTypeApplicationService.getCount(c);
            return count;
