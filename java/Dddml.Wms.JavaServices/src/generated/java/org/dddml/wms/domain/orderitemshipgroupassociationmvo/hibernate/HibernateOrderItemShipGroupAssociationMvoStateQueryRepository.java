...
public class HibernateOrderItemShipGroupAssociationMvoStateQueryRepository implements OrderItemShipGroupAssociationMvoStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderItemShipGroupAssociationMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<OrderItemShipGroupAssociationMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderItemShipGroupAssociationMvoState.class);
    ...
    @Transactional(readOnly = true)
    public OrderItemShipGroupAssociationMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<OrderItemShipGroupAssociationMvoState> list = (List<OrderItemShipGroupAssociationMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public OrderItemShipGroupAssociationMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
