...
public class HibernatePickwaveStateQueryRepository implements PickwaveStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(PickwaveState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<PickwaveState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(PickwaveState.class);
    ...
    @Transactional(readOnly = true)
    public PickwaveState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<PickwaveState> list = (List<PickwaveState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public PickwaveState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
