...
public class HibernateGoodIdentificationTypeStateQueryRepository implements GoodIdentificationTypeStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(GoodIdentificationTypeState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<GoodIdentificationTypeState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(GoodIdentificationTypeState.class);
    ...
    @Transactional(readOnly = true)
    public GoodIdentificationTypeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<GoodIdentificationTypeState> list = (List<GoodIdentificationTypeState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public GoodIdentificationTypeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
