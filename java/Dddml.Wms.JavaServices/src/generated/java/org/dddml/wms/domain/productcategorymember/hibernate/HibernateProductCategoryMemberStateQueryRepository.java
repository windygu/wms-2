...
public class HibernateProductCategoryMemberStateQueryRepository implements ProductCategoryMemberStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("ProductCategoryMemberId", "ThruDate", "Comments", "SequenceNum", "Quantity", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(ProductCategoryMemberState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<ProductCategoryMemberState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(ProductCategoryMemberState.class);
    ...
    @Transactional(readOnly = true)
    public ProductCategoryMemberState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<ProductCategoryMemberState> list = (List<ProductCategoryMemberState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public ProductCategoryMemberState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
