...
public class HibernateOrderRoleMvoStateQueryRepository implements OrderRoleMvoStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderRoleMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<OrderRoleMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderRoleMvoState.class);
    ...
    @Transactional(readOnly = true)
    public OrderRoleMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<OrderRoleMvoState> list = (List<OrderRoleMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public OrderRoleMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
