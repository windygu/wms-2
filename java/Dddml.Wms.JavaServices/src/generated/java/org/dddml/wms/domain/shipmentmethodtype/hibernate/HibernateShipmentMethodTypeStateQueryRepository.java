...
public class HibernateShipmentMethodTypeStateQueryRepository implements ShipmentMethodTypeStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("ShipmentMethodTypeId", "Description", "SequenceNum", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(ShipmentMethodTypeState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<ShipmentMethodTypeState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(ShipmentMethodTypeState.class);
    ...
    @Transactional(readOnly = true)
    public ShipmentMethodTypeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<ShipmentMethodTypeState> list = (List<ShipmentMethodTypeState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public ShipmentMethodTypeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
