...
public class HibernateLocatorTypeStateQueryRepository implements LocatorTypeStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(LocatorTypeState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<LocatorTypeState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(LocatorTypeState.class);
    ...
    @Transactional(readOnly = true)
    public LocatorTypeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<LocatorTypeState> list = (List<LocatorTypeState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public LocatorTypeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
