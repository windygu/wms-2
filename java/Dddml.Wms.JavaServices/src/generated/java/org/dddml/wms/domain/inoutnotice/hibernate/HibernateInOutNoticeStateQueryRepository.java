...
public class HibernateInOutNoticeStateQueryRepository implements InOutNoticeStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(InOutNoticeState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<InOutNoticeState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(InOutNoticeState.class);
    ...
    @Transactional(readOnly = true)
    public InOutNoticeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<InOutNoticeState> list = (List<InOutNoticeState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public InOutNoticeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
