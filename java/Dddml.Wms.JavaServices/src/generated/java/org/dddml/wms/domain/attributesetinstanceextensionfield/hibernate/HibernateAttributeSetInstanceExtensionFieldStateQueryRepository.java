...
public class HibernateAttributeSetInstanceExtensionFieldStateQueryRepository implements AttributeSetInstanceExtensionFieldStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("Name", "Type", "Length", "Alias", "Description", "GroupId", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    @Transactional(readOnly = true)
    public Iterable<AttributeSetInstanceExtensionFieldState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(AttributeSetInstanceExtensionFieldState.class);
    ...
    @Transactional(readOnly = true)
    public AttributeSetInstanceExtensionFieldState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<AttributeSetInstanceExtensionFieldState> list = (List<AttributeSetInstanceExtensionFieldState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public AttributeSetInstanceExtensionFieldState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
