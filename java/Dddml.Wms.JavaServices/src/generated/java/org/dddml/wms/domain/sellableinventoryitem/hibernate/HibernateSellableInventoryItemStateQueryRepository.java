...
public class HibernateSellableInventoryItemStateQueryRepository implements SellableInventoryItemStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("SellableInventoryItemId", "SellableQuantity", "Entries", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(SellableInventoryItemState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<SellableInventoryItemState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(SellableInventoryItemState.class);
    ...
    @Transactional(readOnly = true)
    public SellableInventoryItemState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<SellableInventoryItemState> list = (List<SellableInventoryItemState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public SellableInventoryItemState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
