package org.dddml.wms.domain.documenttype.hibernate;
...
public class HibernateDocumentTypeStateQueryRepository implements DocumentTypeStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("DocumentTypeId", "Description", "ParentDocumentTypeId", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(DocumentTypeState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<DocumentTypeState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(DocumentTypeState.class);
    ...
    @Transactional(readOnly = true)
    public DocumentTypeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<DocumentTypeState> list = (List<DocumentTypeState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public DocumentTypeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
