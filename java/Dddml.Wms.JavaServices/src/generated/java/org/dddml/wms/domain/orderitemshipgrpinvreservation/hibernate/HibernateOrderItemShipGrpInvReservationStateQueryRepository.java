...
public class HibernateOrderItemShipGrpInvReservationStateQueryRepository implements OrderItemShipGrpInvReservationStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderItemShipGrpInvReservationState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<OrderItemShipGrpInvReservationState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderItemShipGrpInvReservationState.class);
    ...
    @Transactional(readOnly = true)
    public OrderItemShipGrpInvReservationState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<OrderItemShipGrpInvReservationState> list = (List<OrderItemShipGrpInvReservationState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public OrderItemShipGrpInvReservationState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
