...
public class HibernateProductCategoryMemberStateRepository implements ProductCategoryMemberStateRepository
{
    ...
    public void save(ProductCategoryMemberState state)
    {
        ProductCategoryMemberState s = state;
        if (getReadOnlyProxyGenerator() != null) {
            s = (ProductCategoryMemberState) getReadOnlyProxyGenerator().getTarget(state);
        }
