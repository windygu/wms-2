...
public class HibernatePicklistItemMvoStateQueryRepository implements PicklistItemMvoStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(PicklistItemMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<PicklistItemMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(PicklistItemMvoState.class);
    ...
    @Transactional(readOnly = true)
    public PicklistItemMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<PicklistItemMvoState> list = (List<PicklistItemMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public PicklistItemMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
