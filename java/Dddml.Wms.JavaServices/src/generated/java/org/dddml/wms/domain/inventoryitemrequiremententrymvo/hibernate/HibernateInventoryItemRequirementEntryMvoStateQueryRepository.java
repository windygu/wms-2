...
public class HibernateInventoryItemRequirementEntryMvoStateQueryRepository implements InventoryItemRequirementEntryMvoStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(InventoryItemRequirementEntryMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<InventoryItemRequirementEntryMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(InventoryItemRequirementEntryMvoState.class);
    ...
    @Transactional(readOnly = true)
    public InventoryItemRequirementEntryMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<InventoryItemRequirementEntryMvoState> list = (List<InventoryItemRequirementEntryMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public InventoryItemRequirementEntryMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
