...
public class HibernateShipmentMethodTypeStateRepository implements ShipmentMethodTypeStateRepository
{
    ...
    public void save(ShipmentMethodTypeState state)
    {
        ShipmentMethodTypeState s = state;
        if (getReadOnlyProxyGenerator() != null) {
            s = (ShipmentMethodTypeState) getReadOnlyProxyGenerator().getTarget(state);
        }
