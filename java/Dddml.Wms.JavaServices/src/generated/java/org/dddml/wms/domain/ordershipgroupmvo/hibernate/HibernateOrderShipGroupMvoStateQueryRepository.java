...
public class HibernateOrderShipGroupMvoStateQueryRepository implements OrderShipGroupMvoStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderShipGroupMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<OrderShipGroupMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderShipGroupMvoState.class);
    ...
    @Transactional(readOnly = true)
    public OrderShipGroupMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<OrderShipGroupMvoState> list = (List<OrderShipGroupMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public OrderShipGroupMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
