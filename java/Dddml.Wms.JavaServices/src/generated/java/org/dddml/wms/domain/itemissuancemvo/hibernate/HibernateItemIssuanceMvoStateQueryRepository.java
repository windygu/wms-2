...
public class HibernateItemIssuanceMvoStateQueryRepository implements ItemIssuanceMvoStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(ItemIssuanceMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<ItemIssuanceMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(ItemIssuanceMvoState.class);
    ...
    @Transactional(readOnly = true)
    public ItemIssuanceMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<ItemIssuanceMvoState> list = (List<ItemIssuanceMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public ItemIssuanceMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
