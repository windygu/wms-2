package org.dddml.wms.domain.damagetype.hibernate;
...
public class HibernateDamageTypeStateQueryRepository implements DamageTypeStateQueryRepository
{
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("DamageTypeId", "Description", "SequenceId", "DefaultHandlingMethodId", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(DamageTypeState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<DamageTypeState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(DamageTypeState.class);
    ...
    @Transactional(readOnly = true)
    public DamageTypeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<DamageTypeState> list = (List<DamageTypeState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public DamageTypeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
