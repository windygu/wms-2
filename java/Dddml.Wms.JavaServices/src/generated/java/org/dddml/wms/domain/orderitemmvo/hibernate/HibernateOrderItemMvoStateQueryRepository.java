...
public class HibernateOrderItemMvoStateQueryRepository implements OrderItemMvoStateQueryRepository
{
    ...
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderItemMvoState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<OrderItemMvoState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults)
    {
        Criteria criteria = getCurrentSession().createCriteria(OrderItemMvoState.class);
    ...
    @Transactional(readOnly = true)
    public OrderItemMvoState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders)
    {
        List<OrderItemMvoState> list = (List<OrderItemMvoState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public OrderItemMvoState getFirst(Map.Entry<String, Object> keyValue, List<String> orders)
    {
