...
namespace Dddml.Wms.Domain.InventoryPostingRule.NHibernate
{
	...
	public partial class NHibernateInventoryPostingRuleStateQueryRepository : IInventoryPostingRuleStateQueryRepository
	{
        ...
        private static readonly ISet<string> _readOnlyPropertyNames = new SortedSet<string>(new String[] { "InventoryPostingRuleId", "Trigger", "Output", "IsOutputNegated", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted" });
