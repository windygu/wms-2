...
namespace Dddml.Wms.Domain.InventoryPRTriggered.NHibernate
{
	...
	public partial class NHibernateInventoryPRTriggeredStateQueryRepository : IInventoryPRTriggeredStateQueryRepository
	{
		...
		public NHibernateInventoryPRTriggeredStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<InventoryPRTriggeredState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<InventoryPRTriggeredState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IInventoryPRTriggeredState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<InventoryPRTriggeredState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IInventoryPRTriggeredState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<InventoryPRTriggeredState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IInventoryPRTriggeredState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
