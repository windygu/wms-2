...
namespace Dddml.Wms.Domain.Locator.NHibernate
{
	...
	public partial class NHibernateLocatorStateQueryRepository : ILocatorStateQueryRepository
	{
        ...
        private static readonly ISet<string> _readOnlyPropertyNames = new SortedSet<string>(new String[] { "LocatorId", "WarehouseId", "ParentLocatorId", "LocatorType", "PriorityNumber", "IsDefault", "X", "Y", "Z", "Description", "LocatorTypeId", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted" });
    
        public IReadOnlyProxyGenerator ReadOnlyProxyGenerator { get; set; }

		public NHibernateLocatorStateQueryRepository ()
		{
		}
