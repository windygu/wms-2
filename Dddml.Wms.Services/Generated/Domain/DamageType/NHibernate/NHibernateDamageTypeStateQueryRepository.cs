...
namespace Dddml.Wms.Domain.DamageType.NHibernate
{
	...
	public partial class NHibernateDamageTypeStateQueryRepository : IDamageTypeStateQueryRepository
	{
		...
		public NHibernateDamageTypeStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<DamageTypeState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<DamageTypeState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IDamageTypeState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<DamageTypeState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IDamageTypeState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<DamageTypeState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IDamageTypeState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
