...
namespace Dddml.Wms.Domain.OrderShipment.NHibernate
{
	...
	public partial class NHibernateOrderShipmentStateQueryRepository : IOrderShipmentStateQueryRepository
	{
        ...
        private static readonly ISet<string> _readOnlyPropertyNames = new SortedSet<string>(new String[] { "OrderShipmentId", "Quantity", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted" });
    
        public IReadOnlyProxyGenerator ReadOnlyProxyGenerator { get; set; }

		public NHibernateOrderShipmentStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<OrderShipmentState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<OrderShipmentState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IOrderShipmentState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<OrderShipmentState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IOrderShipmentState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<OrderShipmentState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IOrderShipmentState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
