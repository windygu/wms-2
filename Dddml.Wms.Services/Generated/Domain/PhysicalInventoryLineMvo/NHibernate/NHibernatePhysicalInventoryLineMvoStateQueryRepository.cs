...
namespace Dddml.Wms.Domain.PhysicalInventoryLineMvo.NHibernate
{
	...
	public partial class NHibernatePhysicalInventoryLineMvoStateQueryRepository : IPhysicalInventoryLineMvoStateQueryRepository
	{
		...
		public NHibernatePhysicalInventoryLineMvoStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<PhysicalInventoryLineMvoState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<PhysicalInventoryLineMvoState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IPhysicalInventoryLineMvoState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<PhysicalInventoryLineMvoState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IPhysicalInventoryLineMvoState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<PhysicalInventoryLineMvoState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IPhysicalInventoryLineMvoState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
