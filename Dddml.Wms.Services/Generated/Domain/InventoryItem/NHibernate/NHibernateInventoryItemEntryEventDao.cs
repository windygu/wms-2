...
namespace Dddml.Wms.Domain.InventoryItem.NHibernate
{
	...
	public class NHibernateInventoryItemEntryEventDao : IInventoryItemEntryEventDao
	{
		...
		public NHibernateInventoryItemEntryEventDao ()
		{
		}
        ...
        public IEnumerable<IInventoryItemEntryEvent> FindByInventoryItemEventId(InventoryItemEventId inventoryItemEventId)
        {
