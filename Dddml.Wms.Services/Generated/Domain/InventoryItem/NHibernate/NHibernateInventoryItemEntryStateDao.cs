...
namespace Dddml.Wms.Domain.InventoryItem.NHibernate
{
	...
	public class NHibernateInventoryItemEntryStateDao : IInventoryItemEntryStateDao
	{
        ...
        private static readonly ISet<string> _readOnlyPropertyNames = new SortedSet<string>(new String[] { "EntrySeqId", "QuantityOnHand", "QuantityReserved", "QuantityOccupied", "QuantityVirtual", "Source", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "InventoryItemId" });
