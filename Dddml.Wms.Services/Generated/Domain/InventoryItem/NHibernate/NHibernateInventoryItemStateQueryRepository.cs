...
namespace Dddml.Wms.Domain.InventoryItem.NHibernate
{
	...
	public partial class NHibernateInventoryItemStateQueryRepository : IInventoryItemStateQueryRepository
	{
		...
		public NHibernateInventoryItemStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<InventoryItemState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<InventoryItemState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IInventoryItemState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<InventoryItemState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IInventoryItemState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<InventoryItemState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IInventoryItemState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
        ...
        public IEnumerable<IInventoryItemEntryState> GetInventoryItemEntries(InventoryItemId inventoryItemId)
        {
            ...
            var partIdCondition = global::NHibernate.Criterion.Restrictions.Conjunction()
                .Add(global::NHibernate.Criterion.Restrictions.Eq("InventoryItemEntryId.InventoryItemIdProductId", inventoryItemId.ProductId))
                .Add(global::NHibernate.Criterion.Restrictions.Eq("InventoryItemEntryId.InventoryItemIdLocatorId", inventoryItemId.LocatorId))
                .Add(global::NHibernate.Criterion.Restrictions.Eq("InventoryItemEntryId.InventoryItemIdAttributeSetInstanceId", inventoryItemId.AttributeSetInstanceId))
                ;
