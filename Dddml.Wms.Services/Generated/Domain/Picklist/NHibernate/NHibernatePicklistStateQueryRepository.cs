...
namespace Dddml.Wms.Domain.Picklist.NHibernate
{
	...
	public partial class NHibernatePicklistStateQueryRepository : IPicklistStateQueryRepository
	{
		...
		public NHibernatePicklistStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<PicklistState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<PicklistState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IPicklistState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<PicklistState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IPicklistState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<PicklistState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IPicklistState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
        ...
        {
            var entityId = new PicklistRoleId(picklistId, partyRoleId);
