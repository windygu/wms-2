...
namespace Dddml.Wms.Domain.StatusItem.NHibernate
{
	...
	public partial class NHibernateStatusItemStateQueryRepository : IStatusItemStateQueryRepository
	{
        ...
        private static readonly ISet<string> _readOnlyPropertyNames = new SortedSet<string>(new String[] { "StatusId", "StatusTypeId", "StatusCode", "SequenceId", "Description", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted" });
    
        public IReadOnlyProxyGenerator ReadOnlyProxyGenerator { get; set; }

		public NHibernateStatusItemStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<StatusItemState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<StatusItemState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IStatusItemState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<StatusItemState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IStatusItemState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<StatusItemState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IStatusItemState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
