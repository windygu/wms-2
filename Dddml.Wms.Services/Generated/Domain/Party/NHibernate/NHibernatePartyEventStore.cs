...
namespace Dddml.Wms.Domain.Party.NHibernate
{
	...
	public class NHibernatePartyEventStore : NHibernateEventStoreBase
	{
		...
		{
			return new PartyStateEventId((string)(eventStoreAggregateId as EventStoreAggregateId).Id, (long)version);
		}
        ...
        public override EventStream LoadEventStream(Type eventType, IEventStoreAggregateId eventStoreAggregateId, long version)
        {
            ...
            {
                SteamVersion = es.Count > 0 ? ((PartyStateEventBase)es.Last()).StateEventId.Version : default(long),
                Events = es
            };
        }
