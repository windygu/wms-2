...
namespace Dddml.Wms.Domain.PicklistRoleMvo.NHibernate
{
	...
	public partial class NHibernatePicklistRoleMvoStateQueryRepository : IPicklistRoleMvoStateQueryRepository
	{
		...
		public NHibernatePicklistRoleMvoStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<PicklistRoleMvoState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<PicklistRoleMvoState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IPicklistRoleMvoState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<PicklistRoleMvoState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IPicklistRoleMvoState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<PicklistRoleMvoState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IPicklistRoleMvoState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
