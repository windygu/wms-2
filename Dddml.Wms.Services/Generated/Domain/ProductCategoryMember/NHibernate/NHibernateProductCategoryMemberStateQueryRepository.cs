...
namespace Dddml.Wms.Domain.ProductCategoryMember.NHibernate
{
	...
	public partial class NHibernateProductCategoryMemberStateQueryRepository : IProductCategoryMemberStateQueryRepository
	{
		...
		public NHibernateProductCategoryMemberStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<ProductCategoryMemberState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<ProductCategoryMemberState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IProductCategoryMemberState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<ProductCategoryMemberState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IProductCategoryMemberState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<ProductCategoryMemberState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IProductCategoryMemberState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
