...
namespace Dddml.Wms.Domain.Attribute.NHibernate
{
	...
	public class NHibernateAttributeAliasStateEventDao : IAttributeAliasStateEventDao
	{
		...
		public NHibernateAttributeAliasStateEventDao ()
		{
		}

		public void Save(IAttributeAliasStateEvent stateEvent)
		{
        ...
        public IEnumerable<IAttributeAliasStateEvent> FindByAttributeStateEventId(AttributeStateEventId attributeStateEventId)
        {
