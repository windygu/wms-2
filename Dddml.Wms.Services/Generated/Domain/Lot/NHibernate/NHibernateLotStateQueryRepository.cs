...
namespace Dddml.Wms.Domain.Lot.NHibernate
{
	...
	public partial class NHibernateLotStateQueryRepository : ILotStateQueryRepository
	{
        ...
        private static readonly ISet<string> _readOnlyPropertyNames = new SortedSet<string>(new String[] { "LotId", "Quantity", "ExpirationDate", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted" });
    
        public IReadOnlyProxyGenerator ReadOnlyProxyGenerator { get; set; }

		public NHibernateLotStateQueryRepository ()
		{
		}

		[Transaction (ReadOnly = true)]
		public ILotState Get(string id)
		{
        ...
        {
            var criteria = CurrentSession.CreateCriteria<LotState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<LotState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<ILotState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<LotState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual ILotState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<LotState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual ILotState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
