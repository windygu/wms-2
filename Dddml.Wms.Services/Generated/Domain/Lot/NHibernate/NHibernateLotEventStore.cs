...
namespace Dddml.Wms.Domain.Lot.NHibernate
{
	...
	public class NHibernateLotEventStore : NHibernateEventStoreBase
	{
		...
		{
			return new LotStateEventId((string)(eventStoreAggregateId as EventStoreAggregateId).Id, (long)version);
		}
        ...
        public override EventStream LoadEventStream(Type eventType, IEventStoreAggregateId eventStoreAggregateId, long version)
        {
            ...
            {
                SteamVersion = es.Count > 0 ? ((LotStateEventBase)es.Last()).StateEventId.Version : default(long),
                Events = es
            };
        }
