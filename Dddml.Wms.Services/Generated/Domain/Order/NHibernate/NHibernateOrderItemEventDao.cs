...
namespace Dddml.Wms.Domain.Order.NHibernate
{
	...
	public class NHibernateOrderItemEventDao : IOrderItemEventDao
	{
		...
		public NHibernateOrderItemEventDao ()
		{
		}

		public void Save(IOrderItemEvent stateEvent)
		{
        ...
        public IEnumerable<IOrderItemEvent> FindByOrderEventId(OrderEventId orderEventId)
        {
            var criteria = CurrentSession.CreateCriteria<OrderItemEventBase>();
            ...
            return criteria.Add(partIdCondition).List<OrderItemEventBase>();
        }
