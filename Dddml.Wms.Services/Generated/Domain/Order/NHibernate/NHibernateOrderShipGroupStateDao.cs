...
namespace Dddml.Wms.Domain.Order.NHibernate
{
	...
	public class NHibernateOrderShipGroupStateDao : IOrderShipGroupStateDao
	{
        ...
        private static readonly ISet<string> _readOnlyPropertyNames = new SortedSet<string>(new String[] { "ShipGroupSeqId", "ShipmentMethodTypeId", "SupplierPartyId", "VendorPartyId", "CarrierPartyId", "CarrierRoleTypeId", "FacilityId", "ContactMechId", "TelecomContactMechId", "TrackingNumber", "ContactPartyId", "VehiclePlateNumber", "ShippingInstructions", "MaySplit", "GiftMessage", "IsGift", "ShipAfterDate", "ShipByDate", "EstimatedShipDate", "EstimatedDeliveryDate", "PickwaveId", "NumberOfPackages", "NumberOfContainers", "NumberOfPakagesPerContainer", "OrderShipGroupStatusId", "OrderItemShipGroupAssociations", "Version", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "OrderId" });
