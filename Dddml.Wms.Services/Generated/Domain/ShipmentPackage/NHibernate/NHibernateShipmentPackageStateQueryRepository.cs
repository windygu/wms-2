...
namespace Dddml.Wms.Domain.ShipmentPackage.NHibernate
{
	...
	public partial class NHibernateShipmentPackageStateQueryRepository : IShipmentPackageStateQueryRepository
	{
		...
		public NHibernateShipmentPackageStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<ShipmentPackageState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<ShipmentPackageState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<IShipmentPackageState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<ShipmentPackageState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual IShipmentPackageState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<ShipmentPackageState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual IShipmentPackageState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
