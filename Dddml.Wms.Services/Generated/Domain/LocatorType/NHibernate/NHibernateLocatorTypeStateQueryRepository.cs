...
namespace Dddml.Wms.Domain.LocatorType.NHibernate
{
	...
	public partial class NHibernateLocatorTypeStateQueryRepository : ILocatorTypeStateQueryRepository
	{
		...
		public NHibernateLocatorTypeStateQueryRepository ()
		{
		}
        ...
        {
            var criteria = CurrentSession.CreateCriteria<LocatorTypeState>();
            criteria.SetFirstResult(firstResult);
            criteria.SetMaxResults(maxResults);
            AddNotDeletedRestriction(criteria);
            return criteria.List<LocatorTypeState>();
        }
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<ILocatorTypeState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<LocatorTypeState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual ILocatorTypeState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<LocatorTypeState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual ILocatorTypeState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
