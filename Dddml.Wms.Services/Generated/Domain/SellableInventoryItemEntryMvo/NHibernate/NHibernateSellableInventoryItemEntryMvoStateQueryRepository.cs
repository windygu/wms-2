...
namespace Dddml.Wms.Domain.SellableInventoryItemEntryMvo.NHibernate
{
	...
	public partial class NHibernateSellableInventoryItemEntryMvoStateQueryRepository : ISellableInventoryItemEntryMvoStateQueryRepository
	{
		...
		public NHibernateSellableInventoryItemEntryMvoStateQueryRepository ()
		{
		}
        ...
        [Transaction(ReadOnly = true)]
        public virtual IEnumerable<ISellableInventoryItemEntryMvoState> Get(Dddml.Support.Criterion.ICriterion filter, IList<string> orders = null, int firstResult = 0, int maxResults = int.MaxValue)
        {
            var criteria = CurrentSession.CreateCriteria<SellableInventoryItemEntryMvoState>();
        ...
        [Transaction(ReadOnly = true)]
        public virtual ISellableInventoryItemEntryMvoState GetFirst(IEnumerable<KeyValuePair<string, object>> filter, IList<string> orders = null)
        {
            var list = (IList<SellableInventoryItemEntryMvoState>)Get(filter, orders, 0, 1);
        ...
        [Transaction(ReadOnly = true)]
        public virtual ISellableInventoryItemEntryMvoState GetFirst(KeyValuePair<string, object> keyValue, IList<string> orders = null)
        {
