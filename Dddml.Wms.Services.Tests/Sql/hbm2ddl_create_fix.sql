...
set @fkConstraintName = (SELECT CONSTRAINT_NAME FROM information_schema.TABLE_CONSTRAINTS WHERE
            CONSTRAINT_SCHEMA = DATABASE() AND
            TABLE_NAME        = 'TeamPlayers' AND
            CONSTRAINT_TYPE   = 'FOREIGN KEY');
set @sqlVar = if(@fkConstraintName is not null, 
			concat('ALTER TABLE TeamPlayers drop foreign key ', @fkConstraintName),
            'select 1');
prepare stmt from @sqlVar;
execute stmt;
deallocate prepare stmt;
...
set @fkConstraintName = (SELECT CONSTRAINT_NAME FROM information_schema.TABLE_CONSTRAINTS WHERE
            CONSTRAINT_SCHEMA = DATABASE() AND
            TABLE_NAME        = 'TeamMascots' AND
            CONSTRAINT_TYPE   = 'FOREIGN KEY');
set @sqlVar = if(@fkConstraintName is not null, 
			concat('ALTER TABLE TeamMascots drop foreign key ', @fkConstraintName),
            'select 1');
prepare stmt from @sqlVar;
execute stmt;
deallocate prepare stmt;
...
set @fkConstraintName = (SELECT CONSTRAINT_NAME FROM information_schema.TABLE_CONSTRAINTS WHERE
            CONSTRAINT_SCHEMA = DATABASE() AND
            TABLE_NAME        = 'TeamStateEventPlayers' AND
            CONSTRAINT_TYPE   = 'FOREIGN KEY');
set @sqlVar = if(@fkConstraintName is not null, 
			concat('ALTER TABLE TeamStateEventPlayers drop foreign key ', @fkConstraintName),
            'select 1');
prepare stmt from @sqlVar;
execute stmt;
deallocate prepare stmt;
...
set @fkConstraintName = (SELECT CONSTRAINT_NAME FROM information_schema.TABLE_CONSTRAINTS WHERE
            CONSTRAINT_SCHEMA = DATABASE() AND
            TABLE_NAME        = 'TeamStateEventMascots' AND
            CONSTRAINT_TYPE   = 'FOREIGN KEY');
set @sqlVar = if(@fkConstraintName is not null, 
			concat('ALTER TABLE TeamStateEventMascots drop foreign key ', @fkConstraintName),
            'select 1');
prepare stmt from @sqlVar;
execute stmt;
deallocate prepare stmt;
...
############################################
    ...
    create table AttributeSetInstances (
       ...
       AttributeSetId VARCHAR(105),
       OrganizationId VARCHAR(105),
       ReferenceId VARCHAR(105),
       SerialNumber VARCHAR(105),
       Lot VARCHAR(105),
       ...
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
       UpdatedAt DATETIME,
       Active TINYINT(1),
       Deleted TINYINT(1),
    ...
    create table AttributeSetInstanceStateEvents (
        AttributeSetInstanceId VARCHAR(50) not null,
       Version BIGINT not null,
       StateEventType VARCHAR(105) not null,
       AttributeSetId VARCHAR(105),
       OrganizationId VARCHAR(105),
       ReferenceId VARCHAR(105),
       SerialNumber VARCHAR(105),
    ...
    create table AttributeSetInstanceStateEventRemovedProperties (
        AttributeSetInstanceId VARCHAR(50) not null,
       Version BIGINT not null,
       RemovedPropertyName VARCHAR(105) not null,
    ...
    create table AttributeSetInstanceExtensionFieldGroups (
       ...
       Version BIGINT not null,
       FieldType VARCHAR(105),
       FieldLength INTEGER,
       FieldCount INTEGER,
       NameFormat VARCHAR(105),
       Description VARCHAR(105),
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
    ...
    create table Attributes (
       ...
       AttributeValueType VARCHAR(105),
       AttributeValueLength INTEGER,
       IsList TINYINT(1),
       FieldName VARCHAR(105),
       ReferenceId VARCHAR(105),
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
    ...
    create table AttributeSets (
       ...
       OrganizationId VARCHAR(105),
       Description VARCHAR(105),
       SerialNumberAttributeId VARCHAR(105),
       LotAttributeId VARCHAR(105),
       ReferenceId VARCHAR(105),
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
    ...
    create table AttributeSetInstanceExtensionField_RV (
       ...
       Active TINYINT(1),
       Deleted TINYINT(1),
       AttrSetInstEFGroupFieldType VARCHAR(105),
       AttrSetInstEFGroupFieldLength INTEGER,
       AttrSetInstEFGroupFieldCount INTEGER,
       AttrSetInstEFGroupNameFormat VARCHAR(105),
       AttrSetInstEFGroupDescription VARCHAR(105),
       AttrSetInstEFGroupCreatedBy VARCHAR(105),
       AttrSetInstEFGroupCreatedAt DATETIME,
       AttrSetInstEFGroupUpdatedBy VARCHAR(105),
    ...
    create table AttributeValue_RV (
       ...
       Active TINYINT(1),
       Deleted TINYINT(1),
       AttributeName VARCHAR(105),
       AttributeOrganizationId VARCHAR(105),
       AttributeDescription VARCHAR(105),
       AttributeIsMandatory TINYINT(1),
       AttributeIsInstanceAttribute TINYINT(1),
       AttributeAttributeValueType VARCHAR(105),
       AttributeAttributeValueLength INTEGER,
       AttributeIsList TINYINT(1),
       AttributeFieldName VARCHAR(105),
       AttributeReferenceId VARCHAR(105),
       AttributeCreatedBy VARCHAR(105),
       AttributeCreatedAt DATETIME,
       AttributeUpdatedBy VARCHAR(105),
    ...
    create table AttributeUse_RV (
       ...
       Active TINYINT(1),
       Deleted TINYINT(1),
       AttributeSetName VARCHAR(105),
       AttributeSetOrganizationId VARCHAR(105),
       AttributeSetDescription VARCHAR(105),
       AttributeSetSerialNumberAttributeId VARCHAR(105),
       AttributeSetLotAttributeId VARCHAR(105),
       AttributeSetReferenceId VARCHAR(105),
       AttributeSetCreatedBy VARCHAR(105),
       AttributeSetCreatedAt DATETIME,
       AttributeSetUpdatedBy VARCHAR(105),
    ...
    create table DayPlan_RV (
       ...
       MonthPlanCreatedBy VARCHAR(105),
       MonthPlanCreatedAt DATETIME,
       MonthPlanUpdatedBy VARCHAR(105),
       ...
       YearPlanCreatedBy VARCHAR(105),
       YearPlanCreatedAt DATETIME,
       YearPlanUpdatedBy VARCHAR(105),
       ...
       PersonEmergencyContactPhoneNumber VARCHAR(105),
       PersonEmergencyContactAddress VARCHAR(105),
       PersonCreatedBy VARCHAR(105),
       PersonCreatedAt DATETIME,
       PersonUpdatedBy VARCHAR(105),
    ...
    create table Permissions (
       ...
       Version BIGINT not null,
       Name VARCHAR(105),
       ParentPermissionId VARCHAR(105),
       Description VARCHAR(105),
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
    ...
    create table RolePermissions (
        IdRoleId VARCHAR(105) not null,
       IdPermissionId VARCHAR(105) not null,
       Version BIGINT not null,
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
    ...
    create table Users (
       ...
       PasswordHash VARCHAR(105),
       PhoneNumber VARCHAR(105),
       PhoneNumberConfirmed TINYINT(1),
       TwoFactorEnabled TINYINT(1),
       SecurityStamp VARCHAR(105),
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
       UpdatedAt DATETIME,
    ...
    create table UserClaims (
       ...
       Version BIGINT not null,
       ClaimType VARCHAR(105),
       ClaimValue VARCHAR(105),
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
       UpdatedAt DATETIME,
    ...
    create table UserLogins (
       ...
       UserLoginIdLoginKeyLoginProvider VARCHAR(105) not null,
       UserLoginIdLoginKeyProviderKey VARCHAR(105) not null,
       Version BIGINT not null,
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
    ...
    create table InOuts (
       ...
       DocumentStatus VARCHAR(105),
       Posted TINYINT(1),
       Processing TINYINT(1),
       Processed TINYINT(1),
       DocumentType INTEGER,
       Description VARCHAR(105),
       OrderNumber VARCHAR(105),
       DateOrdered DATETIME,
       IsPrinted TINYINT(1),
       MovementType VARCHAR(105),
       MovementDate DATETIME,
       BusinessPartnerId VARCHAR(105),
       WarehouseId VARCHAR(105),
       POReference VARCHAR(105),
       FreightAmountAmount NUMERIC(19,5),
       FreightAmountCurrency VARCHAR(10),
       ShipperId VARCHAR(105),
       ChargeAmountAmount NUMERIC(19,5),
       ChargeAmountCurrency VARCHAR(10),
       DatePrinted DATETIME,
       SalesRepresentative VARCHAR(105),
       NumberOfPackages INTEGER,
       PickDate DATETIME,
       ShipDate DATETIME,
       TrackingNumber VARCHAR(105),
       ...
       Volume NUMERIC(19,5),
       Weight NUMERIC(19,5),
       RmaNumber VARCHAR(105),
       ReversalNumber VARCHAR(105),
       IsDropShip TINYINT(1),
       DropShipBusinessPartnerId VARCHAR(105),
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
       UpdatedAt DATETIME,
    ...
    create table InOutLines (
       ...
       InOutLineIdSkuIdProductId VARCHAR(105) not null,
       InOutLineIdSkuIdAttributeSetInstanceId VARCHAR(105) not null,
       Version BIGINT not null,
       LineNumber BIGINT,
       Description VARCHAR(105),
       LocatorId VARCHAR(105),
       Product VARCHAR(105),
       UomId VARCHAR(105),
       ...
       AttributeSetInstanceId VARCHAR(105),
    ...
    create table OrganizationStructures (
        IdOrganizationStructureTypeId VARCHAR(105) not null,
       IdParentId VARCHAR(105) not null,
       IdSubsidiaryId VARCHAR(105) not null,
       Version BIGINT not null,
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
    ...
    create table Locators (
       ...
       Version BIGINT not null,
       WarehouseId VARCHAR(105) not null,
       ParentLocatorId VARCHAR(105),
       LocatorType VARCHAR(105),
       PriorityNumber VARCHAR(105),
       IsDefault TINYINT(1),
       X VARCHAR(105),
       Y VARCHAR(105),
       Z VARCHAR(105),
    ...
    create table People (
       ...
       EmergencyContactPhoneNumber VARCHAR(105),
       EmergencyContactAddress VARCHAR(105),
       CreatedBy VARCHAR(105),
       CreatedAt DATETIME,
       UpdatedBy VARCHAR(105),
       UpdatedAt DATETIME,
    ...
    create table TeamMascots (
        TeamName VARCHAR(50) not null,
       MascotsItem VARCHAR(105) not null,
    ...
    create table UserRole_RV (
       ...
       UserPasswordHash VARCHAR(105),
       UserPhoneNumber VARCHAR(105),
       UserPhoneNumberConfirmed TINYINT(1),
       UserTwoFactorEnabled TINYINT(1),
       UserSecurityStamp VARCHAR(105),
       UserCreatedBy VARCHAR(105),
       UserCreatedAt DATETIME,
       UserUpdatedBy VARCHAR(105),
    ...
    create table InOutLine_RV (
       ...
       InOutRmaNumber VARCHAR(105),
       InOutReversalNumber VARCHAR(105),
       InOutIsDropShip TINYINT(1),
       InOutDropShipBusinessPartnerId VARCHAR(105),
       InOutCreatedBy VARCHAR(105),
       InOutCreatedAt DATETIME,
       InOutUpdatedBy VARCHAR(105),
