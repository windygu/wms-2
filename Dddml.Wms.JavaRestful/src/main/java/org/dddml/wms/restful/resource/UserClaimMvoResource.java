...
public class UserClaimMvoResource {
    ...
    public void put(@PathParam("id") String id, CreateOrMergePatchUserClaimMvoDto.CreateUserClaimMvoDto value) {
        try {
            ...
            UserClaimMvoCommand.CreateUserClaimMvo cmd = value.toCreateUserClaimMvo();
            UserClaimMvoResourceUtils.setNullIdOrThrowOnInconsistentIds(id, cmd);
            userClaimMvoApplicationService.when(cmd);
    ...
    public void patch(@PathParam("id") String id, CreateOrMergePatchUserClaimMvoDto.MergePatchUserClaimMvoDto value) {
        try {
            ...
            UserClaimMvoCommand.MergePatchUserClaimMvo cmd = value.toMergePatchUserClaimMvo();
            UserClaimMvoResourceUtils.setNullIdOrThrowOnInconsistentIds(id, cmd);
            userClaimMvoApplicationService.when(cmd);
    ...
    public void delete(@PathParam("id") String id,
        ...
        try {
            ...
            UserClaimMvoResourceUtils.setNullIdOrThrowOnInconsistentIds(id, deleteCmd);
    ...
    @GET
    public UserClaimMvoStateEventDto getStateEvent(@PathParam("id") String id, @PathParam("version") long version) {
        try {

            UserClaimId idObj = UserClaimMvoResourceUtils.parseIdString(id);
            UserClaimMvoStateEventDtoConverter dtoConverter = getUserClaimMvoStateEventDtoConverter();
            return dtoConverter.toUserClaimMvoStateEventDto((AbstractUserClaimMvoStateEvent) userClaimMvoApplicationService.getStateEvent(idObj, version));
    ...
    @GET
    public UserClaimMvoStateDto getHistoryState(@PathParam("id") String id, @PathParam("version") long version, @QueryParam("fields") String fields) {
        try {
            ...
            return dtoConverter.toUserClaimMvoStateDto(userClaimMvoApplicationService.getHistoryState(idObj, version));

        } catch (DomainError error) { throw error; } catch (Exception ex) { throw new DomainError("ExceptionCaught", ex); }
    }


    protected  UserClaimMvoStateEventDtoConverter getUserClaimMvoStateEventDtoConverter() {
        return new UserClaimMvoStateEventDtoConverter();
    }
    ...
    public static class UserClaimMvoResourceUtils {
        ...
        public static UserClaimMvoStateDto[] toUserClaimMvoStateDtoArray(Iterable<UserClaimId> ids) {
            ...
            ids.forEach(id -> {
                ...
                dto.setUserClaimId(new UserClaimIdDtoWrapper(id));
                states.add(dto);
            });
